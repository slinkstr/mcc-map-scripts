...
; Source file: m45.hsc
; Start time: 4/7/2022 7:06:10
; Decompilation finished in ~0.0137167s
...
(global short s_md_reminder_wait (* 30.0 60.0))
(global short s_md_reminder_interval (* 30.0 45.0))
...
(global real r_crv_debris_speed 20.0)
...
(global real s_lnc_seraph_bombingrun_time 6.0)
...
(global real r_deserter_warn_distance 420.0)
...
(global short s_achievement_timer (* 30.0 180.0))
...
(global short s_hgr_bravo_position -1)
...
(script dormant void md_fac_tr_clear_los
    ...
    (sleep_until (<= (objects_distance_to_object (players) (ai_get_object "sq_unsc_fac_posthallway/trooper0")) 3.0) 10)
...
(script dormant void md_lnc_car_get_to_sabre
    ...
    (sleep_until (>= (device_get_position "dm_slo_shutter") 1.0) 1)
    ...
    (sleep 1)
    (thespian_performance_setup_and_begin "thespian_launch_jorge" "" 0.0)
...
(script dormant void md_waf_an9_batteries_at_79
    (sleep (random_range (* 30.0 10.0) (* 30.0 20.0)))
    (md_start)
...
(script dormant void md_waf_an9_station_defenses_online
    (sleep (random_range (* 30.0 12.0) (* 30.0 15.0)))
    (md_start)
...
(script dormant void md_hgr_tr1_savannah_hitting_hard
    ...
    (sound_impulse_start "sound\levels\120_halo\trench_run\island_creak.sound" none 1.0)
    (cam_shake 0.2 1.0 2 3.0)
    (interpolator_start "corvette_power")
    (if (> (ai_living_count "sq_unsc_com_pilots") 0) 
        (begin
            (if (>= (ai_living_count "sq_unsc_com_pilots") 3) 
                (thespian_performance_setup_and_begin "thespian_corvette_stagger_pilot2" "" 0.0))
            (if (>= (ai_living_count "sq_unsc_com_pilots") 2) 
                (thespian_performance_setup_and_begin "thespian_corvette_stagger_pilot1" "" 0.0))
            (if (>= (ai_living_count "sq_unsc_com_pilots") 1) 
                (thespian_performance_setup_and_begin "thespian_corvette_stagger_pilot0" "" 0.0))
            (sleep 60)
...
(script static void md_grm_savannah_goes_down
    ...
    (sleep_until (>= s_objcon_grm 60) 30 (* 30.0 120.0))
...
(script command_script void cs_gunroom_gunners_left
    ...
    (sleep_until 
        (begin
            ...
            (= (object_get_health "dm_savannah_gunroom") -1.0)
        ) 
    1)
    (sleep (* 30.0 1.0))
...
(script dormant void corvette_cannon_control
    ...
    (sleep_until 
        (begin
            (sleep_until 
                (and
                    (> (device_get_position "dm_savannah_corvette") 0.0)
                    (< (device_get_position "dm_savannah_corvette") 0.15)
                ) 
            1)
            (if debug 
                (print "corvette: left cannons aiming at the frigate.."))
            ...
            (sleep_until 
                (and
                    (> (device_get_position "dm_savannah_corvette") 0.44)
                    (< (device_get_position "dm_savannah_corvette") 0.56)
                ) 
            1)
            (if debug 
...
(script static void com_savannah_chase
    ...
    (device_set_position_track "dm_savannah_comms" "m45_orbit_corvette" 0.0)
    (device_set_position_immediate "dm_savannah_comms" 0.0)
    (device_set_power "dm_savannah_comms" 1.0)
    (device_set_position "dm_savannah_comms" 1.0)
...
(script static void hgr_savannah_chase
    ...
    (device_set_position_track "dm_savannah_hangar" "m45_chase" 1.0)
    (device_set_power "dm_savannah_hangar" 1.0)
    (device_set_position "dm_savannah_hangar" 1.0)
)

(script static void grm_savannah_chase
    (object_destroy_folder "dm_savannah")
    (object_create "dm_savannah_gunroom")
    (device_set_position_track "dm_savannah_gunroom" "m45_chase" 1.0)
    (device_set_power "dm_savannah_gunroom" 1.0)
    (device_set_position "dm_savannah_gunroom" 1.0)
)
...
(script dormant void grm_savannah_moment
    ...
    (sleep (random_range (* 30.0 10.0) (* 30.0 11.0)))
...
(script dormant void grm_destroy_savannah
    ...
    (device_set_position_track "dm_savannah_destroyed" "m45_drift" 0.0)
    (device_set_position_immediate "dm_savannah_destroyed" 0.0)
    (sleep 1)
    ...
    (sleep (* 30.0 s_fx_frigate_death_time))
    (object_destroy_folder "dm_savannah")
)
...
(script command_script void cs_grm_warpout
    ...
    (object_set_velocity (ai_vehicle_get ai_current_actor) 1000.0)
...
(script static void waf_savannah_dock
    ...
    (device_set_position_track "dm_savannah_wafer" "m45_dock" 0.0)
    (device_set_position_immediate "dm_savannah_wafer" 0.0)
    (device_animate_position "dm_savannah_wafer" 0.99 60.0 1.0 0.0 false)
)

(script static void crv_savannah_orbit
    (object_destroy "dm_savannah_corvette")
    (object_create "dm_savannah_corvette")
    (device_set_position_track "dm_savannah_corvette" "m45_orbit_corvette" 0.0)
    (device_set_position_immediate "dm_savannah_corvette" 0.0)
    (device_set_power "dm_savannah_corvette" 1.0)
)
...
(script static void crv_savannah_warp
    ...
    (device_set_power "dm_savannah_corvette" 0.0)
    (device_set_position_track "dm_savannah_corvette" "m45_warp_in" 0.0)
    (device_set_position_immediate "dm_savannah_corvette" 0.0)
    (device_animate_position "dm_savannah_corvette" 0.99 25.0 0.0 3.0 false)
    (sleep (- (* 30.0 25.0) 12.0))
    (if debug 
    ...
    (if (< s_crv_engines_damaged 4) 
        (wake md_crv_sav_clip_engines) (set b_crv_all_engines_damaged true))
)

(script static void lnos_setup
    (object_create_anew "dm_lnos")
    (object_cinematic_visibility "dm_lnos" true)
    (device_set_position_track "dm_lnos" "m45_lnos_approach" 0.0)
)
...
(script static void lnos_setup_bridge
    ...
    (object_cinematic_visibility "dm_lnos" true)
    (device_set_position_track "dm_lnos" "m45_lnos_approach" 0.0)
    (device_animate_position "dm_lnos" 0.65 0.0 0.0 0.0 false)
    (sleep 1)
)

(script static void lnos_arrive
    (sound_impulse_start "sound\levels\solo\m45\corvette_power_up.sound" none 1.0)
    (device_animate_position "dm_lnos" 1.0 (* 60.0 10.0) 1.0 3.0 false)
    (cam_shake 10.0 0.1 3 5.0)
)

(script static void lnos_arrive_fast
    (device_animate_position "dm_lnos" 1.0 10.0 1.0 3.0 false)
)
...
(script static void crv_launch_pods (device_name d1, string_id anim1, device_name d2, string_id anim2, device_name d3, string_id anim3)
    ...
    (device_set_position_track d1 anim1 0.0)
    (device_set_position_track d2 anim2 0.0)
    (device_set_position_track d3 anim3 0.0)
    (device_animate_position d1 0.0 0.0 0.0 0.0 false)
    (device_animate_position d2 0.0 0.0 0.0 0.0 false)
    (device_animate_position d3 0.0 0.0 0.0 0.0 false)
    (device_animate_position d1 1.0 10.0 0.0 0.0 false)
    (device_animate_position d2 1.0 10.0 0.0 0.0 false)
    (device_animate_position d3 1.0 10.0 0.0 0.0 false)
    (sleep (* 30.0 10.0))
    (if (<= (object_get_health d1) 0.0) 
        (begin
            (if debug 
...
(script static void power_down_corvette
    ...
    (sound_impulse_start "sound\levels\120_halo\trench_run\island_creak.sound" none 1.0)
    (sound_class_set_gain "amb" 0.0 90)
    (cam_shake 0.2 1.0 2 3.0)
    (if debug 
...
(script dormant void bch_seraph_crash_control
    ...
    (device_set_position_track "dm_bch_seraph_crash" "e3_seraph_crash0" 1.0)
    (sleep 2)
    (objects_attach "dm_bch_seraph_crash" "" (ai_vehicle_get "sq_cov_bch_seraphs/crash0") "")
    (device_set_power "dm_bch_seraph_crash" 1.0)
    (device_set_position "dm_bch_seraph_crash" 1.0)
    (device_animate_position "dm_bch_seraph_crash" 1.0 6.0 0.0 0.0 true)
    (sleep_until (>= (device_get_position "dm_bch_seraph_crash") 1.0) 1)
    ...
    (damage_object "sc_wall_panel" "" 1000.0)
    (cam_shake 0.2 1.0 1 3.0)
    (sleep 300)
...
(script static void show_fighter_warning
    (sound_impulse_start "sound\game_sfx\fireteam\issue_directive.sound" none 1.0)
    (chud_set_static_hs_variable player0 1 1.0)
    (chud_set_static_hs_variable player1 1 1.0)
    (chud_set_static_hs_variable player2 1 1.0)
    (chud_set_static_hs_variable player3 1 1.0)
)
...
(script static void start_sabre_tutorial (player player_variable)
    ...
    (set s_players_finished_tutorial (+ s_players_finished_tutorial 1.0))
)
...
(script dormant void sabre_tutorial
    ...
    (sleep_until (>= s_players_finished_tutorial (game_coop_player_count)) 1 (* 30.0 60.0))
    (sleep 30)
...
(script static void md_play_on_player (short player_short, sound line)
    (sound_impulse_start line (player_get player_short) 1.0)
    (sleep (sound_impulse_language_time line))
)
...
(script static void cam_shake (real attack, real intensity, short duration, real decay)
    (player_effect_set_max_rotation 3.0 3.0 3.0)
...
(script static void trigger_bombing
    (sound_impulse_start "sound\levels\solo\m45\base_scripted_expl2.sound" none 1.0)
    (sleep 10)
    (cam_shake 1.0 0.28 50 0.45)
...
(script static void trigger_bombing_heavy
    (sound_impulse_start "sound\levels\solo\m45\base_scripted_expl1.sound" none 1.0)
    (sleep 10)
    (cam_shake 1.0 0.5 50 0.45)
    (interpolator_start "base_bombing")
)
...
(script static void seraph_bombingrun_loop (device_name marker, object_name bomber)
    (sleep_until 
        (begin
            ...
            (sleep_until (>= (device_get_position marker) 1.0) 1)
...
(script static void seraph_bombingrun_start (device_name marker, object_name bomber)
    (object_create_anew marker)
    (device_set_position_track marker "e3_seraph_flyover0" 0.0)
    (device_set_position_immediate marker 0.0)
    (sleep 1)
    (object_create bomber)
    (sleep 1)
    (objects_attach marker "" bomber "")
    (device_animate_position marker 1.0 s_lnc_seraph_bombingrun_time 0.0 0.0 true)
)
...
(script static void bch_skybox_pod_drop (device_name d)
    ...
    (device_set_position_track d "m45_skybox_drop_600wu" 0.0)
    (device_animate_position d 1.0 6.0 2.0 0.0 false)
)
...
(script static boolean obj_urocks_1_18
    (or
        (<= (ai_task_count "obj_cov_bch/gate_rocks_infantry_forward") 0)
        (> s_objcon_bch 50)
    )
)
...
(script static boolean obj_urocks_1_19
    (and
        (= b_bch_rocks_pods_complete true)
        (<= (ai_living_count "sq_cov_bch_rocks_pods") 0)
    )
)
...
(script static boolean obj_uspart_1_25
    (and
        (<= (ai_strength "gr_cov_bch_cove") 0.75)
        (>= s_objcon_bch 100)
    )
)
...
(script static boolean obj_uspart_1_26
    (and
        (<= (ai_strength "gr_cov_bch_cove") 0.75)
        (<= (ai_task_count "obj_cov_bch/gate_cove_forward") 0)
    )
)
...
(script static boolean obj_urocke_3_14
    (and
        b_fac_deadman_jorge_waiting
        b_fac_deadman_kat_waiting
        b_fac_deadman_carter_waiting
    )
)
...
(script static boolean obj_uadvan_11_2
    (and
        (<= (ai_task_count "obj_cov_brg/gate_main") 1)
        (>= s_objcon_brg 20)
    )
)
...
(script static boolean obj_udefea_11_6
    (and
        (>= s_objcon_brg 10)
        (<= (ai_task_count "obj_cov_brg/gate_main") 0)
    )
)
...
(script static boolean obj_ugunro_18_4
    (and
        (>= s_objcon_grm 60)
        (<= (ai_task_count "obj_cov_grm/gate_main") 0)
        (= b_grm_hol_finishes_dialogue true)
    )
)
...
(script static boolean obj_uadvan_18_5
    (and
        (<= (ai_living_count "sq_cov_grm_hall_breachers0") 0)
        (<= (ai_task_count "obj_cov_grm/hall_elites_bunker") 0)
    )
)
...
(script static boolean obj_uhall__21_4
    (and
        (> (ai_spawn_count "sq_cov_hgr_breachers0") 0)
        (<= (ai_living_count "sq_cov_hgr_breachers0") 2)
    )
)
...
(script static boolean obj_uhanga_21_5
    (and
        (>= s_objcon_hgr 30)
        (<= (ai_living_count "gr_cov_hgr") 0)
    )
)

(script static boolean obj_uhanga_21_6
    (and
        (<= (ai_task_count "obj_cov_hgr/gate_main") 1)
        (>= (ai_living_count "gr_cov_hgr_snipers") 1)
    )
)
...
(script static boolean obj_uesc_d_23_4
    (and
        (>= s_objcon_esc 30)
        (<= (ai_task_count "obj_cov_esc/gate_main") 0)
    )
)
...
(script startup void space
    ...
    (sleep_until 
        (or
            (= b_bch_completed true)
            (>= s_insertion_index s_fac_encounter_index)
        ) 
    1)
    ...
    (sleep_until 
        (or
            ...
            (>= s_insertion_index s_lnc_encounter_index)
        ) 
    1)
    ...
    (sleep_until 
        (or
            ...
            (>= s_insertion_index s_waf_encounter_index)
        ) 
    1)
    ...
    (sleep_until 
        (or
            ...
            (>= s_insertion_index s_wrp_encounter_index)
        ) 
    1)
    ...
    (sleep_until 
        (or
            ...
            (>= s_insertion_index s_crv_encounter_index)
        ) 
    1)
    (if (<= s_insertion_index s_crv_encounter_index) 
        (wake crv_encounter))
    (sleep_until 
        (or
            (= b_crv_completed true)
            (>= s_insertion_index s_brd_encounter_index)
        ) 
    1)
    (if (<= s_insertion_index s_brd_encounter_index) 
        (wake brd_encounter))
    (sleep_until 
        (or
            (= b_brd_completed true)
            (>= s_insertion_index s_com_encounter_index)
        ) 
    1)
    (if (<= s_insertion_index s_com_encounter_index) 
        (wake com_encounter))
    (sleep_until 
        (or
            (= b_com_completed true)
            (>= s_insertion_index s_hgr_encounter_index)
        ) 
    1)
    (if (<= s_insertion_index s_hgr_encounter_index) 
        (wake hgr_encounter))
    (sleep_until 
        (or
            (= b_hgr_completed true)
            (>= s_insertion_index s_grm_encounter_index)
        ) 
    1)
    (if (<= s_insertion_index s_grm_encounter_index) 
        (wake grm_encounter))
    (sleep_until 
        (or
            (volume_test_players "tv_bridge_start")
            (>= s_insertion_index s_brg_encounter_index)
        ) 
    1)
    (if (<= s_insertion_index s_brg_encounter_index) 
        (wake brg_encounter))
    (sleep_until 
        (or
            (= b_brg_completed true)
            (>= s_insertion_index s_esc_encounter_index)
        ) 
    1)
    (if (<= s_insertion_index s_esc_encounter_index) 
        (wake esc_encounter))
    (sleep_until 
        (or
            (volume_test_players "tv_final_start")
            (>= s_insertion_index s_fin_encounter_index)
        ) 
    1)
    (if (<= s_insertion_index s_fin_encounter_index) 
        (wake fin_encounter))
    (sleep_until (= b_fin_completed true))
    (if debug 
        (print "starting outro cinematic"))
    ...
    (if 
        (or
            ...
            (begin
                ...
                (f_play_cinematic_advanced "045la_katsplan_v2" "set_beach_001_005" "set_beach_001_005")
                (unit_raise_weapon player0 1)
                (unit_raise_weapon player1 1)
                (unit_raise_weapon player2 1)
                (unit_raise_weapon player3 1)
...
(script command_script void cs_bch_jetpackelite0
    ...
    (sleep_until 
        (or
            (< (object_get_shield (ai_get_object ai_current_actor)) 1.0)
            (>= s_objcon_bch 50)
            (<= (ai_strength "gr_cov_bch_rocks") 0.5)
        )
    )
...
(script command_script void cs_bch_cov_ds4
    ...
    (cs_fly_to_and_face "ps_bch_cov_ds4/hover" "ps_bch_cov_ds4/land_facing" 1.0)
    (sleep 30)
    (cs_vehicle_speed 0.3)
...
(script dormant void bch_fork_control
    (sleep_until (>= s_objcon_bch 10) 30 (* 30.0 7.0))
...
(script command_script void cs_bch_fork0
    ...
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 1.0 180)
    (cs_vehicle_speed 1.0)
    (cs_vehicle_boost true)
...
(script dormant void fac_encounter
    ...
    (device_set_power "dm_fac_entrance" 1.0)
    (device_set_position "dm_fac_entrance" 1.0)
    (sleep_until 
        (or
...
(script dormant void fac_door_lock_return_to_breach
    ...
    (device_set_position_immediate "dm_fac_breach_exit" 0.0)
    (device_set_power "dm_fac_breach_exit" 0.0)
    (zone_set_trigger_volume_enable "zone_set:set_facility_001_005_010" false)
    (zone_set_trigger_volume_enable "begin_zone_set:set_facility_001_005_010" false)
    (game_save_no_timeout)
)
...
(script dormant void fac_shutter_control
    (sleep_until b_fac_shutter_activated 1 (* 30.0 20.0))
...
(script command_script void cs_fac_fork
    ...
    (cs_vehicle_speed 0.6)
    (cs_fly_to_and_face "ps_fac_fork/hover" "ps_fac_fork/land_facing" 1.0)
    (sleep 30)
    (cs_vehicle_speed 0.3)
    (cs_fly_to_and_face "ps_fac_fork/land" "ps_fac_fork/land_facing" 1.0)
    (f_unload_fork_cargo (ai_vehicle_get ai_current_actor) "large")
    (sleep 60)
    (cs_fly_to_and_face "ps_fac_fork/hover" "ps_fac_fork/land_facing" 1.0)
    (sleep 30)
...
(script dormant void lnc_trooper_salute_control
    (sleep_until (> (device_get_position "dm_slo_shutter") 0.0) 1)
...
(script command_script void cs_lnc_carter_post
    ...
    (sleep_until 
        (begin
            (sleep_until (> (objects_distance_to_flag (ai_actors ai_carter) "fl_lnc_carter") 2.0))
...
(script command_script void cs_lnc_kat_post
    ...
    (sleep_until 
        (begin
            (sleep_until (> (objects_distance_to_flag (ai_actors ai_kat) "fl_lnc_kat") 2.0))
...
(script dormant void lnc_shutter_control
    ...
    (mus_stop mus_03)
    (mus_start mus_04)
    (device_set_position "dm_slo_shutter" 1.0)
    (sleep (random_range (* 30.0 6.0) (* 30.0 9.0)))
    (device_set_power "dm_fac_cc_exit" 1.0)
    (device_set_position "dm_fac_cc_exit" 1.0)
)
...
(script command_script void cs_lnc_catwalk_trooper0
    ...
    (cs_go_by "ps_thespian_slo/catwalk_left_exit1" "ps_thespian_slo/catwalk_left_exit1" 1.0)
    (cs_go_by "ps_thespian_slo/catwalk_left_erase" "ps_thespian_slo/catwalk_left_erase" 1.0)
...
(script dormant void waf_encounter
    ...
    (sound_looping_start "sound\levels\solo\m45\space_loop\space_loop" none 1.0)
    ...
    (if (= b_waf_sabre_tut_skipped true) 
        (sleep_until (>= (device_get_position "dm_savannah_wafer") 0.75)) (sleep_until (>= (device_get_position "dm_savannah_wafer") 0.95)))
    ...
    (sleep_until (<= (ai_living_count "gr_cov_waf") 0) 30 (* 30.0 30.0))
    (ai_erase "gr_cov_waf")
    (sleep 90)
...
(script dormant void waf_final_fighter_wave_control
    (sleep (random_range (* 30.0 20.0) (* 30.0 30.0)))
    (if 
        (or
            (difficulty_is_heroic_or_higher)
            (game_is_cooperative)
        ...
        (begin
            (if (>= s_waf_banshee_spawn_remaining 7) 
                (begin
                    ...
                    (set s_waf_banshee_spawn_remaining (- s_waf_banshee_spawn_remaining 7.0))
                )
            )
            (if (>= s_waf_banshee_spawn_remaining 5) 
                (begin
                    (waf_spawn_banshee_center_5)
                    (set s_waf_banshee_spawn_remaining (- s_waf_banshee_spawn_remaining 5.0))
                )
            )
            (if (>= s_waf_banshee_spawn_remaining 3) 
                (begin
                    (waf_spawn_banshee_center_3)
                    (set s_waf_banshee_spawn_remaining (- s_waf_banshee_spawn_remaining 3.0))
                )
            )
            (if (>= s_waf_banshee_spawn_remaining 2) 
                (begin
                    (waf_spawn_banshee_center_2)
                    (set s_waf_banshee_spawn_remaining (- s_waf_banshee_spawn_remaining 2.0))
                )
            )
            (if (>= s_waf_banshee_spawn_remaining 1) 
                (begin
                    (waf_spawn_banshee_center_1)
                    (set s_waf_banshee_spawn_remaining (- s_waf_banshee_spawn_remaining 1.0))
                )
            )
        ...
        (begin
            (if (>= s_waf_seraph_spawn_remaining 3) 
                (begin
                    ...
                    (set s_waf_seraph_spawn_remaining (- s_waf_seraph_spawn_remaining 3.0))
                )
            )
            (if (>= s_waf_seraph_spawn_remaining 2) 
                (begin
                    (waf_spawn_seraph_center_2)
                    (set s_waf_seraph_spawn_remaining (- s_waf_seraph_spawn_remaining 2.0))
                )
            )
            (if (>= s_waf_seraph_spawn_remaining 1) 
                (begin
                    (waf_spawn_seraph_center_1)
                    (set s_waf_seraph_spawn_remaining (- s_waf_seraph_spawn_remaining 1.0))
                )
            )
        ...
        (begin
            (if (>= s_waf_sabre_spawn_remaining 3) 
                (begin
                    ...
                    (set s_waf_sabre_spawn_remaining (- s_waf_sabre_spawn_remaining 3.0))
                )
            )
            (if (>= s_waf_sabre_spawn_remaining 2) 
                (begin
                    (waf_spawn_sabre_center_2)
                    (set s_waf_sabre_spawn_remaining (- s_waf_sabre_spawn_remaining 2.0))
                )
            )
            (if (>= s_waf_sabre_spawn_remaining 1) 
                (begin
                    (waf_spawn_sabre_center_1)
                    (set s_waf_sabre_spawn_remaining (- s_waf_sabre_spawn_remaining 1.0))
                )
            )
...
(script command_script void cs_crv_banshee_launch
    ...
    (object_set_velocity (ai_vehicle_get ai_current_actor) 30.0)
)
...
(script dormant void crv_engine0_control
    ...
    (sleep_until (<= (object_get_health "dm_crv_engine_large_left") 0.0) 1)
    (set s_crv_engines_damaged (+ s_crv_engines_damaged 1.0))
    (set b_crv_attempt_save true)
)

(script dormant void crv_engine1_control
    (object_can_take_damage "dm_crv_engine_small_left")
    (sleep_until (<= (object_get_health "dm_crv_engine_small_left") 0.0) 1)
    (set s_crv_engines_damaged (+ s_crv_engines_damaged 1.0))
    (set b_crv_attempt_save true)
)
...
(script dormant void crv_engine2_control
    ...
    (sleep_until (<= (object_get_health "dm_crv_engine_small_right") 0.0) 1)
    (set s_crv_engines_damaged (+ s_crv_engines_damaged 1.0))
    (set b_crv_attempt_save true)
)
...
(script dormant void crv_engine3_control
    ...
    (sleep_until (<= (object_get_health "dm_crv_engine_large_right") 0.0) 1)
    (set s_crv_engines_damaged (+ s_crv_engines_damaged 1.0))
    (set b_crv_attempt_save true)
)
...
(script dormant void crv_engine_blip
    ...
    (if (> (object_get_health "dm_crv_engine_large_right") 0.0) 
        ...
        (begin
            (if (>= s_crv_seraph_spawn_remaining 3) 
                (begin
                    ...
                    (set s_crv_seraph_spawn_remaining (- s_crv_seraph_spawn_remaining 3.0))
                )
            )
            (if (>= s_crv_seraph_spawn_remaining 2) 
                (begin
                    (crv_spawn_seraph_center_2)
                    (set s_crv_seraph_spawn_remaining (- s_crv_seraph_spawn_remaining 2.0))
                )
            )
            (if (>= s_crv_seraph_spawn_remaining 1) 
                (begin
                    (crv_spawn_seraph_center_1)
                    (set s_crv_seraph_spawn_remaining (- s_crv_seraph_spawn_remaining 1.0))
                )
            )
        ...
        (begin
            (if (>= s_crv_sabre_spawn_remaining 3) 
                (begin
                    ...
                    (set s_crv_sabre_spawn_remaining (- s_crv_sabre_spawn_remaining 3.0))
                )
            )
            (if (>= s_crv_sabre_spawn_remaining 2) 
                (begin
                    (crv_spawn_sabre_center_2)
                    (set s_crv_sabre_spawn_remaining (- s_crv_sabre_spawn_remaining 2.0))
                )
            )
            (if (>= s_crv_sabre_spawn_remaining 1) 
                (begin
                    (crv_spawn_sabre_center_1)
                    (set s_crv_sabre_spawn_remaining (- s_crv_sabre_spawn_remaining 1.0))
                )
            )
...
(script dormant void com_encounter
    ...
    (sound_disable_acoustic_palette "space_filter_loop")
    (object_create "sc_crv_shutters")
    (sound_start_global_effect "space_lopass" 1.0)
...
(script static void fireteam_setup
    ...
    (ai_player_set_fireteam_max_squad_absorb_distance player0 100.0)
)
...
(script dormant void com_completion_control
    ...
    (sleep_until (<= (ai_living_count "gr_cov_com") 0) 30 (* 30.0 240.0))
    (sleep 60)
    (game_save)
...
(script dormant void hgr_encounter
    ...
    (device_set_power "c_hangar_door" 0.0)
    ...
    (ai_place "gr_cov_hgr")
    (device_set_position "dm_door_comms_exit" 1.0)
    ...
    (set s_objcon_hgr 20)
    (sleep_until (> (device_get_position "dm_door_com_hgr") 0.0) 1)
    ...
    (sleep_until (<= (ai_living_count "gr_cov_hgr") 3) 30 (* 30.0 600.0))
    (sleep 30)
    (f_blip_ai "gr_cov_hgr" blip_hostile)
    (sleep_until (<= (ai_living_count "gr_cov_hgr") 0) 30 (* 30.0 120.0))
    (sleep 90)
    (set b_hgr_repressurize true)
    (game_save)
    (wake md_hgr_jor_go_for_controls)
    (device_set_power "c_hangar_door" 1.0)
    (f_blip_object "c_hangar_door" blip_interface)
    (sleep_until (> (device_group_get "dg_hangar") 0.0))
    (sleep 10)
    (if debug 
...
(script dormant void hgr_follow_control
    ...
    (sleep (random_range (* 30.0 7.0) (* 30.0 12.0)))
...
(script dormant void hgr_atmosphere_control
    ...
    (sound_impulse_start "sound\levels\solo\m45\airlock\airlock_repressurize.sound" none 1.0)
    (sleep 45)
    (sound_class_set_gain "amb" 1.0 90)
    (sound_impulse_start "sound\levels\solo\m45\corvette_power_up.sound" none 1.0)
...
(script static void weaken_pilot (short index)
    ...
    (unit_set_maximum_vitality (unit (list_get l_pilots index)) 0.1 0.0)
    (unit_set_current_vitality (unit (list_get l_pilots index)) 0.1 0.0)
)

(script static void bring_pilot_to_gunroom (short index, boolean from_hangar)
    (if 
        (and
            (> (object_get_health (list_get l_pilots index)) 0.0)
            ...
            (begin
                ...
                (if (= from_hangar true) 
                    (object_teleport (list_get l_pilots index) "fl_grm_fireteam_from_hangar") (object_teleport (list_get l_pilots index) "fl_grm_fireteam_from_bridge"))
            )
    )
)
...
(script dormant void grm_encounter
    ...
    (kill_volume_enable "kill_crv_01")
    (soft_ceiling_enable "soft_ceiling_ship_01" false)
    (device_set_position_immediate "dm_door_com_hgr" 0.0)
    (device_one_sided_set "dm_door_com_hgr" true)
    (device_set_power "dm_door_com_hgr" 0.0)
    ...
    (sleep_until 
        (or
            ...
            (volume_test_players "tv_objcon_grm_010_right")
        ) 
    1)
    (if debug 
...
(script dormant void grm_door_lock_return_to_hangar
    ...
    (device_set_position_immediate "dm_door_hgr_grm" 0.0)
    (device_set_power "dm_door_hgr_grm" 0.0)
    (sleep 1)
...
(script dormant void grm_door_lock_return_to_aftship
    (device_set_position_immediate "dm_door_comms_exit" 0.0)
    (device_set_power "dm_door_comms_exit" 0.0)
)
...
(script dormant void grm_spawn_control
    (sleep (random_range (* 30.0 12.0) (* 30.0 14.0)))
    (if debug 
    ...
    (sleep_until (> (device_get_position "dm_door_grm_entrance") 0.0) 1)
    (grm_spawn_elites)
)
...
(script static void open_hangar_gunroom_doors
    (device_set_power "dm_gunroom_door_center" 1.0)
    (device_set_position "dm_gunroom_door_center" 1.0)
    (device_set_power "dm_gunroom_door_left" 1.0)
    (device_one_sided_set "dm_gunroom_door_left" false)
    (device_set_position "dm_gunroom_door_left" 1.0)
    (device_closes_automatically_set "dm_gunroom_door_left" false)
    (device_set_power "dm_gunroom_door_right" 1.0)
    (device_one_sided_set "dm_gunroom_door_right" false)
    (device_set_power "dm_grm_hall_left" 1.0)
    (device_one_sided_set "dm_grm_hall_left" false)
    (device_operates_automatically_set "dm_grm_hall_left" true)
    (device_set_power "dm_grm_hall_right" 1.0)
...
(script dormant void grm_jackal_spawn
    ...
    (sleep_until (<= (ai_living_count "gr_cov_grm") 2) 30 (* 30.0 60.0))
...
(script dormant void brg_encounter
    ...
    (set s_objcon_brg 40)
    (sleep_until (= (device_group_get "dg_bridge") 1.0) 1)
    (set b_brg_completed true)
)

(script dormant void brg_prop_control
    (sleep_until (> (device_get_position "dm_door_bridge_entrance") 0.0) 1)
    (if debug 
...
(script dormant void brg_switch_control
    ...
    (sleep_until (<= (ai_living_count "gr_cov_brg") 0) 30 (* 30.0 240.0))
    (sleep 120)
    (if debug 
    ...
    (mus_stop mus_09)
    (sleep_until (> (device_group_get "dg_bridge") 0.0))
    (if debug 
        (print "brg: player has flipped the switch..."))
    (f_unblip_object "c_bridge_refuel")
    (device_set_power "c_bridge_refuel" 0.0)
...
(script dormant void esc_door_lock_return_to_bridge
    ...
    (device_set_position_immediate "dm_door_bridge_entrance" 0.0)
    (device_operates_automatically_set "dm_door_bridge_entrance" false)
    (sleep 1)
    (device_set_power "dm_door_bridge_entrance" 0.0)
    (sleep 1)
...
(script dormant void esc_door_unlock_return_to_hangar
    ...
    (device_set_power "dm_door_hgr_grm" 1.0)
    (device_operates_automatically_set "dm_door_hgr_grm" true)
)
...
(script dormant void fin_encounter
    ...
    (sleep (random_range (* 30.0 12.0) (* 30.0 16.0)))
    (fin_firefight)
...
(script command_script void cs_sabre_warp
    ...
    (object_set_velocity (ai_vehicle_get ai_current_actor) 120.0)
)

(script command_script void cs_sabre_exit_station
    (ai_set_clump ai_current_actor clump_sabres)
    (object_set_velocity (ai_vehicle_get ai_current_actor) 20.0)
)
...
(script command_script void cs_banshee_warp
    ...
    (ai_set_stuck_velocity_threshold ai_current_actor 1.0)
    (effect_new_on_object_marker fx_warp_flash (ai_vehicle_get ai_current_actor) "fx_warp")
    (object_set_velocity (ai_vehicle_get ai_current_actor) 50.0)
)
...
(script command_script void cs_seraph_warp
    ...
    (ai_set_stuck_velocity_threshold ai_current_actor 1.0)
    (effect_new_on_object_marker fx_warp_flash (ai_vehicle_get ai_current_actor) "fx_warp")
    (object_set_velocity (ai_vehicle_get ai_current_actor) 100.0)
)

(script command_script void cs_phantom_warp
    (effect_new_on_object_marker fx_warp_flash (ai_vehicle_get ai_current_actor) "fx_warp")
    (object_set_velocity (ai_vehicle_get ai_current_actor) 40.0)
)
...
(script dormant void bch_cov_post_dock_control
    ...
    (sleep_until (not (bch_wraith_is_alive)) 30 (* 30.0 180.0))
    (sleep_until 
        (begin
            (if (bch_wraith_is_alive) 
                (sleep_until (<= (ai_task_count "obj_cov_bch_post/dock") 0)) (sleep_until (<= (ai_task_count "obj_cov_bch_post/dock") 1)))
...
(script command_script void cs_bch_post_beach_fork
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 1.0 150)
    (set s_bch_post_beach_wave (+ s_bch_post_beach_wave 1.0))
    ...
    (if 
        (and
            (<= s_bch_post_beach_wave 1)
            (= b_mendicant_beach true)
        ) 
            (begin
                (if debug 
...
(script static boolean bch_wraith_is_alive
    (> (object_get_health o_bch_wraith) 0.0)
)
...
(script dormant void bch_wraith_water_kill
    ...
    (damage_object o_bch_wraith "" 10000.0)
)

(script command_script void cs_bch_post_dock_fork
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 1.0 150)
    (set s_bch_post_dock_wave (+ s_bch_post_dock_wave 1.0))
    ...
    (if (bch_wraith_is_alive) 
        (begin
            ...
            (if (<= (random_range 0 100) s_bch_post_heavy_chance) 
                (f_load_fork (ai_vehicle_get ai_current_actor) "left" ai_bch_post_dock_heavy ai_bch_post_dock_01 none none) (f_load_fork (ai_vehicle_get ai_current_actor) "left" ai_bch_post_dock_00 ai_bch_post_dock_01 none none))
        )
    )
...
(script static void bch_seraphs_loop
    ...
    (sleep_until 
        (begin
            (cond
                ((<= (ai_living_count "sq_cov_bch_seraphs/pilot0") 0)
                    (ai_place "sq_cov_bch_seraphs/pilot0")
                )
                ((<= (ai_living_count "sq_cov_bch_seraphs/pilot3") 0)
                    (ai_place "sq_cov_bch_seraphs/pilot3")
                )
                ((<= (ai_living_count "sq_cov_bch_seraphs/pilot2") 0)
                    (ai_place "sq_cov_bch_seraphs/pilot2")
                )
                ((<= (ai_living_count "sq_cov_bch_seraphs/pilot1") 0)
...
(script static void beach_seraph_setup
    ...
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 1.0 s_bch_bomber_scale_ticks)
)
...
(script static void drop_pod (device_name pod_marker, ai pod_pilot)
    ...
    (device_set_position_immediate pod_marker 0.0)
    (sleep 1)
    (device_set_power pod_marker 1.0)
    ...
    (device_set_power pod_marker 0.0)
)
...
(script static void open_pod (device_name pod_marker, ai pod_pilot)
    ...
    (object_damage_damage_section (ai_vehicle_get_from_spawn_point pod_pilot) "body" 100.0)
    (sleep 45)
...
(script command_script void cs_mendicant_beach
    ...
    (sleep_until 
        (or
            ...
            (<= (unit_get_shield ai_current_actor) 0.0)
            (= b_bch_post_pelican_enroute true)
        ) 
    30 (* 30.0 35.0))
    (sleep (random_range 60 120))
...
(script command_script void cs_mendicant_bridge
    ...
    (cs_shoot true)
    (ai_disregard ai_current_actor true)
    (sleep (random_range (* 30.0 30.0) (* 30.0 45.0)))
    (if debug 
        (print "camo now"))
    (ai_set_active_camo ai_current_actor true)
    (cs_enable_targeting false)
...
(script command_script void cs_mendicant_final
    ...
    (cs_shoot true)
    (ai_disregard ai_current_actor true)
    (sleep (random_range (* 30.0 30.0) (* 30.0 35.0)))
    (if debug 
        (print "camo now"))
    (ai_set_active_camo ai_current_actor true)
    (cs_enable_targeting false)
...
(script static void 045la_blastoff_005_sc_sh6
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "primary_engine_glow" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "ambient_steam_off" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "secondary_engine_glow" 0.0 0.0)
    (cinematic_sleep 8)
    ...
    (cinematic_sleep 45)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "primary_engine_glow" 1.0 60.0)
    (cinematic_sleep 15)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "secondary_engine_glow" 1.0 60.0)
    (cinematic_sleep 104)
    (cinematic_lights_destroy_shot)
    (cinematic_clips_destroy)
    (render_exposure_fade_out 0.0)
...
(script static void 045la_blastoff_005_sc_sh7
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 13) "camera" 0.25 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 13) "location" 0.5 0.0)
    (cinematic_sleep 121)
...
(script static void 045la_blastoff_030_sc_sh1
    ...
    (cinematic_lights_initialize_for_shot 0)
    (cinematic_clips_initialize_for_shot 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 2) "ambient_steam_off" 0.0 0.0)
    (cinematic_sleep 34)
...
(script static void 045la_blastoff_030_sc_sh4
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 2) "secondary_engine_top" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 1) "boost_fx" 0.0 0.0)
    (cinematic_sleep 32)
    (cinematic_scripting_start_effect 3 3 0 (cinematic_object_get "sabre_sabre_fastpack1"))
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 2) "secondary_engine_top" 1.0 5.0)
    ...
    (cinematic_sleep 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 2) "secondary_engine_top" 0.0 40.0)
    (cinematic_sleep 4)
    ...
    (cinematic_sleep 46)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 1) "main_engine_fx" 0.15 0.0)
    (cinematic_sleep 180)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 1) "main_engine_fx" 1.0 35.0)
    (cinematic_sleep 42)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 1) "boost_fx" 1.0 20.0)
    (cinematic_sleep 23)
...
(script static void 045lf_jorge_030_sc_sh1
    ...
    (cinematic_lights_initialize_for_shot 0)
    (cinematic_clips_initialize_for_shot 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 9) "camera" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 9) "location" 0.6 0.0)
    (cinematic_sleep 1)
    (cinematic_print "custom script play")
...
(script static void 045lf_jorge_040_sc_sh1
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 30) "camera" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 30) "location" 0.6 0.0)
    (cinematic_sleep 128)
...
(script static void 045lf_jorge_040_sc_sh3
    ...
    (cinematic_lights_initialize_for_shot 2)
    (cinematic_clips_initialize_for_shot 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 17) "led_outer" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 21) "led_outer" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 23) "led_outer" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 24) "led_outer" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 22) "led_outer" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 16) "location" 0.6 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 18) "led_outer" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 19) "led_outer" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 20) "led_outer" 1.0 0.0)
    (cinematic_scripting_start_screen_effect 3 2 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 16) "camera" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 29) "led_fill" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 16) "bg_dim" 0.94 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 25) "led_outer" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 27) "led_fill" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 28) "led_fill" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 26) "led_outer" 1.0 0.0)
    (cinematic_sleep 48)
    ...
    (cinematic_sleep 9)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 25) "led_outer" 0.3 10.0)
    (cinematic_sleep 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 26) "led_outer" 0.3 10.0)
    (cinematic_sleep 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 28) "led_fill" 0.3 10.0)
    (cinematic_sleep 1)
    (cinematic_scripting_start_effect 3 2 3 (cinematic_object_get "cruiser_08"))
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 29) "led_fill" 0.3 10.0)
    (cinematic_sleep 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 27) "led_fill" 0.3 10.0)
    (cinematic_sleep 4)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 24) "led_outer" 0.3 10.0)
    (cinematic_sleep 2)
    (cinematic_scripting_start_effect 3 2 4 (cinematic_object_get "cruiser_07"))
    (cinematic_sleep 8)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 23) "led_outer" 0.3 10.0)
    (cinematic_sleep 2)
    (cinematic_scripting_start_effect 3 2 5 (cinematic_object_get "cruiser_06"))
    (cinematic_sleep 9)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 22) "led_outer" 0.3 10.0)
    (cinematic_sleep 7)
    ...
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 21) "led_outer" 0.3 10.0)
    ...
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 20) "led_outer" 0.3 10.0)
    (cinematic_sleep 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 18) "led_outer" 0.3 10.0)
    (cinematic_sleep 4)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 19) "led_outer" 0.3 10.0)
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 17) "led_outer" 0.3 10.0)
    (cinematic_sleep 7)
...
(script static void 045lb_pitstop_010_sc_sh1
    ...
    (cinematic_clips_initialize_for_shot 0)
    (cinematic_scripting_start_music 0 0 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "boost_fx" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "main_engine_fx" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "front_engine_light" 1.0 0.0)
    (cinematic_scripting_start_music 0 0 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 3) "front_engine_light" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 5) "boost_fx" 0.25 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 5) "front_engine_light" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 5) "main_engine_fx" 1.0 0.0)
    (cinematic_sleep 1)
    (cinematic_scripting_start_dialogue 0 0 0 none)
    (cinematic_sleep 34)
    (cinematic_scripting_start_dialogue 0 0 2 none)
    (cinematic_sleep 40)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 3) "front_engine_light" 0.0 80.0)
    (cinematic_sleep 25)
...
(script static void 045lb_pitstop_020_sc_sh1
    ...
    (cinematic_lights_initialize_for_shot 0)
    (cinematic_clips_initialize_for_shot 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 13) "screen_on" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 10) "light_flash_01" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 10) "light_flash_02" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 5) "boost_fx" 0.25 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 5) "front_engine_light" 1.0 0.0)
    (cinematic_sleep 98)
    (cinematic_scripting_start_dialogue 1 0 0 none)
    (cinematic_sleep 64)
...
(script static void 045lb_pitstop_020_sc_sh2
    ...
    (cinematic_lights_initialize_for_shot 1)
    (cinematic_clips_initialize_for_shot 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "nuke_1" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "nuke_2" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 10) "light_flash_01" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 16) "camera" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 16) "location" 0.4 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 10) "light_flash_02" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 16) "bg_dim" 0.9 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "nuke_3" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 0.0 0.0)
    (cinematic_sleep 3)
    (fade_in 0.0 0.0 0.0 5)
    (cinematic_print "custom script play")
    (cinematic_sleep 17)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 1.0 0.0)
    (cinematic_sleep 3)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 0.0 0.0)
    (cinematic_sleep 3)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 0.5 0.0)
    (cinematic_sleep 3)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 0.0 0.0)
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "nuke_1" 1.0 600.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 0.5 0.0)
    (cinematic_sleep 2)
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 1.0 0.0)
    (cinematic_sleep 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "nuke_2" 1.0 600.0)
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 0.5 0.0)
    (cinematic_sleep 21)
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 0.5 0.0)
    (cinematic_sleep 3)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "nuke_3" 1.0 600.0)
    (cinematic_sleep 25)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 1.0 0.0)
    (cinematic_sleep 3)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 17) "led_outer" 0.5 0.0)
...
(script static void 045lb_pitstop_020_sc_sh3
    ...
    (cinematic_clips_initialize_for_shot 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 13) "screen_on" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 13) "screen" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 10) "light_flash_02" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 13) "holland" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 10) "light_flash_01" 0.0 0.0)
    (cinematic_sleep 44)
    (cinematic_lights_destroy_shot)
    (cinematic_clips_destroy)
...
(script static void 045lb_pitstop_030_sc_sh1
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 6) "light_flash_01" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 6) "light_flash_02" 0.0 0.0)
    (cinematic_sleep 3)
    (cinematic_scripting_start_dialogue 2 0 0 none)
    (cinematic_sleep 272)
    (cinematic_lights_destroy_shot)
...
(script static void 045lb_pitstop_040_sc_sh1
    ...
    (cinematic_lights_initialize_for_shot 0)
    (cinematic_clips_initialize_for_shot 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 3) "main_engine_fx" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 3) "boost_fx" 0.1 0.0)
    (cinematic_sleep 131)
...
(script static void 045lb_pitstop_040_sc_sh2
    ...
    (cinematic_lights_initialize_for_shot 1)
    (cinematic_clips_initialize_for_shot 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 10) "screen_on" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 10) "holland" 0.0 0.0)
    (object_set_permutation (cinematic_object_get "player") "flair_left_shoulder" "")
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 1) "thrusters_back" 0.75 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 10) "screen" 0.0 0.0)
    (cinematic_print "custom script play")
...
(script static void 045lb_pitstop_040_sc_sh3
    ...
    (cinematic_lights_initialize_for_shot 2)
    (cinematic_clips_initialize_for_shot 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 0) "frigate_engines" 0.25 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 6) "main_engine_fx" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 7) "main_engine_fx" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 5) "main_engine_fx" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 3) "main_engine_fx" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 1) "thrusters_back" 1.0 0.0)
    (cinematic_sleep 7)
    (cinematic_scripting_start_dialogue 3 2 1 none)
    (cinematic_sleep 103)
    (cinematic_scripting_start_dialogue 3 2 0 none)
    (cinematic_sleep 140)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 3 0) "frigate_engines" 1.0 200.0)
    (cinematic_sleep 200)
    (cinematic_print "custom script play")
    (fade_out 0.0 0.0 0.0 70)
    (cinematic_sleep 75)
    (cinematic_lights_destroy_shot)
    (cinematic_clips_destroy)
    (render_exposure_fade_out 0.0)
...
(script static void 045lb_pitstop_050_sc_sh1
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 4 10) "location" 0.6 0.0)
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 4 10) "camera" 0.5 0.0)
...
(script static void 045le_bomb_delivery_010_sc_sh2
    ...
    (cinematic_clips_initialize_for_shot 1)
    (render_exposure 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "thrusters_back" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "thrusters_down" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "jetwash_off" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "jetwash" 1.0 0.0)
    (cinematic_sleep 1)
    ...
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "frigate_turret_07_weapon") false)
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "thrusters_back" 0.0 50.0)
    (cinematic_sleep 19)
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "frigate_turret_08_weapon") true)
    (cinematic_print "custom script play")
    (cinematic_sleep 2)
    ...
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "frigate_turret_08_weapon") false)
    (cinematic_sleep 8)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "jetwash_off" 0.5 100.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "thrusters_down" 0.0 100.0)
    (cinematic_sleep 4)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "frigate_turret_06_weapon") true)
    (cinematic_sleep 16)
...
(script static void 045le_bomb_delivery_010_sc_sh3
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "jetwash_off" 0.5 0.0)
    (cinematic_sleep 10)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "jetwash_off" 1.0 150.0)
    (cinematic_sleep 73)
...
(script static void 045la_katsplan_050_sc_sh2
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 1) "headlights" 0.0 0.0)
    (cinematic_print "custom script play")
    (object_set_model_state_property (cinematic_object_get "falcon_1") 0 true)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 1) "thrust" 0.05 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 1) "engine_exhaust" 0.2 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 1) "blur" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 1) "jet_wash" 1.0 0.0)
    (cinematic_sleep 130)
...
(script static void 045la_katsplan_060_sc_sh1
    ...
    (cinematic_lights_initialize_for_shot 0)
    (cinematic_clips_initialize_for_shot 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 1) "blur" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 1) "thrust" 1.0 0.0)
    (cinematic_print "custom script play")
    (cinematic_show_letterbox_immediate false)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 9) "primary_ammunition_tens" 0.3 0.0)
    (object_set_model_state_property (cinematic_object_get "falcon_1") 0 true)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 1) "engine_rpm" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "primary_ammunition_ones" 0.2 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 9) "primary_ammunition_ones" 0.2 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "primary_ammunition_tens" 0.3 0.0)
    (cinematic_print "custom script play")
    (cinematic_sleep 6)
