...
; Source file: m10.hsc
; Start time: 4/7/2022 7:06:17
; Decompilation finished in ~0.0179943s
...
(script dormant void 1stbowl_start
    ...
    (ai_bring_forward "group_emile" 7.0)
...
(script dormant void intro_falcons_start
    ...
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "flying" 1.0 1.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "flying" 1.0 1.0)
    (sleep 1)
...
(script static void intro_falcons_setup_start
    ...
    (thespian_performance_setup_and_begin "carter_falcon_intro" "" 0.0)
    (thespian_performance_setup_and_begin "kat_falcon_intro" "" 0.0)
    (thespian_performance_setup_and_begin "emile_falcon_intro" "" 0.0)
    (ai_vehicle_enter_immediate "group_jorge" (ai_vehicle_get_from_squad "intro_falcon_02" 0) falcon_p_l1_wpn)
...
(script static void intro_falcon01_dropoff_start
    (device_set_position_track "dm_falcon01_start" "m10_insert_dropoff_a_leomar" 0.0)
    (device_animate_position "dm_falcon01_start" 1.0 50.0 0.1 0.1 false)
    (player_camera_control false)
    (player_enable_input false)
    (print "lookat_carter")
    (player_control_lock_gaze player0 "pts_1stbowl/lookat_carter" 40.0)
    (sleep 30)
    (player_control_unlock_gaze player0)
    (sleep_until (>= (device_get_position "dm_falcon01_start") 0.12) 1)
    (print "lookat_outpost")
    (player_control_lock_gaze player0 "pts_1stbowl/lookat_outpost" 40.0)
    ...
    (sleep_until (>= (device_get_position "dm_falcon01_start") 1.0) 1)
    (objects_detach "dm_falcon01_start" (ai_vehicle_get_from_squad "intro_falcon_01" 0))
    (object_set_velocity (ai_vehicle_get_from_squad "intro_falcon_01" 0) 0.0 0.0 0.7)
...
(script static void intro_falcon02_dropoff_start
    (device_set_position_track "dm_falcon02_start" "m10_insert_dropoff_b_leomar" 0.0)
    (device_animate_position "dm_falcon02_start" 1.0 56.0 0.1 0.1 false)
    ...
    (object_set_velocity (ai_vehicle_get_from_squad "intro_falcon_02" 0) 2.0 0.0 2.0)
...
(script command_script void cs_intro_falcons_02
    ...
    (cs_fly_by "pts_1stbowl/air_support04" 1.0)
...
(script command_script void cs_1stbowl_moah01
    ...
    (sound_impulse_start "sound\characters\ambient_life\moa\moa_call_long_bigger" (ai_get_object ai_current_actor) 1.0)
...
(script dormant void witnesses_start
    ...
    (ai_bring_forward "group_carter" 8.0)
    (ai_bring_forward "group_kat" 8.0)
...
(script dormant void witnesses_emile_teleport
    (sleep_until 
        (or
            ...
            (and
                (not (objects_can_see_object (players) obj_emile 30.0))
                (not (objects_can_see_object (players) "sc_emile_teleport_test" 30.0))
            )
        ) 
    1 100)
    (if (not (volume_test_objects "tv_1stbowl_witnesses" obj_emile)) 
...
(script dormant void witnesses_player_kills
    ...
    (if (<= (ai_living_count "obj_1stbowl_civ") 3) 
        (begin
            ...
            (print "scream!")
            (sleep 20)
            (device_set_position "dm_kiva01_door" 0.0)
...
(script dormant void hud_barn_start
    ...
    (sleep 100)
    (sleep_until (objects_can_see_object player0 "sc_hud_barn01" 25.0) 10 (* 15.0 30.0))
...
(script dormant void bowl_birds_start
    (sleep_until (> 40.0 (objects_distance_to_object player0 "sc_1stbowl_truck")))
    (flock_create "flocks_bowl_birds")
    (sleep_until (> 30.0 (objects_distance_to_object player0 "sc_1stbowl_truck")))
...
(script dormant void 1stbowl_elite_start
    ...
    (sleep_until 
        (or
            (<= (object_get_health (ai_get_object "1stbowl_elite")) 0.1)
            (< (objects_distance_to_object (players) (ai_get_object "1stbowl_elite")) 1.0)
        ) 
    1)
...
(script command_script void cs_1stbowl_skirm_q01
    (cs_go_to "pts_1stbowl/skirm_excape01" 10.0)
...
(script dormant void barn_start
    ...
    (ai_bring_forward "group_carter" 8.0)
    (ai_bring_forward "group_spartans" 12.0)
    ...
    (ai_bring_forward "obj_barn_cov" 4.0)
...
(script dormant void barn_combat
    ...
    (sleep_until 
        (or
            (and
                (objects_can_see_flag (players) "fl_barn_skirm_init02" 25.0)
    ...
    (sleep 10)
    (thespian_performance_setup_and_begin "vig_barn_call" "" 0.0)
    ...
    (ai_bring_forward "group_spartans" 10.0)
...
(script dormant void meadow_banshees_start
    ...
    (object_set_scale (ai_vehicle_get_from_squad "meadow_banshees" 0) 1.0 90)
    (object_set_scale (ai_vehicle_get_from_squad "meadow_banshees" 1) 1.0 90)
...
(script dormant void barn_skirm_init_start
    ...
    1)
    (sound_impulse_start "sound\characters\skirmisher\skirmisher_rooftop" "sc_sound_barn_skirm" 1.0)
    (wake md_motion_tracker)
    (cs_run_command_script "barn_skirm_init" cs_barn_skirm_init)
    (object_set_scale (ai_get_object "barn_skirm_init") 1.0 30)
)
...
(script command_script void cs_barn_spartan
    (cs_enable_pathfinding_failsafe true)
    (cs_walk true)
    (cs_go_to "pts_barn/spartan01" 1.0)
    (cs_look true "pts_barn/bloodtrail")
    (cs_go_to "pts_barn/spartan02" 1.0)
)
...
(script command_script void cs_barn_spartan02
    ...
    (cs_go_to "pts_barn/spartan02" 1.0)
    (cs_walk true)
    (cs_go_to "pts_barn/spartan03" 1.0)
    (sleep_forever)
)
...
(script dormant void barn_gren_hud
    (sleep_until (< (objects_distance_to_object (players) "eq_barn_gren") 3.0) 5)
...
(script dormant void barn_health_hud
    ...
    (sleep_forever)
    (sleep_until (< (objects_distance_to_object (players) "dc_barn_health") 3.0) 5)
    (if (> 1.0 (object_get_health (player0))) 
        (begin
            (chud_track_object_with_priority "dc_barn_health" 6 "wp_callout_health")
            (sleep_until (>= 12.0 (objects_distance_to_object (player0) "dc_barn_health")))
...
(script dormant void barn_bodies_door
    ...
    (device_set_power "dm_barn_door01" 1.0)
    (device_set_position "dm_barn_door01" 0.0)
    ...
    (sleep_until 
        (begin
            ...
            (if (>= (random_range 0 3) 1) 
                (cs_shoot_point true "ps_air_meadow/falcon_shoot") (cs_shoot_point false "ps_air_meadow/falcon_shoot"))
            (cs_fly_by "ps_air_meadow/falcon_buzz02")
            (sleep (random_range 60 90))
            (if (>= (random_range 0 3) 1) 
                (cs_shoot_point true "ps_air_meadow/falcon_shoot") (cs_shoot_point false "ps_air_meadow/falcon_shoot"))
...
(script dormant void meadow_start
    ...
    (ai_bring_forward "group_spartans" 20.0)
    (game_save)
...
(script dormant void meadow_cov_air_start
    ...
    (object_set_scale (ai_vehicle_get_from_squad "meadow_fork" 0) 1.0 90)
...
(script dormant void meadow_coop_jorge
    ...
    (if (not (volume_test_object "tv_meadow_adv01" obj_jorge)) 
        (begin
            (sleep_until (not (objects_can_see_object (players) "sc_meadow_coop_jorge" 30.0)) 5 200)
...
(script dormant void meadow_evac
    ...
    (sleep 1)
    (object_set_scale (ai_vehicle_get_from_squad "meadow_falcon02" 0) 1.0 (* 30.0 10.0))
...
(script command_script void cs_meadow_falcon_evac
    ...
    (cs_vehicle_speed 0.5)
    (cs_fly_to "ps_air_meadow/falcon_hover01" 1.0)
    (cs_vehicle_speed 0.1)
    (cs_fly_to_and_face "ps_air_meadow/falcon_land01" "ps_air_meadow/falcon_land_face" 1.0)
...
(script command_script void cs_meadow_fork_entry
    ...
    (cs_fly_to_and_face "ps_air_meadow/meadow_drop03" "ps_air_meadow/meadow_face" 1.0)
...
(script command_script void cs_meadow_fork_fallback
    (if (>= (game_coop_player_count) 3) 
        (f_load_fork (ai_vehicle_get ai_current_actor) "dual" "meadow_cov_back01" "meadow_cov_back_l" "meadow_cov_back02" none) (f_load_fork (ai_vehicle_get ai_current_actor) "dual" "meadow_cov_back01" "meadow_cov_back_l" none none))
    (cs_fly_by "ps_air_meadow/meadow_drop04")
    (cs_fly_to_and_face "ps_air_meadow/meadow_drop05" "ps_air_meadow/meadow_face" 1.0)
    (f_unload_fork (ai_vehicle_get ai_current_actor) "dual")
)
...
(script command_script void cs_meadow_fork_exit
    (cs_enable_pathfinding_failsafe true)
    (cs_vehicle_boost true)
    (cs_fly_by "ps_air_meadow/meadow_exit01" 5.0)
...
(script dormant void 3kiva_start
    ...
    (ai_bring_forward "group_carter" 10.0)
    (ai_bring_forward "group_jorge" 10.0)
    ...
    (if (not (volume_test_object "tv_3kiva_falcon_failsafe" (ai_vehicle_get_from_squad "intro_falcon_01" 0))) 
        (wake 3kiva_falcon_failsafe) (print "3kiva falcon arrived"))
    ...
    (if (volume_test_object "tv_3kiva_meadow" (ai_vehicle_get_from_squad "intro_falcon_01" 0)) 
        (wake 3kiva_falcon_start_failsafe) (print "3kiva falcon arrived"))
    (ai_place "3kiva_bob")
...
(script dormant void 3kiva01_cov_start
    ...
    (set 3kiva_objective_count (+ 3kiva_objective_count 1.0))
    (hud_unblip_all)
    (game_save)
    (wake 3kiva01_hud)
    ...
    (ai_bring_forward "group_carter" 25.0)
    (ai_bring_forward "group_jorge" 25.0)
...
(script dormant void 3kiva_coop_test
    ...
    (sleep_until 
        (begin
            ...
            (cond
                ((volume_test_object "begin_zone_set:zoneset_barn_outro:2" player0)
                    (object_teleport_to_ai_point player0 "ps_3kiva/coop_test")
                )
                ((volume_test_object "begin_zone_set:zoneset_barn_outro:2" player1)
                    (object_teleport_to_ai_point player1 "ps_3kiva/coop_test")
                )
                ((volume_test_object "begin_zone_set:zoneset_barn_outro:2" player2)
                    (object_teleport_to_ai_point player2 "ps_3kiva/coop_test")
                )
                ((volume_test_object "begin_zone_set:zoneset_barn_outro:2" player3)
...
(script static boolean spartan_in_pickup (ai spartan)
    (or
        (vehicle_test_seat_unit "v_3kiva_pickup_init" none (ai_get_unit spartan))
        (vehicle_test_seat_unit "v_3kiva_pickup_left" none (ai_get_unit spartan))
        (if (= (current_zone_set_fully_active) 5) 
            (begin
...
(script dormant void 3kiva_troopers_bsp2
    ...
    (sleep_until (<= (ai_living_count "3kiva_fork_squad01") 0) 30 (* 30.0 20.0))
...
(script dormant void 3kiva_trooper_crashsite_arrival02
    ...
    (sleep_until (< (objects_distance_to_object (players) "cr_3kiva_hogsite02") 10.0))
...
(script dormant void 3kiva_trooper_crashsite_arrival03
    ...
    (sleep_until (< (objects_distance_to_object (players) "cr_3kiva_hogsite03") 10.0))
...
(script static void 3kiva_defend_blip (object_name defend_object, ai troopers)
    ...
    (sleep_until 
        (begin
            (sleep_until (< (objects_distance_to_object (players) defend_object) 30.0))
            (f_unblip_object defend_object)
            (f_unblip_ai troopers)
            (sleep_until (> (objects_distance_to_object (players) defend_object) 35.0))
            (f_blip_ai troopers 5)
            (f_blip_object defend_object blip_defend)
            false
        )
...
(script dormant void 3kiva_final_bsp2
    ...
    (sleep_until (<= (ai_living_count "obj_3kiva02_cov") 1) 30 (* 30.0 300.0))
    (sleep_until (<= (ai_living_count "obj_3kiva02_cov") 0) 30 (* 30.0 160.0))
...
(script dormant void 3kiva_final_bsp3
    ...
    (sleep_until (<= (ai_living_count "obj_3kiva03_cov") 1) 30 (* 30.0 300.0))
    (sleep_until (<= (ai_living_count "obj_3kiva03_cov") 0) 30 (* 30.0 160.0))
...
(script command_script void cs_kiva02_fork
    ...
    (cs_vehicle_boost false)
    (cs_fly_to_and_face "ps_air_3kiva_fork/3kiva02_drop01b02" "ps_air_3kiva_fork/3kiva02_face01" 1.0)
...
(script command_script void cs_kiva02_fork02
    ...
    (cs_vehicle_boost false)
    (cs_fly_to_and_face "ps_air_3kiva_fork/3kiva02_drop02c" "ps_air_3kiva_fork/3kiva02_drop02_face" 1.0)
...
(script command_script void cs_kiva03_fork
    ...
    (cs_vehicle_boost false)
    (cs_fly_to_and_face "ps_air_3kiva_fork/3kiva03_drop01c" "ps_air_3kiva_fork/3kiva03_face01" 1.0)
...
(script dormant void 3kiva_carter_catchup01_start
    (sleep_until (>= (objects_distance_to_object (players) (ai_get_object "group_carter")) 100.0))
    (print "carter is lost")
)

(script dormant void 3kiva_carter_catchup02_start
    (sleep_until (>= 3kiva_jun_bsp 2))
    (if (>= (objects_distance_to_object (players) (ai_get_object "group_carter")) 100.0) 
        (sleep_forever))
...
(script static void 3kiva_blip_next_objective
    (print "blip next obj")
    (cond
        ((volume_test_objects "vol_3kiva_1bsp" (ai_vehicle_get_from_squad "intro_falcon_01" 0))
            (wake md_3kiva_waypoint_kiva01)
        )
        ((volume_test_objects "vol_3kiva_2bsp" (ai_vehicle_get_from_squad "intro_falcon_01" 0))
            (wake md_3kiva_waypoint_kiva02)
        )
        ((volume_test_objects "vol_3kiva_3bsp" (ai_vehicle_get_from_squad "intro_falcon_01" 0))
...
(script command_script void cs_kiva_jun_fork
    ...
    (sleep 1)
    (object_set_scale (ai_vehicle_get ai_current_actor) 1.0 (* 30.0 10.0))
    (cs_fly_by "ps_air_3kiva_fork/3kiva_drop01a" 5.0)
    (sleep_until (>= 3kiva_troopers_bsp 2))
    (cond
        ((= 3kiva_troopers_bsp 2)
...
(script command_script void cs_kiva_fork_02
    ...
    (cs_vehicle_boost true)
    (cs_fly_to_and_face "ps_air_3kiva_fork/3kiva02_drop01a" "ps_air_3kiva_fork/3kiva02_face01" 1.0)
    (cs_vehicle_boost false)
...
(script command_script void cs_kiva_fork_03
    ...
    (cs_vehicle_speed 0.8)
    (cs_fly_to_and_face "ps_air_3kiva_fork/3kiva_drop04a" "ps_air_3kiva_fork/3kiva03_drop02_face" 1.0)
    (f_load_fork (ai_vehicle_get ai_current_actor) "right" "3kiva_fork_squad01" none none none)
    (f_unload_fork (ai_vehicle_get ai_current_actor) "dual")
...
(script dormant void 3kiva_falcon_ecav_start
    ...
    (sleep_until 
        (begin
            ...
            (and
                (or
                    (vehicle_test_seat_unit_list (ai_vehicle_get_from_squad "intro_falcon_01" 0) none player0)
                    (not (player_is_in_game player0))
                )
                (or
                    (vehicle_test_seat_unit_list (ai_vehicle_get_from_squad "intro_falcon_01" 0) none player1)
                    (not (player_is_in_game player1))
                )
                (or
                    (vehicle_test_seat_unit_list (ai_vehicle_get_from_squad "intro_falcon_01" 0) none player2)
                    (not (player_is_in_game player2))
                )
                (or
                    (vehicle_test_seat_unit_list (ai_vehicle_get_from_squad "intro_falcon_01" 0) none player3)
...
(script dormant void 3kiva_falcon02_start
    ...
    (sleep 1)
    (object_set_scale (ai_vehicle_get_from_squad "3kiva_falcon02" 0) 1.0 90)
    (sleep_until 3kiva_done)
    (cond
        ((= 3kiva_troopers_bsp 2)
...
(script command_script void cs_3kiva_falcon_evac02
    ...
    (cs_vehicle_speed 0.1)
    (cs_fly_to "ps_air_3kiva_falcon_evac/3kiva02_land02" 1.0)
...
(script command_script void cs_3kiva_falcon_evac03
    ...
    (cs_vehicle_speed 0.3)
    (cs_fly_to_and_face "ps_air_3kiva_falcon_evac/3kiva03_jun_land" "ps_air_3kiva_falcon_evac/3kiva03_face" 1.0)
    (cs_run_command_script ai_current_actor cs_3kiva_falcon_evac_finish)
)
...
(script command_script void cs_3kiva_falcon02_evac02
    ...
    (if (>= (ai_living_count "group_3kiva_troopers") 1) 
        (begin
            ...
            (cs_vehicle_speed 0.1)
            (cs_fly_to "ps_3kiva_falcon02_evac02/land02" 1.0)
            (sleep_until 
                (begin
...
(script command_script void cs_3kiva_falcon02_evac03
    ...
    (if (>= (ai_living_count "group_3kiva_troopers") 1) 
        (begin
            ...
            (cs_face true "ps_3kiva_falcon02_evac03/face01")
            (cs_vehicle_speed 0.1)
            (cs_fly_to "ps_3kiva_falcon02_evac03/land02" 1.0)
            (sleep_until 
                (begin
...
(script command_script void cs_3kiva_falcon_evac_outpost
    ...
    (soft_ceiling_enable "falcon_ride" true)
    (cs_enable_pathfinding_failsafe true)
    (cs_fly_by "ps_air_3kiva_falcon_evac/3kiva_exit" 10.0)
    ...
    (cs_attach_to_spline "")
    (cs_vehicle_speed 0.1)
    (cs_fly_to_and_face "ps_air_3kiva_falcon_evac/3kiva_exit_unload" "ps_air_3kiva_falcon_evac/3kiva_exit_face" 1.0)
    ...
    (cs_vehicle_speed 0.8)
    (cs_fly_by "ps_air_3kiva_falcon_evac/3kiva_exit10" 2.0)
...
(script dormant void outpost_ext_start
    ...
    (device_set_position_immediate "dm_outpost_door01" 0.0)
    ...
    (thespian_performance_kill_by_ai "group_spartans")
    (sleep 20)
    (thespian_performance_setup_and_begin "vig_outpost_rally" "" 0.0)
    (wake chapter_03_start)
    (ai_disregard (ai_actors "obj_outpost_ext_cov") true)
    (sleep_until (= (device_get_position "dm_outpost_blastdoor") 0.0))
    (sleep 60)
    ...
    (device_set_position "dm_outpost_door01" 1.0)
    (sleep 40)
    (thespian_performance_kill_by_ai "group_spartans")
...
(script dormant void outpost_blastdoor_start
    ...
    (sleep 140)
    (ai_bring_forward "group_carter" 10.0)
    (ai_bring_forward "group_emile" 10.0)
    (ai_bring_forward "group_jorge" 10.0)
    (sleep_until 
        (begin
            (sleep_until 
            ...
            (device_set_power "dm_outpost_blastdoor" 1.0)
            (device_set_position "dm_outpost_blastdoor" 0.0)
            (sleep_until 
                (or
            ...
            (if (not (<= (device_get_position "dm_outpost_blastdoor") 0.6)) 
                (device_set_position "dm_outpost_blastdoor" 0.8) (wake md_outpost_ext_fallback_b))
            (<= (device_get_position "dm_outpost_blastdoor") 0.6)
        )
    )
    ...
    (sleep_until (<= (device_get_position "dm_outpost_blastdoor") 0.45) 1)
    (sound_impulse_start "sound\levels\solo\m10\sound_scenery\blast_doors\blast_door_oneshot\blast_door_close_mono" "dm_outpost_blastdoor" 1.0)
    (sound_impulse_start "sound\levels\solo\m10\sound_scenery\blast_doors\blast_door_oneshot\blast_door_close_surr" "dm_outpost_blastdoor" 1.0)
    (sound_looping_stop "sound\levels\solo\m10\sound_scenery\blast_doors\blast_door_loop\blast_door_loop")
    (sleep_until (= (device_get_position "dm_outpost_blastdoor") 0.0) 5)
    (print "door:poweroff")
    (device_set_power "dm_outpost_blastdoor" 0.0)
)
...
(script dormant void outpost_fork_start
    ...
    (object_set_scale (ai_vehicle_get_from_squad "outpost_fork" 0) 1.0 200)
    (sleep 750)
    (print "outpost_fork02")
    (ai_place "outpost_fork02")
    (object_set_scale (ai_vehicle_get_from_squad "outpost_fork02" 0) 0.01 0)
    (object_set_scale (ai_vehicle_get_from_squad "outpost_fork02" 0) 1.0 200)
    (sleep 600)
    ...
    (object_set_scale (ai_vehicle_get_from_squad "outpost_fork03" 0) 1.0 200)
    (sleep 400)
    ...
    (object_set_scale (ai_vehicle_get_from_squad "outpost_banshees" 0) 1.0 200)
    (object_set_scale (ai_vehicle_get_from_squad "outpost_banshees" 1) 1.0 200)
...
(script command_script void cs_outpost_fork_entry
    ...
    (cs_vehicle_boost false)
    (cs_vehicle_speed 0.6)
    (cs_fly_by "pts_outpost_ext/fork_entry01a" 1.0)
    (cs_vehicle_speed 0.4)
    (begin_random_count
        1
        (cs_fly_to_and_face "pts_outpost_ext/fork_entry01b" "pts_outpost_ext/face01" 1.0)
        (cs_fly_to_and_face "pts_outpost_ext/fork_entry01b" "pts_outpost_ext/face02" 1.0)
    )
    (cs_fly_to "pts_outpost_ext/fork_entry01b" 1.0)
    (f_unload_fork (ai_vehicle_get ai_current_actor) "dual")
    (cs_enable_targeting true)
    (cs_enable_looking true)
    (cs_enable_moving true)
...
(script command_script void cs_outpost_fork02_entry
    ...
    (begin_random_count
        1
        (cs_fly_to_and_face "pts_outpost_ext/fork_entry01b" "pts_outpost_ext/face01" 2.0)
        (cs_fly_to_and_face "pts_outpost_ext/fork_entry01b" "pts_outpost_ext/face02" 2.0)
    )
    (f_unload_fork (ai_vehicle_get ai_current_actor) "dual")
    (cs_enable_targeting true)
    (cs_enable_looking true)
...
(script command_script void cs_outpost_fork03_entry
    (if (= (game_difficulty_get) legendary) 
        (f_load_fork (ai_vehicle_get ai_current_actor) "dual" "outpost_ext_skirms03" "outpost_ext_grunts03" "outpost_ext_jacks03" "outpost_ext_cov03_legendary") (f_load_fork (ai_vehicle_get ai_current_actor) "dual" "outpost_ext_jacks03" "outpost_ext_cov03" "outpost_ext_skirms03" "outpost_ext_grunts03"))
    (cs_enable_pathfinding_failsafe true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_outpost_ext/fork_entry01aa")
    (cs_vehicle_boost false)
...
(script dormant void outpost_int_start
    ...
    (thespian_performance_setup_and_begin "vig_outpost_trooper" "" 0.0)
    ...
    (device_set_position_immediate "dm_outpost_door03" 0.0)
    (game_save)
    ...
    (device_set_position "dm_outpost_door02" 0.0)
    (object_hide player0 true)
    (object_hide player1 true)
    (object_hide player2 true)
    (object_hide player3 true)
    ...
    (thespian_performance_setup_and_begin "vig_outpost_elite_intro" "" 0.0)
    (test_glowstick02)
    ...
    (game_save)
    (ai_bring_forward "group_jorge" 4.0)
    ...
    (device_set_power "dc_outpost_end" 1.0)
    (sleep_until (> (device_get_position "dc_outpost_end") 0.0) 1)
...
(script dormant void outpost_server_door_close
    ...
    (device_set_power "dm_outpost_server_door_init" 1.0)
    (device_set_position "dm_outpost_server_door_init" 0.0)
    (sleep_until (= (device_get_position "dm_outpost_server_door_init") 0.0))
...
(script dormant void outpost_hud_body_start
    ...
    (sleep_until 
        (or
            (objects_can_see_object player0 "sc_hud_outpost_body" 25.0)
            (objects_can_see_object player1 "sc_hud_outpost_body" 25.0)
            (objects_can_see_object player2 "sc_hud_outpost_body" 25.0)
            (objects_can_see_object player3 "sc_hud_outpost_body" 25.0)
        ) 
    1)
...
(script static boolean outpost_int_elite_back_prep
    (and
        (>= (object_get_shield (object_get_ai "outpost_int_elites01")) 0.7)
...
(script dormant void outpost_servers
    ...
    (device_set_position "dm_server03" 0.0)
    (device_set_position "dm_server06" 0.2)
    (sleep_until (volume_test_players "vol_outpost_int_back_hall01") 5)
    (device_set_position "dm_server06" 0.0)
    (sleep 10)
    (device_set_position "dm_server07" 0.0)
    (sleep 14)
    (device_set_position "dm_server11" 0.3)
    (sleep 9)
    (device_set_position "dm_server13" 0.3)
    (sleep 35)
    (device_set_position "dm_server02" 1.0)
    (sleep 3)
    (device_set_position "dm_server03" 1.0)
    (sleep 9)
    (device_set_position "dm_server04" 1.0)
    (sleep 9)
    ...
    (sleep_until 
        (begin
            (begin_random_count
                1
                (device_set_position "dm_server06" (real_random_range 0.0 0.3))
                (device_set_position "dm_server07" (real_random_range 0.0 0.3))
                (device_set_position "dm_server10" 0.0)
                (device_set_position "dm_server10" 1.0)
                (device_set_position "dm_server11" (real_random_range 0.0 0.3))
            )
...
(script dormant void outpost_servers_end
    ...
    (device_set_position "dm_server01" 1.0)
    (device_set_position "dm_server02" 1.0)
    (device_set_position "dm_server03" 1.0)
    (device_set_position "dm_server04" 1.0)
    (device_set_position "dm_server05" 1.0)
    (device_set_position "dm_server06" 1.0)
    (device_set_position "dm_server07" 1.0)
    (device_set_position "dm_server08" 1.0)
    (device_set_position "dm_server09" 1.0)
    (device_set_position "dm_server10" 1.0)
    (device_set_position "dm_server11" 1.0)
    (device_set_position "dm_server12" 1.0)
    (device_set_position "dm_server13" 1.0)
    (device_set_position "dm_server14" 1.0)
    (device_set_position "dm_server15" 1.0)
    (device_set_position "dm_server16" 1.0)
)
...
(script static boolean bob_will_run_from_player (player player_num, ai bob)
    (and
        (or
            ...
            (< (objects_distance_to_object player_num bob) 25.0)
        )
    ...
    (sleep_until 
        (begin
            (if (volume_test_players "vol_recycle_barn") 
                (recycle_barn_lite_go) (recycle_barn_go))
            (if (volume_test_players "vol_recycle_meadow") 
                (recycle_meadow_lite_go) (recycle_meadow_go))
            (if (volume_test_players "vol_recycle_3kiva") 
                (recycle_3kiva_lite_go) (recycle_3kiva_go))
            (if (volume_test_players "vol_recycle_3kiva01") 
                (recycle_3kiva01_lite_go) (recycle_3kiva01_go))
            (if (volume_test_players "vol_recycle_3kiva02") 
                (recycle_3kiva02_lite_go) (recycle_3kiva02_go))
            (if (volume_test_players "vol_recycle_3kiva03") 
                (recycle_3kiva03_lite_go) (recycle_3kiva03_go))
            (if (volume_test_players "vol_recycle_cliffside") 
                (recycle_cliffside_lite_go) (recycle_cliffside_go))
            (if (volume_test_players "vol_recycle_outpost") 
                (recycle_outpost_lite_go) (recycle_outpost_go))
            false
        ) 
    400)
)
...
(script static void objects_manage_5
    ...
    (if (not (>= (game_coop_player_count) 3)) 
        (object_create_folder "cr_3kiva02_no3coop") (object_destroy_folder "cr_3kiva02_no3coop"))
...
(script dormant void rain_start
    (if (>= (game_coop_player_count) 3) 
        (sleep_forever))
    (print "rain_start")
    (weather_animate_force "light_rain_far" 1.0 0.0)
    (sleep_until (>= g_1stbowl_obj_control 20))
    (sleep_until (not (any_players_in_vehicle)))
    (weather_animate_force "light_rain" 1.0 5.0)
    (sleep_until (volume_test_players "vol_barn_start"))
...
(script dormant void rain_barn_start
    (if (>= (game_coop_player_count) 3) 
        (sleep_forever))
    (weather_animate_force "heavy_rain" 1.0 5.0)
    (print "rain_barn_start")
    (if (game_is_cooperative) 
        (begin
            (sleep_until (volume_test_players "tv_barn_bloodtrail02"))
            (weather_animate_force "off" 1.0 3.0)
        )
    )
...
(script dormant void rain_3kiva_start
    ...
    (sleep_until 
        (begin
            ...
            (sleep (random_range (* 30.0 5.0) (* 30.0 25.0)))
            (weather_animate_force "light_rain" 1.0 (random_range 5 15))
            (sleep (random_range (* 30.0 15.0) (* 30.0 20.0)))
            (weather_animate_force "off" 1.0 (random_range 5 15))
            (sleep (random_range (* 30.0 15.0) (* 30.0 30.0)))
            false
        )
    )
)
...
(script dormant void rain_outpost_start
    ...
    (weather_animate_force "off" 1.0 5.0)
)
...
(script dormant void md_1stbowl_beacon_found
    ...
    (sleep_until (object_running_sync_action (ai_get_object "group_kat") "spartan_inspect_debris") 1 (* 30.0 9.0))
...
(script dormant void md_1stbowl_stand_down01
    ...
    (sleep_until (= (object_get_health "sc_1stbowl_propane01") 0.0))
    (sleep_until (not b_is_dialogue_playing) 5)
...
(script dormant void md_3kiva_kiva01_done
    ...
    (ai_dialogue_enable true)
    (sleep 100)
    (sleep_until (not (volume_test_players "tv_kiva01_center")) 30 (* 30.0 500.0))
...
(script dormant void sound_1stbowl_falcons
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "rotor_audio" 1.0 0.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "engine_audio" 0.6 0.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "rotor_audio" 1.0 0.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "engine_audio" 0.6 0.0)
    (sleep_until (>= (device_get_position "dm_falcon01_start") 0.22) 5)
    (print "sound_1stbowl_falcons: slow down to the hover")
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "rotor_audio" 0.6 60.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "rotor_audio" 0.6 60.0)
    (sleep_until (= g_1stbowl_obj_control 7) 5)
    (print "sound_1stbowl_falcons: speed up again")
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "rotor_audio" 1.0 60.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "rotor_audio" 1.0 60.0)
    (sleep_until (>= (device_get_position "dm_falcon01_start") 0.9) 5)
    (print "sound_1stbowl_falcons: hovering to drop off")
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "rotor_audio" 0.2 60.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "engine_audio" 0.2 60.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "rotor_audio" 0.2 60.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "engine_audio" 0.2 60.0)
    (sleep_until (>= (device_get_position "dm_falcon02_start") 0.9) 5)
    (print "sound_1stbowl_falcons: falcon02 takes off")
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "rotor_audio" 1.0 60.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_02" 0) "engine_audio" 0.6 60.0)
    (sleep_until (not (any_players_in_vehicle)) 5)
    (print "sound_1stbowl_falcons: falcon01 takes off")
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "rotor_audio" 1.0 60.0)
    (object_set_cinematic_function_variable (ai_vehicle_get_from_squad "intro_falcon_01" 0) "engine_audio" 0.6 60.0)
)
...
(script dormant void music_1stbowl
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music01" none 1.0)
    (sleep_until g_music02 5)
    (print "music change: gas kiva- found the beacon")
    (sound_looping_stop "levels\solo\m10\music\m10_music01")
    (sound_looping_start "levels\solo\m10\music\m10_music02" none 1.0)
    (sleep_until g_music03 5)
    (print "music change: double time it")
    (sound_looping_start "levels\solo\m10\music\m10_music03" none 1.0)
)
...
(script dormant void music_barn
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music04" none 1.0)
    (sleep_until g_music03 5)
...
(script dormant void music_meadow
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music05" none 1.0)
    (sleep_until g_music02 5)
...
(script dormant void music_3kiva
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music08" none 1.0)
...
(script dormant void music_3kiva01
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music06" none 1.0)
    (sleep_until 
        (or
            3kiva01_done
...
(script dormant void music_3kiva02
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music07" none 1.0)
    (sleep_until g_music04 5)
...
(script dormant void music_outpost_ext
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music09" none 1.0)
    (sleep_until g_music03 5)
...
(script dormant void music_outpost_int
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music10" none 1.0)
    (sleep_until g_music03 5)
...
(script dormant void music_alpha
    ...
    (sound_looping_start "levels\solo\m10\music\m10_music11" none 1.0)
...
(script static boolean branch_vig_damage_hack (ai my_actor)
    (or
        (> (object_get_recent_shield_damage (ai_get_object my_actor)) 0.3)
        (> (object_get_recent_body_damage (ai_get_object my_actor)) 0.0)
    )
)
...
(script dormant void hud_witnesses
    (sleep_until (objects_can_see_object player0 "sc_hud_1stbowl_kiva01" 25.0) 5 (* 5.0 30.0))
    (f_hud_flash_object "sc_hud_1stbowl_kiva_highlight")
)

(script dormant void 3kiva01_hud
    (sleep_until (player_can_see_or_dist "sc_hud_3kiva01_center" 20 10) 5 (* 5.0 30.0))
    (wake md_3kiva01_heat)
    (f_hud_flash_object "sc_hud_3kiva01_highlight")
)

(script dormant void 3kiva02_hud
    (sleep_until (player_can_see_or_dist "sc_hud_3kiva02" 25 10) 5 (* 5.0 30.0))
    (f_hud_flash_object "sc_hud_3kiva02_highlight")
)

(script dormant void 3kiva03_hud
    (sleep_until (player_can_see_or_dist "sc_hud_3kiva03" 25 10) 5 (* 5.0 30.0))
)
...
(script static void hud_info_object (object_name hud_object, string wp_callout_type)
    ...
    (sleep 80)
    (sleep_until (not (objects_can_see_object player0 hud_object 35.0)) 5 150)
...
(script static void training_motion_tracker
    (chud_show_motion_sensor false)
    (chud_set_static_hs_variable player0 4 1.0)
...
(script dormant void ct_training_enterexit_start
    ...
    (if (= (game_difficulty_get) legendary) 
        (sleep_forever))
    (sleep_until (>= 10.0 (objects_distance_to_object player0 "v_3kiva_pickup_init")) 5)
    (f_blip_object_offset "v_3kiva_pickup_init" blip_default 1)
    (sleep_until 
        (begin
            (sleep_until (player_can_see_and_dist "v_3kiva_pickup_init" 10 5) 5)
            (f_hud_training_forever player0 "ct_training_enterexit")
            (sleep_until (not (<= (objects_distance_to_object player0 "v_3kiva_pickup_init") 6.0)) 5)
            (f_hud_training_clear player0)
            false
        )
    )
...
(script dormant void training_health
    ...
    (if (= (game_difficulty_get) legendary) 
        (sleep_forever))
    (if (>= (unit_get_health player0) 1.0) 
        (sleep_forever))
    (sleep_until (< (objects_distance_to_object "dc_outpost_health" player0) 4.0) 1)
...
(script dormant void ct_training_activate_start
    (branch
        (>= (device_get_position "dc_outpost_end") 1.0)
        (f_unblip_object "dc_outpost_end")
    )
    (if (= (game_difficulty_get) legendary) 
        (sleep_forever))
    (f_blip_object "dc_outpost_end" blip_interface)
    (sleep_until (>= (device_get_position "dc_outpost_end") 1.0) 5)
    (f_unblip_object "dc_outpost_end")
)
...
(script static boolean obj_3foot__10_7
    (and
        (volume_test_object "vol_3kiva01_approach02" obj_carter)
        3kiva01_done
    )
)
...
(script static boolean obj_3carte_17_3
    (<= (objects_distance_to_object "cr_3kiva_hogsite02" (ai_get_object "group_carter")) 12.0)
)
...
(script static boolean obj_3jorge_17_5
    (<= (objects_distance_to_object "cr_3kiva_hogsite02" (ai_get_object "group_jorge")) 12.0)
)

(script static boolean obj_3clean_17_6
    (and
        (<= (ai_living_count "obj_3kiva02_cov") 5)
        (>= g_3kiva_obj_control 3)
    )
)
...
(script static boolean obj_3carte_20_4
    (<= (objects_distance_to_object "cr_3kiva_hogsite03" (ai_get_object "group_carter")) 12.0)
)

(script static boolean obj_3jorge_20_5
    (<= (objects_distance_to_object "cr_3kiva_hogsite03" (ai_get_object "group_jorge")) 12.0)
)
...
(script static void ins_barn
    ...
    (sleep 5)
    (object_set_velocity (ai_vehicle_get_from_squad "intro_falcon_01" 0) 0.0 0.0 10.0)
    (wake rain_start)
    (ai_dialogue_enable false)
...
(script static void test_1stbowl_falcons_loop
    ...
    (sleep_until 
        (begin
            (objects_attach "dm_falcon01_start" "" (ai_vehicle_get_from_squad "intro_falcon_01" 0) "")
            (objects_attach "dm_falcon02_start" "" (ai_vehicle_get_from_squad "intro_falcon_02" 0) "")
            (device_set_position_track "dm_falcon01_start" "m10_insert_dropoff_a" 0.0)
            (device_animate_position "dm_falcon01_start" 1.0 50.0 0.1 0.1 false)
            (device_set_position_track "dm_falcon02_start" "m10_insert_dropoff_b" 0.0)
            (device_animate_position "dm_falcon02_start" 1.0 55.0 0.1 0.1 false)
            (sleep_until 
                (and
                    (= (device_get_position "dm_falcon01_start") 1.0)
                    (= (device_get_position "dm_falcon02_start") 1.0)
                )
            )
            (sleep 90)
            (objects_detach "dm_falcon01_start" (ai_vehicle_get_from_squad "intro_falcon_01" 0))
...
(script static void test_1stbowl_falcons_endpoints
    (device_set_position_track "dm_falcon01_start" "m10_dropoff" 0.0)
...
(script static void test_1stbowl_falcons_end
    ...
    (object_set_velocity (ai_vehicle_get_from_squad "intro_falcon_02" 0) 0.0 0.0 0.7)
    (cs_run_command_script (f_ai_get_vehicle_driver "intro_falcon_02") cs_intro_falcons_02)
)
...
(script static void test_outpost_interior_hall01
    ...
    (sleep_until (volume_test_players "vol_outpost_int_back_hall01") 5)
    (game_save)
    (ai_bring_forward obj_jorge 2.0)
    (wake md_outpost_flush)
    (sleep 100)
...
(script static void 010la_outpost_050_sc_sh1
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 5) "engine_rpm" 1.0 0.0)
    (begin
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 5) "engine_exhaust" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "engine_exhaust" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 5) "driver_seat_power" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "driver_seat_power" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 5) "thrust" 0.5 0.0)
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "thrust" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 5) "blur" 1.0 0.0)
    (cinematic_sleep 75)
...
(script static void 010la_outpost_050_sc_sh2
    ...
    (render_exposure 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 24) "camera" 1.0 0.0)
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 24) "location" 0.1 0.0)
    (cinematic_sleep 101)
...
(script static void 010la_outpost_055_sc_sh1
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 1) "thrust" 0.5 0.0)
    (cinematic_print "custom script play")
    (begin
        (object_set_model_state_property (cinematic_object_get "falcon1new") 0 true)
        (object_set_model_state_property (cinematic_object_get "falcon2new") 0 true)
    )
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 1) "engine_exhaust" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 0) "engine_exhaust" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 1) "driver_seat_power" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 0) "thrust" 0.5 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 0) "engine_rpm" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 0) "driver_seat_power" 1.0 0.0)
...
(script static void 010lc_bodysearch_010_sc_sh1
    ...
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 9) "primary_ammunition_tens" 0.3 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 9) "primary_ammunition_ones" 0.2 0.0)
...
(script static void 010lc_bodysearch_020_sc_sh4
    ...
    (render_exposure 1.0 0.0)
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 5) "blade_activate" 0.0 0.0)
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    (unit_set_active_camo (cinematic_unit_get "elite01") true 1.0)
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "carter_ar_weapon") false)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "player_ar_weapon") false)
    (cinematic_sleep 44)
    ...
    (cinematic_sleep 52)
    (unit_set_active_camo (cinematic_unit_get "elite01") false 1.0)
    (cinematic_print "custom script play")
    (cinematic_sleep 23)
    (cinematic_scripting_start_music 1 3 1)
    (cinematic_sleep 7)
    (cinematic_scripting_start_effect 1 3 0 (cinematic_object_get "fx_console_sparks"))
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 5) "blade_activate" 1.0 16.0)
    (cinematic_sleep 38)
    (cinematic_lights_destroy_shot)
    (cinematic_clips_destroy)
    (render_exposure_fade_out 0.0)
...
(script static void 010lc_bodysearch_020_sc_sh5
    ...
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    (unit_set_active_camo (cinematic_unit_get "elite02") true 1.0)
    (cinematic_print "custom script play")
    (unit_set_active_camo (cinematic_unit_get "elite03") true 1.0)
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "player_ar_weapon") false)
    (cinematic_print "custom script play")
    (cinematic_sleep 20)
    (cinematic_print "custom script play")
...
(script static void 010lc_bodysearch_030_sc_sh1
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 5) "blade_right_on" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 18) "primary_ammunition_tens" 0.0 0.0)
    (object_set_permutation (cinematic_object_get "player") "flair_head_a" "player_will")
    (object_set_permutation (cinematic_object_get "player") "flair_head_b" "player_will")
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    ...
    (object_cinematic_visibility (cinematic_object_get "elite02") false)
    (cinematic_print "custom script play")
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 1) "primary_ammunition_tens" 0.3 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 1) "primary_ammunition_ones" 0.2 0.0)
    (object_set_permutation (cinematic_object_get "console_screen") "screen" "destroyed")
    (cinematic_show_letterbox_immediate false)
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    ...
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 18) "primary_ammunition_ones" 0.7 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 18) "primary_ammunition_ones" 0.7 0.0)
    (object_set_permutation (cinematic_object_get "player") "flair_left_shoulder" "player_vinh")
    (cinematic_print "custom script play")
    (object_set_permutation (cinematic_object_get "player") "flair_chest_b" "player_will")
    ...
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 18) "primary_ammunition_tens" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 4) "blade_activate" 1.0 0.0)
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "carter_ar_weapon") false)
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    (begin
    ...
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "carter_ar_weapon") false)
    (cinematic_sleep 2)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 4) "blade_activate" 0.0 12.0)
    (cinematic_sleep 8)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "carter_ar_weapon") true)
    (cinematic_sleep 22)
    ...
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "carter_ar_weapon") false)
    (cinematic_sleep 45)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 5) "blade_right_on" 1.0 9.0)
    (cinematic_sleep 141)
    (cinematic_print "custom script play")
    ...
    (cinematic_print "custom script play")
    (cinematic_sleep 7)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 5) "blade_right_on" 0.0 9.0)
    (cinematic_sleep 2)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "kat_pistol_weapon") true)
    (cinematic_sleep 1)
    ...
    (cinematic_sleep 244)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 18) "primary_ammunition_ones" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 18) "primary_ammunition_tens" 0.0 0.0)
    (cinematic_sleep 40)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 18) "primary_ammunition_ones" 0.2 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 2 18) "primary_ammunition_tens" 0.3 0.0)
    (cinematic_sleep 243)
