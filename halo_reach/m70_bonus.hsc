...
; Start time: 4/7/2022 7:05:58
; Decompilation finished in ~0.0026636s
...
(global real r_p0_damage_tracker 0.0)
(global real r_p0_shield_last 1.0)
(global real r_p0_health_last 1.0)
(global real r_p1_damage_tracker 0.0)
(global real r_p1_shield_last 1.0)
(global real r_p1_health_last 1.0)
(global real r_p2_damage_tracker 0.0)
(global real r_p2_shield_last 1.0)
(global real r_p2_health_last 1.0)
(global real r_p3_damage_tracker 0.0)
(global real r_p3_shield_last 1.0)
(global real r_p3_health_last 1.0)
...
(script dormant void f_objects_manage
    (sleep_until 
        (begin
            (cond
                ((and
                    (= (current_zone_set_fully_active) s_set_hill)
                    (not (= s_zoneset_last_refreshed s_set_hill))
                )
                    (f_objects_hill_create)
                    (set s_zoneset_last_refreshed s_set_hill)
                )
                ((and
                    (= (current_zone_set_fully_active) s_set_cin_outro)
                    (not (= s_zoneset_last_refreshed s_set_cin_outro))
                )
...
(script dormant void sc_spawn_bottom
    (sleep_until 
        (begin
            (sleep_until (<= (+ (ai_living_count "sq_bot_01") (ai_living_count "sq_bot_02")) 3.0) 1)
...
(script dormant void sc_spawn_left
    (sleep_until 
        (begin
            (sleep_until (<= (+ (ai_living_count "sq_left_01") (ai_living_count "sq_left_02")) 3.0) 1)
            (print "spawn left 01")
            (sv_left01)
            (sleep 30)
            (sleep_until (<= (+ (ai_living_count "sq_left_01") (ai_living_count "sq_left_02")) 3.0) 1)
...
(script dormant void sc_spawn_right
    (sleep_until 
        (begin
            (sleep_until (<= (+ (ai_living_count "sq_right_01") (ai_living_count "sq_right_02")) 3.0) 1)
...
(script dormant void sc_spawn_top
    (sleep_until 
        (begin
            (sleep_until (<= (+ (ai_living_count "sq_top_01") (ai_living_count "sq_top_02")) 3.0) 1)
            (print "spawn top 01")
            (sv_top01)
            (sleep 30)
            (sleep_until (<= (+ (ai_living_count "sq_top_01") (ai_living_count "sq_top_02")) 3.0) 1)
...
(script static void f_cin_epilogue_prep
    ...
    (weather_animate_force "no_rain" 1.0 0.0)
)
        ...
        (begin
            ...
            (if 
                (and
                    ...
                    (begin
                        (set s_players_alive (+ s_players_alive 1.0))
                    )
            )
            (if 
                (and
...
(script static void f_hud_messages_player (player p)
    (chud_fade_messages_for_player p 0.0 30)
)
...
(script static void f_hud_weapons_player (player p)
    (chud_fade_weapon_stats_for_player p 0.0 30)
)
...
(script static void f_hud_grenades_player (player p)
    (chud_fade_grenades_for_player p 0.0 30)
)
...
(script static void f_hud_motion_player (player p)
    (chud_fade_motion_sensor_for_player p 0.0 30)
    (sleep 30)
    (chud_set_static_hs_variable p 4 1.0)
)
...
(script static void f_hud_shield_player (player p)
    (chud_fade_shield_for_player p 0.0 30)
)
...
(script static void f_hud_crosshair_player (player p)
    (chud_fade_crosshair_for_player p 0.0 30)
)
...
(script static void f_hud_crack_1_player (player p)
    (chud_set_static_hs_variable p 3 1.0)
)
...
(script static void f_hud_crack_2_player (player p)
    (chud_set_static_hs_variable p 2 1.0)
...
(script static boolean f_phantom_0_not_spawning
    (or
        ...
        (<= (object_get_health (ai_vehicle_get_from_squad "sq_hill_phantom_0" 0)) 0.0)
    )
)
...
(script static boolean f_phantom_1_not_spawning
    (or
        ...
        (<= (object_get_health (ai_vehicle_get_from_squad "sq_hill_phantom_1" 0)) 0.0)
    )
)
...
(script static boolean f_phantom_2_not_spawning
    (or
        ...
        (<= (object_get_health (ai_vehicle_get_from_squad "sq_hill_phantom_2" 0)) 0.0)
    )
)
...
(script static boolean f_phantom_3_not_spawning
    (or
        ...
        (<= (object_get_health (ai_vehicle_get_from_squad "sq_hill_phantom_3" 0)) 0.0)
    )
)
...
(script static boolean f_phantom_4_not_spawning
    (or
        ...
        (<= (object_get_health (ai_vehicle_get_from_squad "sq_hill_phantom_4" 0)) 0.0)
    )
)
...
(script command_script void f_cs_hill_phantom_init
    ...
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.0 (* 30.0 5.0))
...
(script command_script void f_cs_sq_hill_phantom_0
    (if 
        (and
            (not (= ai_phantom_0_v1 none))
            (= ai_phantom_0_v2 none)
        ) 
            (begin
...
(script command_script void f_cs_sq_hill_phantom_1
    (if 
        (and
            (not (= ai_phantom_1_v1 none))
            (= ai_phantom_1_v2 none)
        ) 
            (begin
                (print "load single")
...
(script command_script void f_cs_sq_hill_phantom_2
    (if 
        (and
            (not (= ai_phantom_2_v1 none))
            (= ai_phantom_2_v2 none)
        ) 
            (begin
...
(script command_script void f_cs_sq_hill_phantom_3
    (if 
        (and
            (not (= ai_phantom_3_v1 none))
            (= ai_phantom_3_v2 none)
        ) 
            (begin
                (print "load single")
...
(script command_script void f_cs_sq_hill_phantom_4
    (if 
        (and
            (not (= ai_phantom_4_v1 none))
            (= ai_phantom_4_v2 none)
        ) 
            (begin
...
(script dormant void music_hill
    ...
    (sound_looping_start "levels\solo\m70_bonus\music\m70b_music_01" none 1.0)
)
                ...
                (begin
                    ...
                    (cond
                        ((= s_rain_force 1)
                            (begin
                                (dprint "heavy")
                                (weather_animate_force "heavy_rain" 1.0 (random_range 10 15))
                            )
                        )
                        ((= s_rain_force 2)
                            (begin
...
(script static void f_rain_kill
    (weather_animate_force "off" 1.0 0.0)
)
...
(script static void 080lb_re_intro_000_sc_sh1
    ...
    (cinematic_clips_initialize_for_shot 0)
    (cinematic_scripting_start_music 0 0 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 3) "banshee_speed" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "wingtips" 0.25 0.0)
    (cinematic_scripting_start_music 0 0 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 3) "wingtips" 0.25 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 4) "banshee_speed" 1.0 0.0)
    (cinematic_sleep 130)
...
(script static void 080lc_game_over_000_sc_sh1
    ...
    (cinematic_print "custom script play")
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "primary_ammunition_ones" 0.2 0.0)
    (begin
        (chud_set_static_hs_variable player0 2 1.0)
        (chud_set_static_hs_variable player1 2 1.0)
        (chud_set_static_hs_variable player2 2 1.0)
        (chud_set_static_hs_variable player3 2 1.0)
    )
    (cinematic_print "custom script play")
    (cinematic_scripting_start_music 0 0 0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 8) "primary_ammunition_tens" 0.3 0.0)
    (begin
        (chud_set_static_hs_variable player0 3 1.0)
        (chud_set_static_hs_variable player1 3 1.0)
        (chud_set_static_hs_variable player2 3 1.0)
        (chud_set_static_hs_variable player3 3 1.0)
    )
    (cinematic_print "custom script play")
...
(script static void 080lc_game_over_000_sc_sh2
    ...
    (chud_cinematic_fade 0.0 0.0)
    (begin
        (chud_set_static_hs_variable player0 4 0.0)
        (chud_set_static_hs_variable player1 4 0.0)
        (chud_set_static_hs_variable player2 4 0.0)
        (chud_set_static_hs_variable player3 4 0.0)
    )
    (begin
        (chud_set_static_hs_variable player0 2 0.0)
        (chud_set_static_hs_variable player1 2 0.0)
        (chud_set_static_hs_variable player2 2 0.0)
        (chud_set_static_hs_variable player3 2 0.0)
    )
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    (begin
        (chud_set_static_hs_variable player0 3 0.0)
        (chud_set_static_hs_variable player1 3 0.0)
        (chud_set_static_hs_variable player2 3 0.0)
        (chud_set_static_hs_variable player3 3 0.0)
    )
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    (cinematic_sleep 9)
    (cinematic_print "custom script play")
    (fade_in 0.0 0.0 0.0 3)
    (cinematic_sleep 35)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "elite_01_plasma_rifle_weapon") true)
    (cinematic_sleep 46)
...
(script static void 080lc_game_over_010_sc_sh1
    (set shadow_apply_depth_bias -0.00001)
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 16) "primary_ammunition_tens" 0.3 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 16) "primary_ammunition_ones" 0.2 0.0)
    (begin
        (chud_cinematic_fade 0.0 0.0)
        (chud_show_cinematics true)
    )
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "blade_activate" 0.0 0.0)
    (cinematic_print "custom script play")
    (cinematic_print "custom script play")
    (begin
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 8) "blade_right_on" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 10) "blade_right_on" 0.0 0.0)
    (cinematic_print "custom script play")
    (begin
    ...
    (cinematic_sleep 1)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 14) "blade_activate" 0.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 3) "blade_activate" 1.0 0.0)
    (cinematic_sleep 2)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "elite_01_plasma_rifle_weapon") true)
    (cinematic_sleep 15)
    ...
    (cinematic_sleep 2)
    (cinematic_print "custom script play")
    (damage_object (cinematic_object_get "elite_01") "body" 80.0)
    (cinematic_sleep 8)
    ...
    (cinematic_sleep 17)
    (cinematic_print "custom script play")
    (damage_object (cinematic_object_get "elite_02") "body" 90.0)
    (cinematic_sleep 15)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 3) "blade_activate" 0.0 8.0)
    (cinematic_sleep 52)
    (cinematic_print "custom script play")
    (damage_object (cinematic_object_get "elite_02") "body" 90.0)
    (cinematic_print "custom script play")
    ...
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "player_pistol_weapon") false)
    (cinematic_sleep 4)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "blade_activate" 1.0 12.0)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "player_ar_weapon") false)
    (cinematic_sleep 3)
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "elite_03_plasma_rifle_weapon") false)
    ...
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "player_pistol_weapon") false)
    (cinematic_sleep 1)
    (damage_object (cinematic_object_get "elite_03") "body" 90.0)
    (cinematic_print "custom script play")
    (cinematic_sleep 2)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "player_ar_weapon") false)
    ...
    (cinematic_sleep 2)
    (cinematic_print "custom script play")
    (damage_object (cinematic_object_get "elite_04") "body" 90.0)
    (cinematic_sleep 1)
    (cinematic_print "custom script play")
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "player_pistol_weapon") false)
    (cinematic_sleep 1)
    ...
    (weapon_set_primary_barrel_firing (cinematic_weapon_get "player_pistol_weapon") false)
    (cinematic_sleep 58)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 8) "blade_right_on" 1.0 9.0)
    (cinematic_sleep 92)
    (cinematic_print "custom script play")
    (damage_object (cinematic_object_get "elite_06") "body" 90.0)
    (cinematic_sleep 46)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 12) "blade_activate" 0.0 8.0)
    (cinematic_sleep 52)
    (cinematic_print "custom script play")
    (damage_object (cinematic_object_get "elite_05") "body" 90.0)
    (cinematic_sleep 31)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 14) "blade_activate" 1.0 15.0)
    (cinematic_sleep 3)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 1 10) "blade_right_on" 1.0 9.0)
    (cinematic_sleep 24)
    (set shadow_apply_depth_bias -0.000001)
    (cinematic_lights_destroy_shot)
    (cinematic_clips_destroy)
    (render_exposure_fade_out 0.0)
)
