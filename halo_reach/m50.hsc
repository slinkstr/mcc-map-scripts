...
; Source file: m50.hsc
; Start time: 4/7/2022 7:06:08
; Decompilation finished in ~0.0066293s
...
(global short g_waypoint_timeout (* 30.0 90.0))
...
(global short evac_delay (* 30.0 10.0))
...
(global short objective_delay (* 30.0 2.0))
...
(script dormant void recycle_control
    (sleep_until 
        (begin
            ...
            (sleep (* s_recycle_interval 30.0))
            (or
                b_ready_started
                b_jetpack_low_started
...
(script command_script void cs_panoptical_falcon0
    ...
    (cs_fly_to "pts_panoptical_evac/f_exit0" 10.0)
...
(script command_script void cs_panoptical_falcon1
    ...
    (cs_fly_to "pts_panoptical_evac/f_exit1" 10.0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 5.0))
    (sleep (* 30.0 5.0))
    (ai_erase ai_current_squad)
)

(script dormant void panoptical_teddy_bear_achievement_check
...
(script dormant void towers_objective_control
    ...
    (device_set_position "dm_condo_door0" 1.0)
...
(script dormant void towers_patrol
    (sleep_until 
        (or
            ...
            (volume_test_players "tv_towers_stair_right")
        ) 
    5)
...
(script dormant void interior_objective_control
    ...
    (device_set_position_immediate "dm_condo_door0" 0.0)
    (sleep 1)
    (device_set_power "dm_condo_door0" 0.0)
...
(script dormant void interior_waypoint
    (sleep_until 
        (begin
            ...
            (cond
                ((or
                    (volume_test_players "tv_interior_wp_01")
                    (volume_test_players "tv_interior_wp_01a")
                )
                    (begin
                        (f_blip_flag "nav_interior_01" blip_default)
                        (sleep_until (not 
                            (or
                                (volume_test_players_all "tv_interior_wp_01")
                                (volume_test_players_all "tv_interior_wp_01a")
                            )
                        ) 1)
...
(script dormant void canyonview_objective_control
    ...
    (thespian_performance_setup_and_begin "panoptical_injured" "" 0.0)
    (sleep 1)
...
(script dormant void canyonview_counterattack
    ...
    (device_set_position "dm_canyonview_door1" 1.0)
    (sleep 1)
    (sleep_until (f_task_is_empty "obj_canyonview_cov/gate_main"))
    (set b_cv_complete true)
    (sleep (random_range (* 30.0 3.0) (* 30.0 5.0)))
...
(script static boolean cv_player_near_troopers
    (and
        ...
        (> (objects_distance_to_object (ai_get_object "gr_unsc") (player0)) 0.0)
    )
)
...
(script dormant void brute_intro
    ...
    (thespian_performance_setup_and_begin "canyonview_brute0" "" 0.0)
    (thespian_performance_setup_and_begin "canyonview_brute1" "" 0.0)
    (thespian_performance_setup_and_begin "canyonview_brute2" "" 0.0)
...
(script static boolean branch_brute2 (ai my_actor)
    (or
        (> (object_get_recent_shield_damage (ai_get_object my_actor)) 0.0)
        (> (object_get_recent_body_damage (ai_get_object my_actor)) 0.0)
...
(script dormant void canyonview_zone_set_control
    (device_set_position_immediate "dm_interior_door1" 0.0)
    (sleep_until (= (device_get_position "dm_interior_door1") 0.0))
...
(script dormant void moa_achieve_trigger_check
    (sleep_until 
        (or
...
(script dormant void atrium_combat_progression
    (sleep 10)
    (if (game_is_cooperative) 
        (set g_atrium_unsc_desired (- g_atrium_unsc_desired 2.0)))
    ...
    (device_set_power "dm_atrium_ctyd_door2" 1.0)
    (sleep_until 
        (and
            (> (device_get_position "atrium_elevator_call") 0.0)
    ...
    (device_set_position "dm_atrium_elevator_door0" 1.0)
    (f_blip_object "atrium_elevator_switch" blip_interface)
    (sleep_until (> (device_get_position "atrium_elevator_switch") 0.0))
    (device_set_power "atrium_elevator_switch" 0.0)
    (f_unblip_object "atrium_elevator_switch")
    (if (not (game_is_cooperative)) 
        (ai_player_remove_fireteam_squad player0 "fireteam_player0"))
    (device_set_position_track "atrium_elevator_platform" "position" 0.0)
    (device_animate_position "atrium_elevator_platform" 0.12 2.0 0.125 0.125 false)
    (sleep_until (>= (device_get_position "atrium_elevator_platform") 0.12))
    (device_set_position "dm_atrium_elevator_door0" 0.0)
    ...
    (sleep 10)
    (mus_stop mus_03)
    (device_animate_position "atrium_elevator_platform" 0.8125 20.0 1.0 1.0 false)
    (wake md_ready_intro)
    (sleep_until (>= (device_get_position "atrium_elevator_platform") 0.8125) 1)
    (device_set_position "dm_atrium_elevator_door1" 1.0)
    (sleep_until (>= (device_get_position "dm_atrium_elevator_door1") 1.0) 1)
    (device_animate_position "atrium_elevator_platform" 1.0 2.0 0.125 0.125 false)
)
...
(script dormant void atrium_waypoint
    ...
    (sleep_until 
        (or
            (>= (device_get_position "atrium_elevator_call") 1.0)
...
(script dormant void ready_objective_control
    ...
    (sleep 1)
    (thespian_performance_setup_and_begin "ready_injured" "" 0.0)
...
(script dormant void th_ready_point
    ...
    (thespian_performance_setup_and_begin "ready_point" "" 0.0)
)
...
(script dormant void jl_suit_up_sequence
    ...
    (thespian_performance_setup_and_begin "ready_odsts_suit_up" "" 0.0)
...
(script command_script void cs_rr_banshee01
    ...
    (cs_vehicle_boost true)
    (cs_fly_by "pts_rr_banshees/enter_01" 10.0)
    (cs_fly_by "pts_rr_banshees/approach_01" 10.0)
    ...
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 2.5))
    (sleep (* 30.0 2.5))
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_rr_banshee02
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_rr_banshees/enter_02" 10.0)
    (cs_fly_by "pts_rr_banshees/approach_02" 10.0)
    (cs_vehicle_boost false)
    ...
    (if 
        (and
            ...
            (begin
                (cs_vehicle_boost false)
                (cs_fly_by "pts_rr_banshees/split_02" 10.0)
                (cs_fly_by "pts_rr_banshees/approach_02" 10.0)
                (cs_fly_by "pts_rr_banshees/dive_02")
                (cs_vehicle_speed 0.9)
                (cs_fly_by "pts_rr_banshees/turn_02")
...
(script command_script void cs_rr_banshee03
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_rr_banshees/enter_03" 10.0)
    (cs_fly_by "pts_rr_banshees/approach_03" 10.0)
    (cs_vehicle_boost false)
    ...
    (if 
        (and
            ...
            (begin
                (cs_vehicle_boost false)
                (cs_fly_by "pts_rr_banshees/split_03" 10.0)
                (cs_fly_by "pts_rr_banshees/approach_03" 10.0)
                (cs_fly_by "pts_rr_banshees/dive_03")
                (cs_vehicle_speed 0.9)
                (cs_fly_by "pts_rr_banshees/turn_03")
...
(script dormant void remove_ready_triage
    ...
    (sleep_until 
        (and
            ...
            (= (device_get_position "dm_ready_door0") 0.0)
        )
    )
...
(script command_script void cs_remove_ready_triage
    ...
    (sleep_until (= (device_get_position "dm_ready_door0") 1.0))
    (ai_erase ai_current_actor)
)
...
(script dormant void jetpack_spawn_control
    ...
    (if (game_is_cooperative) 
        (set g_ready_odst_desired (- g_ready_odst_desired 2.0)))
...
(script dormant void jetpack_high_objective_control
    ...
    (device_set_position "dm_jh_lobby0" 0.0)
    (ai_erase "gr_cov_jl")
...
(script dormant void jh_spawn_control
    ...
    (if (game_is_cooperative) 
        (begin
            (set g_jh_civ_desired (- g_jh_civ_desired 2.0))
            (set g_jh_odst_desired (- g_jh_odst_desired 2.0))
        )
    )
...
(script dormant void jetpack_high_waypoint
    ...
    (wake hud_flash_evac)
    (sleep_until (>= objcon_jetpack_high 6) 5 (* 30.0 30.0))
...
(script dormant void trophy_objective_control
    ...
    (sleep_until 
        (or
            ...
            (volume_test_players "tv_objcon_trophy_040")
        ) 
    1)
    (if debug 
        (print "objective control: jetpack 005"))
...
(script command_script void cs_trophy_phantom0
    ...
    (cs_fly_by "pts_trophy_ph0/entry4" 5.0)
    (cs_fly_by "pts_trophy_ph0/entry3" 5.0)
    (cs_vehicle_speed 0.6)
    ...
    (cs_fly_by "pts_trophy_ph0/entry2" 5.0)
    (cs_fly_by "pts_trophy_ph0/entry1" 5.0)
...
(script command_script void cs_trohpy_dogfight_unsc0
    ...
    (object_set_scale (ai_vehicle_get ai_current_actor) 1.0 (* 30.0 5.0))
    (cs_enable_pathfinding_failsafe true)
    (cs_fly_by "pts_trophy_dogfight/entry0" 2.0)
    (cs_fly_by "pts_trophy_dogfight/entry1" 2.0)
    (cs_fly_to "pts_trophy_dogfight/hover0" 10.0)
    (cs_vehicle_speed 0.4)
...
(script dormant void trophy_doors
    (device_set_position "dm_trophy_door1" 1.0)
    (sleep_until (= (device_get_position "dm_trophy_door1") 1.0) 1)
...
(script dormant void trophy_waypoint
    ...
    (if (not b_trophy_complete) 
        (begin
            (if (>= (object_get_health (ai_vehicle_get_from_spawn_point "trophy_cov_shade0/gunner")) 0.0) 
                (f_blip_object (ai_vehicle_get_from_spawn_point "trophy_cov_shade0/gunner") blip_neutralize))
            (if (>= (object_get_health (ai_vehicle_get_from_spawn_point "trophy_cov_shade1/gunner")) 0.0) 
                (f_blip_object (ai_vehicle_get_from_spawn_point "trophy_cov_shade1/gunner") blip_neutralize))
        )
    )
    (sleep_until 
        (or
            (<= (object_get_health (ai_vehicle_get_from_spawn_point "trophy_cov_shade0/gunner")) 0.0)
            (<= (object_get_health (ai_vehicle_get_from_spawn_point "trophy_cov_shade1/gunner")) 0.0)
        )
    )
    (if (<= (object_get_health (ai_vehicle_get_from_spawn_point "trophy_cov_shade0/gunner")) 0.0) 
...
(script command_script void cs_ride_vehicle_route
    ...
    (cs_fly_to_and_face "falcon_enter/hover" "falcon_enter/land_facing" 1.0)
    (sleep (* 30.0 1.0))
    (cs_fly_to_and_face "falcon_ride/evac" "falcon_ride/evac_facing" 1.0)
    (sleep (* 30.0 2.0))
    (set b_falcon_evac_hover true)
    (sleep_until b_falcon_goto_load_hover)
    (cs_attach_to_spline "spline_falcon_ride")
    (cs_vehicle_speed 0.6)
    (cs_fly_by "falcon_ride/rooftop0_start" 1.0)
    (set b_rooftop0_start true)
    (cs_vehicle_speed 0.4)
    (cs_fly_by "falcon_ride/rooftop0_finish" 1.0)
    (set b_rooftop0_finish true)
    (cs_vehicle_speed 0.8)
    (cs_fly_to "falcon_ride/load_zone" 5.0)
    (cs_vehicle_speed 0.3)
    (set b_falcon_load_hover true)
    (cs_fly_to_and_face "falcon_ride/load_hover" "falcon_ride/load_zone_facing" 1.0)
    (sleep_until b_falcon_goto_lz_hover)
    (cs_vehicle_speed 0.7)
    (cs_fly_by "falcon_ride/rooftop2_start" 5.0)
    (set b_rooftop2_start true)
    (cs_fly_by "falcon_ride/transport" 5.0)
    (set b_falcon_transport true)
    (cs_vehicle_speed 0.9)
    (cs_fly_by "falcon_ride/park" 5.0)
    (set b_falcon_park true)
    (cs_fly_by "falcon_ride/lz_setup" 5.0)
    (set b_falcon_lz_setup true)
    (cs_fly_to "falcon_ride/park_detach" 5.0)
    (cs_attach_to_spline "")
    (cs_vehicle_speed 0.3)
...
(script command_script void cs_ride_vehicle0_route
    ...
    (cs_fly_to_and_face "falcon0_enter/hover" "falcon0_enter/land_facing" 1.0)
    (sleep (* 30.0 1.0))
    (cs_fly_to_and_face "falcon0_ride/evac" "falcon0_ride/evac_facing" 1.0)
    (sleep (* 30.0 2.0))
    (set b_falcon0_evac_hover true)
    (sleep_until b_falcon0_goto_load_hover)
    (cs_attach_to_spline "spline_falcon0_ride")
    (cs_vehicle_speed 0.6)
    (cs_fly_by "falcon0_ride/rooftop0_start" 1.0)
    (set b_rooftop0_start true)
    (cs_vehicle_speed 0.4)
    (cs_fly_by "falcon0_ride/rooftop0_finish" 1.0)
    (set b_rooftop0_finish true)
    (cs_vehicle_speed 0.8)
    (cs_fly_to "falcon0_ride/load_zone" 5.0)
    (cs_vehicle_speed 0.3)
    (set b_falcon0_load_hover true)
    (cs_fly_to_and_face "falcon0_ride/load_hover" "falcon0_ride/load_zone_facing" 1.0)
    (sleep_until b_falcon0_goto_lz_hover)
    (cs_vehicle_speed 0.7)
    (cs_fly_by "falcon0_ride/rooftop2_start" 5.0)
    (set b_rooftop2_start true)
    (cs_fly_by "falcon0_ride/transport" 5.0)
    (set b_falcon0_transport true)
    (cs_vehicle_speed 0.9)
    (cs_fly_by "falcon0_ride/park" 5.0)
    (set b_falcon0_park true)
    (cs_fly_by "falcon0_ride/lz_setup" 5.0)
    (set b_falcon0_lz_setup true)
    (cs_fly_to "falcon0_ride/park_detach" 5.0)
    (cs_attach_to_spline "")
    (cs_vehicle_speed 0.3)
...
(script dormant void ride_progression
        ...
        (begin
            ...
            (sleep_until 
                (begin
                    ...
                    (and
                        (or
                            (= (unit_in_vehicle_type player0 20) true)
                            (not (player_is_in_game player0))
                        )
                        (or
                            (= (unit_in_vehicle_type player1 20) true)
                            (not (player_is_in_game player1))
                        )
                        (or
                            (= (unit_in_vehicle_type player2 20) true)
                            (not (player_is_in_game player2))
                        )
                        (or
                            (= (unit_in_vehicle_type player3 20) true)
    ...
    (ai_designer_clump_perception_range 500.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee0/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee0/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee00/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee00/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee000/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee000/spawn_points_0") g_falcon_vitality 0.0)
    ...
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee01/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee01/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee02/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee02/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee03/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee03/spawn_points_0") g_falcon_vitality 0.0)
    ...
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee04/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee04/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee05/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee05/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee06/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee06/spawn_points_0") g_falcon_vitality 0.0)
    ...
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee07/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee07/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee08/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee08/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_current_vitality (ai_vehicle_get_from_starting_location "ride_banshee09/spawn_points_0") g_falcon_vitality 0.0)
    (unit_set_maximum_vitality (ai_vehicle_get_from_starting_location "ride_banshee09/spawn_points_0") g_falcon_vitality 0.0)
    (sleep_until 
        (or
            b_falcon_park
            b_falcon0_park
...
(script command_script void cs_ride_vehicle_exit
    ...
    (cs_ignore_obstacles true)
    (cs_vehicle_speed 0.2)
    (cs_fly_to_and_face "falcon_exit/p0" "falcon_exit/p1" 1.0)
    (cs_vehicle_speed 1.0)
    (cs_fly_by "falcon_exit/p1" 5.0)
    (cs_fly_by "falcon_exit/p2" 5.0)
    (cs_fly_by "falcon_exit/p3" 5.0)
    (ai_erase ai_current_actor)
)
...
(script command_script void cs_ride_vehicle0_exit
    ...
    (sleep (* 30.0 3.0))
    (cs_vehicle_speed 0.2)
    (cs_fly_to_and_face "falcon0_exit/p0" "falcon0_exit/p1" 1.0)
    (cs_vehicle_speed 1.0)
    (cs_fly_by "falcon0_exit/p1" 5.0)
    (cs_fly_by "falcon0_exit/p2" 5.0)
    (cs_fly_by "falcon0_exit/p3" 5.0)
    (ai_erase ai_current_actor)
)
...
(script command_script void cs_terminal_pelican0
    ...
    (cs_enable_pathfinding_failsafe true)
    (cs_vehicle_speed 1.0)
    (cs_fly_by "000_terminal_pelicans/pelican0_enter_p1" 5.0)
    (cs_fly_by "000_terminal_pelicans/pelican0_enter_p2a" 5.0)
    (cs_vehicle_speed 0.8)
    (cs_fly_to "000_terminal_pelicans/pelican0_hover" 1.0)
...
(script command_script void cs_terminal_pelican0_exit
    ...
    (sleep (* 30.0 0.0))
    (cs_vehicle_speed 0.4)
    (cs_fly_by "000_terminal_pelicans/pelican0_hover" 2.0)
    (cs_vehicle_speed 0.6)
    (cs_fly_by "000_terminal_pelicans/pelican0_p1" 2.0)
    (cs_vehicle_speed 0.8)
    (set b_banshee0_start true)
    (cs_fly_to "000_terminal_pelicans/pelican0_exit" 2.0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 5.0))
    (sleep (* 30.0 5.0))
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_terminal_pelican1_exit
    (unit_close (ai_vehicle_get ai_current_actor))
    (cs_vehicle_speed 0.4)
    (cs_fly_by "000_terminal_pelicans/pelican1_hover" 2.0)
    (cs_vehicle_speed 1.0)
    (cs_fly_by "000_terminal_pelicans/pelican1_p1" 2.0)
    (cs_fly_to "000_terminal_pelicans/pelican1_exit" 2.0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 5.0))
    (sleep (* 30.0 5.0))
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_terminal_pelican2_exit
    (unit_close (ai_vehicle_get ai_current_actor))
    (cs_vehicle_speed 0.4)
    (cs_fly_by "000_terminal_pelicans/pelican2_hover" 2.0)
    (cs_attach_to_spline "spline_pelican1_exit")
    (cs_vehicle_speed 1.0)
    (cs_fly_to "000_terminal_pelicans/pelican2_exit" 2.0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 5.0))
    (sleep (* 30.0 5.0))
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_ride_banshee0
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_000/enter_01" 10.0)
)
...
(script command_script void cs_ride_banshee00
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_000/enter_02" 10.0)
)
...
(script command_script void cs_ride_banshee000
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_000/enter_03" 10.0)
)
...
(script command_script void cs_ride_banshee01
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_123/enter_01" 10.0)
...
(script command_script void cs_ride_banshee02
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_123/enter_02" 10.0)
...
(script command_script void cs_ride_banshee03
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_123/enter_03" 10.0)
...
(script command_script void cs_ride_banshee123_swarm1
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_123/swarm1" 10.0)
)
...
(script command_script void cs_ride_banshee123_swarm2
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_123/exit_01" 10.0)
    (cs_fly_by "pts_ride_banshees_123/swarm2" 10.0)
)
...
(script command_script void cs_ride_banshee123_remove
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_123/remove_01" 10.0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 2.5))
    (sleep (* 30.0 2.5))
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_ride_banshee04
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_456/enter_01" 10.0)
    (cs_fly_by "pts_ride_banshees_456/approach_01" 10.0)
...
(script command_script void cs_ride_banshee05
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_456/enter_02" 10.0)
    (cs_fly_by "pts_ride_banshees_456/approach_02" 10.0)
...
(script command_script void cs_ride_banshee06
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_456/enter_03" 10.0)
    (cs_fly_by "pts_ride_banshees_456/approach_03" 10.0)
...
(script command_script void cs_ride_banshee456_swarm1
    ...
    (cs_fly_by "pts_ride_banshees_456/enter_01" 10.0)
    (cs_fly_by "pts_ride_banshees_456/approach_01" 10.0)
    (cs_fly_by "pts_ride_banshees_456/swarm1" 10.0)
)
...
(script command_script void cs_ride_banshee456_swarm2
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_456/turn_01" 10.0)
    (cs_fly_by "pts_ride_banshees_456/exit_01" 10.0)
    (cs_fly_by "pts_ride_banshees_456/split_01" 10.0)
    (cs_fly_by "pts_ride_banshees_456/swarm2" 10.0)
)
...
(script command_script void cs_ride_banshee456_remove
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_456/remove_01" 10.0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 2.5))
    (sleep (* 30.0 2.5))
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_ride_banshee789_swarm1
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_789/swarm1" 10.0)
)
...
(script command_script void cs_ride_banshee789_swarm2
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_789/swarm2" 10.0)
)
...
(script command_script void cs_ride_banshee789_swarm3
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_789/swarm3" 10.0)
)
...
(script command_script void cs_ride_banshee789_remove
    (cs_vehicle_boost true)
    (cs_fly_by "pts_ride_banshees_789/remove_01" 10.0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 2.5))
    (sleep (* 30.0 2.5))
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_ride_phantom0_route
    ...
    (cs_enable_pathfinding_failsafe true)
    (cs_vehicle_speed 0.8)
    (cs_fly_by "phantom0_ride/p0" 5.0)
    (cs_vehicle_speed 0.4)
    (cs_fly_by "phantom0_ride/p1" 5.0)
    (cs_fly_by "phantom0_ride/p2" 5.0)
    (cs_fly_by "phantom0_ride/p3" 5.0)
    (cs_fly_by "phantom0_ride/p4" 5.0)
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_ride_falcon1
    ...
    (cs_shoot true)
    (cs_vehicle_speed 0.3)
    (cs_fly_by "falcon1_ride/p0" 5.0)
    (cs_fly_by "falcon1_ride/p1" 5.0)
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_ride_falcon2
    ...
    (cs_shoot true)
    (cs_vehicle_speed 1.0)
    (cs_fly_by "falcon2_ride/p0" 5.0)
    (cs_fly_by "falcon2_ride/p1" 5.0)
    (ai_erase ai_current_squad)
)
...
(script dormant void starport_spawn_control
    ...
    (sleep 1)
    (thespian_performance_setup_and_begin "starport_intro" "" 0.0)
...
(script dormant void starport_ghosts_spawn_control
    ...
    (if (< (random_range 0 100) 50) 
        (ai_place "starport_cov_ghosts_ds0") (ai_place "starport_cov_ghosts_ds1"))
    (wake ghost2_reserve)
    (wake ghost3_reserve)
)

(script dormant void ghost0_reserve
    (sleep_until (not (vehicle_test_seat (ai_vehicle_get "starport_cov_ghost0/pilot") ghost_d)))
    (ai_vehicle_reserve (ai_vehicle_get_from_spawn_point "starport_cov_ghost0/pilot") true)
)

(script dormant void ghost1_reserve
    (sleep_until (not (vehicle_test_seat (ai_vehicle_get "starport_cov_ghost1/pilot") ghost_d)))
    (ai_vehicle_reserve (ai_vehicle_get_from_spawn_point "starport_cov_ghost1/pilot") true)
)

(script dormant void ghost2_reserve
    (sleep_until (not (vehicle_test_seat (ai_vehicle_get "starport_cov_ghost2/pilot") ghost_d)))
    (ai_vehicle_reserve (ai_vehicle_get_from_spawn_point "starport_cov_ghost2/pilot") true)
)

(script dormant void ghost3_reserve
    (sleep_until (not (vehicle_test_seat (ai_vehicle_get "starport_cov_ghost3/pilot") ghost_d)))
...
(script command_script void cs_starport_ghosts_dropship0
    ...
    (cs_fly_to "starport_ghosts_dropship0/hover" 5.0)
    (sleep 30)
    (cs_vehicle_speed 0.6)
    (cs_fly_to_and_face "starport_ghosts_dropship0/land" "starport_ghosts_dropship0/land_facing" 1.0)
    (sleep 10)
...
(script command_script void cs_starport_ghosts_dropship1
    ...
    (cs_fly_to "starport_ghosts_dropship1/hover" 5.0)
    (sleep 30)
    (cs_vehicle_speed 0.6)
...
(script command_script void cs_starport_phantom0
    ...
    (cs_vehicle_speed 0.6)
    (cs_fly_to_and_face "starport_ph0/hover" "starport_ph0/hover_facing" 1.0)
    (cs_vehicle_speed 0.4)
...
(script command_script void cs_starport_m0_pelican_land
    (cs_vehicle_speed 0.4)
    (cs_fly_to "starport_m0_pelican/hover" 1.0)
    (cs_vehicle_speed 0.2)
    (sleep 30)
    ...
    (vehicle_unload (ai_vehicle_get ai_current_actor) falcon_g)
    (sleep 90)
    (thespian_performance_setup_and_begin "starport_turret0_activate" "" 0.0)
...
(script command_script void cs_starport_m1_pelican_land
    (cs_vehicle_speed 0.4)
    (cs_fly_to "starport_m1_pelican/hover" 1.0)
    (cs_vehicle_speed 0.2)
    (sleep 30)
    ...
    (vehicle_unload (ai_vehicle_get ai_current_actor) falcon_g)
    (sleep 90)
    (thespian_performance_setup_and_begin "starport_turret1_activate" "" 0.0)
...
(script dormant void starport_turret0_control
    (sleep_until (> (device_get_position "turret0_switch") 0.0))
...
(script dormant void starport_turret1_control
    (sleep_until (> (device_get_position "turret1_switch") 0.0))
...
(script dormant void starport_firing_control
    ...
    (sleep_until (> (device_get_position "firing_control_switch") 0.0))
...
(script dormant void starport_secret_balcony_achievement_check
    (sleep_until 
        (or
...
(script static void 2
    (if ai_render_objectives 
        (set ai_render_objectives false) (set ai_render_objectives true))
)
...
(script static void 4
    (if ai_render_command_scripts 
        (set ai_render_command_scripts false) (set ai_render_command_scripts true))
)
...
(script static void 6
    (if debug_instanced_geometry_cookie_cutters 
        (set debug_instanced_geometry_cookie_cutters false) (set debug_instanced_geometry_cookie_cutters true))
)
...
(script dormant void hud_flash_tower
    ...
    (sleep_until (objects_can_see_object player0 "highlight_tower_box" 10.0) 5 (* 30.0 15.0))
...
(script dormant void hud_flash_evac
    ...
    (sleep_until (objects_can_see_object player0 "highlight_evac_box" 10.0) 5 (* 30.0 30.0))
...
(script dormant void hud_flash_evac0
    ...
    (sleep_until (objects_can_see_object player0 "highlight_evac0_box" 10.0) 5 (* 30.0 30.0))
    (f_hud_flash_object "sc_ui_highlight_evac")
...
(script dormant void md_cv_trooper_intro
    ...
    (if (>= (ai_living_count trooper1) 1) 
        (f_md_ai_play 0 trooper1 m50_0250) (f_md_object_play 0 none m50_0250))
    (if (player_has_female_voice player0) 
        (begin
            (md_print "a spartan?  where the hell'd she come from?")
            (if (>= (ai_living_count female_trooper1) 1) 
                (f_md_ai_play 0 female_trooper1 m50_0270) (f_md_object_play 30 none m50_0270))
        ) (begin
            (md_print "a spartan?  where the hell'd he come from?")
            (if (>= (ai_living_count female_trooper1) 1) 
                (f_md_ai_play 0 female_trooper1 m50_0260) (f_md_object_play 0 none m50_0260))
        )
    )
    (md_print "who cares? spartan, assist!")
    (if (>= (ai_living_count trooper1) 1) 
        (f_md_ai_play 0 trooper1 m50_0280) (f_md_object_play 0 none m50_0280))
    (md_finished)
    (if (not (game_is_cooperative)) 
        (begin
...
(script dormant void md_cv_how_to
    ...
    (if (>= (ai_living_count female_trooper1) 1) 
        (f_md_ai_play 0 female_trooper1 m50_0290) (f_md_object_play 0 none m50_0290))
    (md_print "elevator in the atrium goes down to the cargo port; cargo port goes to the tower!")
    (if (>= (ai_living_count trooper1) 1) 
        (f_md_ai_play 30 trooper1 m50_0300) (f_md_object_play 30 none m50_0300))
    (md_print "gotta get in there...")
    (if (>= (ai_living_count female_trooper1) 1) 
        (f_md_ai_play 0 female_trooper1 m50_0330) (f_md_object_play 0 none m50_0330))
    (sleep 60)
    (md_print "whoa!  contacts!  from the west!")
    (if (>= (ai_living_count trooper1) 1) 
        (f_md_ai_play 0 trooper1 m50_0240) (f_md_object_play 0 none m50_0240))
    (md_finished)
)
...
(script dormant void md_cv_encounter_complete
    ...
    (if (>= (ai_living_count trooper1) 1) 
        (f_md_ai_play 0 trooper1 m50_0340) (f_md_object_play 0 none m50_0340))
    (md_finished)
    (wake ct_objective_elevator_start)
)

(script dormant void md_atrium_elevator_call
    (sleep_until (> (device_get_position "atrium_elevator_call") 0.0) 1)
    (sleep (random_range (* 30.0 4.0) (* 30.0 6.0)))
    (begin
        ...
        (if (>= (ai_living_count trooper1) 1) 
            (f_md_ai_play 0 trooper1 m50_0460) (f_md_object_play 0 none m50_0460))
    )
    ...
    (begin
        ...
        (if (>= (ai_living_count trooper1) 1) 
            (f_md_ai_play 30 trooper1 m50_0490) (f_md_object_play 30 none m50_0490))
        (md_finished)
        (sleep (* 30.0 2.0))
    ...
    (if 
        (and
            ...
            (begin
                ...
                (if (>= (ai_living_count trooper1) 1) 
                    (f_md_ai_play 0 trooper1 m50_0510) (f_md_object_play 0 none m50_0510))
                (md_finished)
            )
    )
)
...
(script dormant void md_atrium_hunters_defeated
    ...
    (if (>= (ai_living_count trooper1) 1) 
        (f_md_ai_play 30 trooper1 m50_0530) (f_md_object_play 30 none m50_0530))
    (md_finished)
)
...
(script dormant void md_traxus_ai01
    ...
    (sound_impulse_start "sound\dialog\levels\m50\mission\m50_0410_tra" none 1.0)
    (md_finished)
)
...
(script dormant void md_traxus_ai02
    ...
    (sound_impulse_start "sound\dialog\levels\m50\mission\m50_0420_tra" none 1.0)
    (md_finished)
)
...
(script static void md_traxus_evac
    ...
    (sound_impulse_start "sound\dialog\levels\m50\mission\m50_0430_tra" none 1.0)
    (md_finished)
)
...
(script dormant void md_traxus_ai04
    ...
    (sound_impulse_start "sound\dialog\levels\m50\mission\m50_0450_tra" none 1.0)
    (md_finished)
)
...
(script dormant void md_traxus_ai_elevator
    ...
    (sound_impulse_start "sound\dialog\levels\m50\mission\m50_0500_tra" none 1.0)
    (md_finished)
)
...
(script static void md_play_info_booth
    ...
    (sound_impulse_start "sound\dialog\levels\m50\mission\m50_0450_tra" none 1.0)
    (md_finished)
    (set md_atruim_ai (+ md_atruim_ai 1.0))
)
...
(script dormant void md_atrium_ai_response
    ...
    (if (>= (ai_living_count trooper1) 1) 
        (f_md_ai_play 0 trooper1 m50_0440) (f_md_object_play 0 none m50_0440))
    (md_finished)
    (set md_atruim_ai_delay (+ md_atruim_ai_delay 500.0))
)
        ...
        (begin
            (cond
                ((and
                    ...
                    (>= (object_get_health "sc_info_booth_02") 1.0)
                )
                    (begin
                ...
                ((and
                    ...
                    (>= (object_get_health "sc_info_booth_03") 1.0)
                )
                    (begin
                ...
                ((and
                    ...
                    (>= (object_get_health "sc_info_booth_04") 1.0)
                )
                    (begin
                ...
                ((and
                    ...
                    (>= (object_get_health "sc_info_booth_05") 1.0)
                )
                    (begin
                ...
                ((and
                    ...
                    (>= (object_get_health "sc_info_booth_06") 1.0)
                )
                    (begin
                ...
                ((and
                    ...
                    (>= (object_get_health "sc_info_booth_07") 1.0)
                )
                    (begin
...
(script dormant void md_ready_outside_door
    ...
    (if (>= (ai_living_count trooper4) 1) 
        (f_md_ai_play 0 trooper4 m50_0570) (f_md_object_play 0 none m50_0570))
    (md_finished)
)
...
(script dormant void md_ready_odst_intro2
    ...
    (device_set_position "dm_ready_door1" 1.0)
    (device_set_position "dm_ready_door2" 1.0)
...
(script dormant void md_ready_player_get_jetpack
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0700) (f_md_object_play 0 none m50_0700))
    (md_finished)
...
(script dormant void md_jp_other_side
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0890) (f_md_object_play 0 none m50_0890))
    (md_finished)
)
...
(script dormant void md_jp_player_crosses
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0720) (f_md_object_play 0 none m50_0720))
    (md_finished)
...
(script dormant void md_jp_keep_moving01
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0830) (f_md_object_play 0 none m50_0830))
    (md_finished)
)
...
(script dormant void md_jp_keep_moving02
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0840) (f_md_ai_play 0 none m50_0840))
    (md_finished)
)
...
(script static void md_jp_take_elevator
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0870) (f_md_object_play 0 none m50_0870))
    (md_finished)
    (if (not (game_is_cooperative)) 
...
(script dormant void md_jp_theres_the_pad
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0900) (f_md_object_play 0 none m50_0900))
    (md_print "entrance on the other side!")
    (if (>= (ai_living_count trooper5_odst2) 1) 
        (f_md_ai_play 30 trooper5_odst2 m50_0910) (f_md_object_play 30 none m50_0910))
    (md_finished)
)
...
(script dormant void md_jp_second_floor
    ...
    (if (>= (ai_living_count trooper5_odst2) 1) 
        (f_md_ai_play 0 trooper5_odst2 m50_0880) (f_md_object_play 0 none m50_0880))
    (md_finished)
    (if (not (game_is_cooperative)) 
        (begin
...
(script dormant void md_jp_clear_the_pad
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0920) (f_md_object_play 0 none m50_0920))
    (md_finished)
...
(script dormant void md_jetpack_complete
    (sleep (random_range objective_delay (* objective_delay 2.0)))
    (md_prep)
    (md_print "yankee niner to echo dispatch: landing pad is clear!  send in the evac birds!")
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0930) (f_md_object_play 0 none m50_0930))
...
(script dormant void md_jp_flourish
    (sleep_until 
        (begin
            (sleep (random_range (* 30.0 15.0) (* 30.0 60.0)))
...
(script static void md_flourish_play (string text, ai squad, ai_line line)
    ...
    (if (>= (ai_living_count squad) 1) 
        (f_md_ai_play 0 squad line) (f_md_object_play 0 none line))
    (md_finished)
)
...
(script dormant void md_ride_start
    (md_prep)
    (thespian_performance_setup_and_begin "trophy_odst_salute" "" 0.0)
    (md_print "pleasure jumping with you, spartan.")
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0950) (f_md_object_play 0 none m50_0950))
    (md_print "we'll hold this location.  you get on that falcon, and make sure those transports make it out in one piece!")
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 30 trooper3_odst1 m50_0960) (f_md_object_play 30 none m50_0960))
    (md_finished)
    (if (not (game_is_cooperative)) 
        (begin
    ...
    (if (>= (ai_living_count trooper3_odst1) 1) 
        (f_md_ai_play 0 trooper3_odst1 m50_0970) (f_md_object_play 0 none m50_0970))
    (md_finished)
    (sleep objective_delay)
    (if (not 
        (or
...
(script dormant void md_ride_pilot_ready
    (sleep (random_range (* 30.0 5.0) (* 30.0 10.0)))
    (md_prep)
...
(script dormant void md_commander_dialogue
    ...
    (if (>= (ai_living_count trooper_sgt2) 1) 
        (f_md_ai_play 0 trooper_sgt2 m50_1400) (f_md_object_play 0 none m50_1400))
    (md_finished)
    (set b_starport_monologue true)
)
...
(script dormant void md_starport_tension_master
    ...
    (if (>= (ai_living_count trooper_sgt2) 1) 
        (f_md_ai_play 0 trooper_sgt2 m50_1420) (f_md_object_play 30 none m50_1420))
    (md_finished)
    (sleep_until 
        (or
            (volume_test_players "tv_md_starport_battery0")
            (volume_test_players "tv_md_starport_battery1")
        )
    )
    (md_print "that's the first missile battery, lieutenant!  get it armed!")
    (if (>= (ai_living_count trooper_sgt2) 1) 
        (f_md_ai_play 0 trooper_sgt2 m50_1430) (f_md_object_play 0 none m50_1430))
    (sleep_until 
        (or
            b_starport_turret0_ready
            b_starport_turret1_ready
    ...
    (cond
        (b_starport_turret0_ready
            (begin
                ...
                (if (>= (ai_living_count trooper_sgt2) 1) 
                    (f_md_ai_play 0 trooper_sgt2 m50_1440) (f_md_object_play 0 none m50_1440))
                (md_finished)
            )
        )
        (b_starport_turret1_ready
            (begin
                ...
                (if (>= (ai_living_count trooper_sgt2) 1) 
                    (f_md_ai_play 0 trooper_sgt2 m50_1450) (f_md_object_play 0 none m50_1450))
                (md_finished)
            )
        )
    )
    ...
    (if (>= (ai_living_count trooper_sgt2) 1) 
        (f_md_ai_play 30 trooper_sgt2 m50_1470) (f_md_object_play 30 none m50_1470))
    (md_finished)
    (mus_start mus_08)
    (sleep_until 
        (and
    ...
    (if (>= (ai_living_count trooper_sgt2) 1) 
        (f_md_ai_play 0 trooper_sgt2 m50_1480) (f_md_object_play 0 none m50_1480))
    ...
    (if (>= (ai_living_count trooper_sgt2) 1) 
        (f_md_ai_play 30 trooper_sgt2 m50_1500) (f_md_object_play 30 none m50_1500))
    (md_finished)
    ...
    (if (>= (ai_living_count trooper_sgt2) 1) 
        (f_md_ai_play 30 trooper_sgt2 m50_1520) (f_md_object_play 30 none m50_1520))
    (md_finished)
)
...
(script static void snd_loop (looping_sound s)
    (sound_looping_start s none 1.0)
)
...
(script static void snd_play (sound s)
    (sound_impulse_start s (player0) 1.0)
)

(script static void snd_play_all (sound s)
    (sound_impulse_start s none 1.0)
...
(script static void hud_flash_message (cutscene_title t, short count, short delay)
    ...
    (sleep_until 
        (begin
            ...
            (set s_hud_flash_count (+ s_hud_flash_count 1.0))
            (sleep delay)
            (>= s_hud_flash_count (- count 1.0))
        ) 
    1)
)
...
(script dormant void ambient_wraith_shells_a
    (sleep_until 
        (begin
            (effect_new_random "fx\fx_library\designer_fx\wraith_mortar.effect" "000_ambient_shells_a" 5.0 5.0)
...
(script dormant void ambient_wraith_shells_b
    (sleep_until 
        (begin
            (effect_new_random "fx\fx_library\designer_fx\wraith_mortar.effect" "000_ambient_shells_b" 5.0 5.0)
            (sleep (random_range 5 60))
            false
        )
    )
    ...
    (sleep_until 
        (begin
            (begin
                ...
                (sleep (random_range (* 30.0 0.0) (* 30.0 1.0)))
...
(script static void ls_flyby (device_name d)
    ...
    (sleep 1)
    (device_set_position_track d "device:m50" 0.0)
...
(script static void ls_flyby_sound
    (sound_impulse_start snd_longsword_flyby none 1.0)
)

(script static void ls_flyby_delay
    (sleep (random_range (* 30.0 s_min_longsword_flyby_delay) (* 30.0 s_max_longsword_flyby_delay)))
)
...
(script static void flyby_bomb (point_reference p, short count, short delay)
    ...
    (sleep_until 
        (begin
            ...
            (set s_current_bomb (+ s_current_bomb 1.0))
            (sleep delay)
...
(script dormant void civilian_transport_takeoff
    (device_set_position_track "dm_civilian_transport" "m50_starport_escape" 0.0)
    (sleep (* 30.0 8.0))
    (device_animate_position "dm_civilian_transport" 1.0 33.33 0.1 0.1 false)
...
(script command_script void cs_special_elite1
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_bob/ready_enter" 10.0)
    (cs_fly_by "pts_bob/ready_dive" 10.0)
...
(script command_script void cs_special_elite2
    ...
    (cs_enable_looking true)
    (cs_vehicle_boost true)
    (cs_fly_by "pts_bob/jetpack_enter" 10.0)
    (cs_fly_by "pts_bob/jetpack_dive" 10.0)
...
(script command_script void cs_special_elite3
    ...
    (cs_vehicle_boost true)
    (cs_shoot true)
    (cs_fly_by "pts_bob/starport_enter" 10.0)
    (cs_fly_by "pts_bob/starport_dive" 10.0)
...
(script static boolean obj_cgrunt_1_12
    (or
        ...
        (<= (ai_task_count "obj_canyonview_cov/initial_brute_front") 0)
    )
)
...
(script static boolean obj_cescap_2_15
    (and
        (>= objcon_canyonview 40)
        (<= (ai_task_count "obj_canyonview_cov/gate_main") 3)
    )
)
...
(script static boolean obj_clow_a_2_18
    (and
        (>= objcon_canyonview 30)
        (<= (ai_task_count "obj_canyonview_cov/initial_brute_middle") 0)
    )
)

(script static boolean obj_acount_3_2
    (or
        (<= (ai_task_count "obj_atrium_cov/gate_counterattack") 3)
        (f_ai_is_defeated "gr_cov_atrium_hunters")
    )
)

(script static boolean obj_ainiti_3_17
    (or
        (>= (ai_strength "gr_cov_atrium_initial") 0.75)
        (!= (f_ai_is_defeated "atrium_cov_initial_inf5") true)
    )
)
...
(script static boolean obj_abrute_3_18
    (or
        (>= objcon_atrium 40)
        (<= (ai_strength "atrium_cov_initial_inf5") 0.5)
    )
)

(script static boolean obj_aflank_3_19
    (and
        (<= (ai_strength "gr_cov_atrium_initial") 0.25)
        (>= objcon_atrium 40)
    )
)
...
(script static boolean obj_aadvan_4_3
    (or
        (<= (ai_task_count "obj_atrium_cov/initial_grunts") 0)
        (>= objcon_atrium 10)
    )
)
...
(script static boolean obj_aadvan_4_5
    (and
        (>= objcon_atrium 30)
        (<= (ai_strength "atrium_cov_initial_inf0") 0.025)
    )
)
...
(script static boolean obj_aadvan_4_6
    (or
        (>= objcon_atrium 40)
        (<= (ai_strength "gr_cov_atrium_initial") 0.025)
    )
)
...
(script static boolean obj_aentra_4_14
    (and
        (>= objcon_atrium 30)
        (<= (ai_task_count "obj_atrium_cov/initial_grunts") 1)
        (<= (ai_task_count "obj_atrium_cov/initial_brutes") 0)
    )
)
...
(script static boolean obj_jcrane_6_1
    (or
        (>= objcon_jetpack_low 90)
        (<= (ai_task_count "obj_jetpack_low_cov/gate_ramp") 3)
    )
)
...
(script static boolean obj_jramp__6_8
    (or
        (>= objcon_jetpack_low 90)
        (<= (ai_task_count "obj_jetpack_low_cov/gate_ramp") 7)
    )
)
...
(script static boolean obj_jcrane_6_22
    (or
        (>= objcon_jetpack_low 100)
        (<= (ai_task_count "obj_jetpack_low_cov/gate_crane") 5)
    )
)

(script static boolean obj_jcrane_6_23
    (or
        (>= objcon_jetpack_low 110)
        (<= (ai_task_count "obj_jetpack_low_cov/gate_crane") 3)
    )
)
...
(script static boolean obj_jmars__7_11
    (or
        (<= (ai_task_count "obj_jetpack_low_cov/gate_ramp") 0)
        (>= objcon_jetpack_low 110)
    )
)
...
(script static boolean obj_jstand_7_14
    (and
        (<= (ai_task_count "obj_jetpack_low_cov/gate_main") 2)
        (>= objcon_jetpack_low 130)
    )
)
...
(script static boolean obj_jhill__8_10
    (or
        (<= (ai_strength "jh_cov_hill_concussion_inf0") 0.5)
        (volume_test_players "tv_jetpack_high_stairs_top")
    )
)
...
(script static boolean obj_jtree__8_13
    (or
        (<= (ai_task_count "obj_jetpack_high_cov/gate_tree") 4)
        (>= objcon_jetpack_high 20)
    )
)
...
(script static boolean obj_jmarin_9_2
    (and
        (<= (ai_strength "gr_cov_jh_hill") 0.5)
        (>= objcon_jetpack_high 30)
    )
)
...
(script static boolean obj_jmarin_9_3
    (and
        (<= (ai_task_count "obj_jetpack_high_cov/tree_initial") 2)
        (>= objcon_jetpack_high 20)
    )
)
...
(script static boolean obj_jodst__9_5
    (and
        (or
            (<= (ai_task_count "obj_jetpack_high_cov/tree_initial") 3)
            (>= objcon_jetpack_high 20)
            (<= (ai_living_count "jh_cov_tree_inf0") 0)
        )
        (>= objcon_jetpack_high 10)
    )
)
...
(script static boolean obj_jmarin_9_7
    (and
        (f_ai_is_partially_defeated "jh_cov_hill_stairs_inf0" 2)
        (f_ai_is_partially_defeated "jh_cov_hill_stairs_inf1" 2)
    )
)
...
(script static boolean obj_jodsts_9_8
    (and
        (or
            (<= (ai_strength "gr_cov_jh_hill") 0.45)
            (>= objcon_jetpack_high 30)
        )
        b_place_jh_hill
    )
...
(script static boolean obj_jodsts_9_9
    (and
        (or
            (<= (ai_strength "gr_cov_jh_hill") 0.1)
            (>= objcon_jetpack_high 40)
        )
        b_place_jh_hill
    )
...
(script static boolean obj_jmarin_9_10
    (and
        (<= (ai_task_count "obj_jetpack_high_cov/gate_hill") 2)
        (>= objcon_jetpack_high 40)
    )
)
...
(script static boolean obj_jmarin_9_12
    (and
        (volume_test_players "tv_jetpack_high_stairs_top")
        (<= (ai_task_count "obj_jetpack_high_cov/gate_hill") 1)
    )
)
...
(script static boolean obj_jodst__9_13
    (and
        (or
            (<= (ai_task_count "obj_jetpack_high_cov/gate_hill") 0)
            (= b_trophy_started true)
        )
        b_place_jh_hill
    )
)
...
(script static boolean obj_jodst__9_26
    (and
        (<= (ai_task_count "obj_jetpack_high_cov/hill_stairs_low") 0)
        b_place_jh_hill
    )
)
...
(script static boolean obj_sadvan_14_2
    (and
        (<= (ai_living_count "starport_cov_inf0") 0)
        (<= (ai_living_count "starport_cov_inf1") 0)
        b_falcon_unloaded
    )
)
...
(script static boolean obj_sm0_as_14_9
    (and
        (f_ai_is_defeated "starport_cov_bridge_inf0")
...
(script static boolean obj_sadvan_14_21
    (and
        (<= (ai_living_count "obj_starport_cov/gate_main") 8)
        (volume_test_players "tv_starport_c0")
    )
)
...
(script static boolean obj_swarth_14_43
    (or
        (> (ai_task_count "obj_starport_cov/gate_missile1") 0)
        (not b_starport_turret1_ready)
    )
)

(script static boolean obj_swarth_14_44
    (or
        (> (ai_task_count "obj_starport_cov/gate_missile0") 0)
        (not b_starport_turret0_ready)
    )
)
...
(script static boolean obj_todst__17_13
    (and
        (= b_trophy_counterattack true)
        (<= (ai_task_count "obj_trophy_cov/gate_interior") 3)
    )
)
...
(script static boolean obj_ttroop_17_14
    (and
        (= b_trophy_counterattack true)
        (<= (ai_task_count "obj_trophy_cov/gate_interior") 1)
    )
)
...
(script static boolean obj_todst__17_24
    (and
        (<= (ai_task_count "obj_trophy_cov/balcony_entrance") 0)
        (volume_test_players "tv_balcony_entrance")
    )
)
...
(script static void duck_and_cover_canyon0
    (branch
        (> (object_get_recent_body_damage (ai_get_object (performance_get_actor "civilian"))) 0.0)
        (f_branch_empty01)
    )
...
(script static void 050la_wake_010_sc_sh1
    ...
    (cinematic_sleep 1520)
    (fade_out 0.0 0.0 0.0 65)
...
(script static void 050lb_reunited_010_sc_sh1
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 0) "thrusters" 1.0 0.0)
    (cinematic_scripting_start_music 0 0 0)
    (cinematic_sleep 125)
    (cinematic_print "custom script play")
...
(script static void 050lb_reunited_010_sc_sh2
    ...
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 17) "thrusters" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 18) "thrusters" 1.0 0.0)
    (object_set_cinematic_function_variable (cinematic_scripting_get_object 0 0) "thrusters" 1.0 0.0)
    (cinematic_sleep 92)
