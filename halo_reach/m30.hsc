...
; Source file: m30.hsc
; Start time: 4/7/2022 7:06:14
; Decompilation finished in ~0.0162231s
...
(global short s_pmp_assault_wave -1)
...
(global real r_rain_min_force 1.0)
(global real r_rain_max_force 1.0)
...
(script command_script void cs_insertion_banshees
    ...
    (object_set_scale (ai_vehicle_get ai_current_actor) 1.0 30)
    (cs_fly_by "pts_insertion_banshees/flyby0" 10.0)
    (cs_fly_by "pts_insertion_banshees/flyby1" 10.0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 4.0))
...
(script static void jetpack_search_delay
    (sleep (random_range (* 30.0 30.0) (* 30.0 90.0)))
)
...
(script dormant void fkv_music_control
    (sleep_until 
        (or
            ...
            (ai_is_alert "gr_cov_slo")
        )
    )
    (sleep_until 
        (or
            (and
                (f_ai_is_defeated "gr_cov_fkv")
                (f_ai_is_defeated "gr_cov_slo")
            )
            (= b_fld_started true)
        )
    )
...
(script dormant void fkv_combat_control
    ...
    (if (difficulty_is_heroic_or_higher) 
        (ai_place "sq_cov_fkv_jpe2_fkv1") (ai_place "sq_cov_fkv_elites0" 2))
    (if (difficulty_is_heroic_or_higher) 
        (ai_place "sq_cov_fkv_e1g3_highvalue0"))
    (if (difficulty_is_legendary) 
        (if (game_is_cooperative) 
            (ai_place "sq_cov_fkv_specops_snipers0") (ai_place "sq_cov_fkv_specops_snipers0" 1))
    )
    (sleep_until 
        (and
...
(script dormant void fkv_retreat_control
    ...
    (sleep (random_range (* 30.0 5.0) (* 30.0 12.0)))
    (if debug 
...
(script static boolean fkv_ds0_turret_is_alive
    (> (unit_get_health (ai_get_turret_ai "sq_cov_fkv_ds0/pilot" 0)) 0.0)
)
...
(script dormant void silo_encounter
    ...
    (sleep_until 
        (or
            ...
            (volume_test_players "tv_objcon_slo_010d")
        ) 
    1)
    (if debug 
...
(script static void fld_jun_failsafe
    (if 
        (or
            ...
            (if debug 
                (print "jun is in a safe bsp, won't teleport him")) (object_teleport (ai_get_object ai_jun) "fl_jun_failsafe_fld"))
)
...
(script dormant void fld_mule_vitality_control
    (sleep_until 
        (begin
            ...
            (unit_set_current_vitality (ai_get_unit "sq_mule_fld/low") 250.0 0.0)
            (unit_set_current_vitality (ai_get_unit "sq_mule_fld/high") 250.0 0.0)
            (sleep (* 30.0 10.0))
            (or
                (<= (ai_living_count "sq_mule_fld") 0)
                (= b_pmp_started true)
...
(script dormant void fld_mule_main
    ...
    (thespian_performance_setup_and_begin "p070_mule" "" 0.0)
    (ai_cannot_die "sq_mule_fld" true)
    (sleep_until (>= s_objcon_fld 40) 30 (* 30.0 20.0))
...
(script dormant void fld_infantry_low_control
    ...
    (sleep_until b_fld_mule_intro_complete 1 (* 30.0 15.0))
...
(script command_script void cs_fields_ds0_main
    ...
    (sleep_until 
        (or
            ...
            b_pmp_started
            (<= (unit_get_health (ai_get_turret_ai ai_current_actor 0)) 0.0)
        )
    )
    (if debug 
...
(script command_script void cs_fields_ds0_turret
    ...
    (sleep_until 
        (begin
            (if (> (object_get_health (ai_get_object "sq_mule_fld/low")) 0.0) 
                (begin
                    (if debug 
            ...
            (if (> (object_get_health (ai_get_object "sq_mule_fld/high")) 0.0) 
                (begin
                    (if debug 
...
(script dormant void pmp_bird_control
    (sleep_until 
        (or
            (<= (objects_distance_to_flag (ai_actors ai_jun) "fl_pmp_birds0") 5.0)
            (<= (objects_distance_to_flag player0 "fl_pmp_birds0") 5.0)
        )
    )
    (if debug 
        (print "birds!"))
...
(script static void pmp_jun_failsafe
    (if 
        (or
            ...
            (if debug 
                (print "jun is in a safe bsp, won't teleport him")) (object_teleport (ai_get_object ai_jun) "fl_jun_failsafe_pmp"))
)
...
(script dormant void pmp_player_stealth_control
    ...
    (ai_disregard (players) true)
    (ai_disregard (ai_get_object "unsc_jun") true)
    (sleep_until (>= s_objcon_pmp 30) 30 (* 30.0 25.0))
    (ai_disregard (players) false)
...
(script dormant void pmp_assault_main
    ...
    (if (> (ai_living_count "gr_militia") 0) 
        (begin
            ...
            (sleep (random_range (* 30.0 6.0) (* 30.0 8.0)))
            (wake md_pmp_stash_convo)
            (sleep_until (= b_pmp_stash_convo_completed true) 30 (* 30.0 30.0))
        ) (begin
...
(script dormant void pmp_counterattack_control
    ...
    (pmp_wave_creek)
    (game_save)
    (sleep_until (<= (ai_task_count "obj_cov_pmp/gate_main") 0) 30 (* 30.0 600.0))
...
(script static boolean pmp_wave_road_should_spawn
    (and
        ...
        (or
            (and
                (< (ai_strength "gr_cov_pmp_lake") 0.6)
...
(script static boolean pmp_wave_creek_should_spawn
    (or
        (and
            ...
            (> (ai_spawn_count "gr_cov_pmp_lake") 0)
            (< (ai_strength "gr_cov_pmp_road") 0.5)
...
(script static void pmp_postcombat_control
    ...
    (if (> (ai_living_count "gr_militia") 0) 
        (begin
            ...
            (sleep (random_range (* 30.0 8.0) (* 30.0 10.0)))
            (wake md_pmp_jun_hydro_civs_alive)
            (sleep_until b_pmp_post_convo_completed (* 30.0 12.0))
...
(script command_script void cs_pmp_ds_alpha
    ...
    (cs_vehicle_boost true)
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 0)
    (object_set_scale (ai_vehicle_get ai_current_actor) 1.0 150)
...
(script dormant void rvr_encounter
    ...
    (ai_bring_forward (ai_get_object ai_jun) 15.0)
    ...
    (set s_objcon_rvr 60)
    (ai_bring_forward (ai_get_object "gr_militia") 10.0)
    (ai_bring_forward (ai_get_object ai_jun) 6.0)
    (game_save)
...
(script dormant void set_encounter
    ...
    (if (not (difficulty_is_legendary)) 
        (thespian_performance_setup_and_begin "thespian_set_elites" "" 0.0))
...
(script dormant void set_bridge_flank_control
    ...
    (sleep_until (>= s_objcon_set 20) 30 (* 30.0 25.0))
...
(script dormant void set_defense
    ...
    (thespian_performance_setup_and_begin "p120_set_jun_plant" "" 0.0)
    (sleep (random_range 150 300))
    ...
    (sleep 60)
    (sleep_until (<= (ai_living_count "gr_cov_set") 0) 30 (* 30.0 360.0))
...
(script command_script void cs_cov_set_ds0
    ...
    (object_set_scale (ai_vehicle_get ai_current_actor) 0.01 (* 30.0 7.0))
...
(script dormant void clf_gate_sequence
    ...
    (md_clf_jun_gate)
    (sleep_until b_clf_gate_opened 30 (* 30.0 40.0))
    (f_unblip_flag "fl_clf_gate")
    (switch_zone_set "set_cliffside_035_040_045")
    (device_set_power "gate" 1.0)
    (device_set_position "gate" 1.0)
...
(script command_script void cs_cliffside_road_ds0
    ...
    (sleep_until (> (device_get_position "gate") 0.0))
...
(script static void countdown
    (sound_impulse_start "sound\game_sfx\multiplayer\player_timer_beep" none 1.0)
    (if debug 
        (print "::: 3 :::"))
    (sleep 30)
    (sound_impulse_start "sound\game_sfx\multiplayer\player_timer_beep" none 1.0)
    ...
    (if debug 
        (print "::: 1 :::"))
    (sleep 30)
    (sound_impulse_start "sound\game_sfx\multiplayer\countdown_timer" none 1.0)
    (if debug 
        (print "::: 0 :::"))
)
...
(script command_script void cs_zeta_fkv_active
    ...
    (sleep (random_range (* 30.0 30.0) (* 30.0 30.0)))
    (set b_zeta_escape true)
    (sleep (random_range (* 30.0 6.0) (* 30.0 10.0)))
    (if debug 
        (print "camo now"))
    (ai_set_active_camo ai_current_actor true)
    (cs_enable_targeting false)
...
(script command_script void cs_zeta_pmp_active
    ...
    (sleep (random_range (* 30.0 30.0) (* 30.0 30.0)))
    (set b_zeta_escape true)
    (sleep_until (< (unit_get_shield ai_current_actor) 0.5) 30 (random_range (* 30.0 6.0) (* 30.0 10.0)))
    (if debug 
        (print "camo now"))
    (ai_set_active_camo ai_current_actor true)
    (cs_enable_targeting false)
...
(script static void new_mission_objective (string_id screen, string_id start_menu)
    (sound_impulse_start "sound\game_sfx\fireteam\issue_directive.sound" none 1.0)
...
(script dormant void md_jun_dropship_overhead_1
    (sleep_until (<= (objects_distance_to_object (ai_actors "sq_cov_rvr_phantom0") (player0)) 50.0))
    (md_start)
    (sleep 20)
    ...
    (sleep_until (> (objects_distance_to_object (ai_actors "sq_cov_rvr_phantom0") (player0)) 30.0))
...
(script dormant void sfx_pmp_magnum_burst
    (if debug 
        (print "bang!"))
    (sound_impulse_start "sound\weapons\magnum\magnum_fire.sound" "sfx_magnum0" 1.0)
    (sleep 5)
    (if debug 
        (print "bang!"))
    (sound_impulse_start "sound\weapons\magnum\magnum_fire.sound" "sfx_magnum0" 1.0)
    ...
    (if debug 
        (print "bang!"))
    (sound_impulse_start "sound\weapons\magnum\magnum_fire.sound" "sfx_magnum1" 1.0)
    (sleep 9)
    (if debug 
        (print "bang!"))
    (sound_impulse_start "sound\weapons\magnum\magnum_fire.sound" "sfx_magnum1" 1.0)
...
(script dormant void md_pmp_jun_magnums
    (pmp_jun_failsafe)
    (sound_impulse_start "sound\levels\solo\m30\magnums_in_distance.sound" "sfx_magnum0" 1.0)
...
(script dormant void md_pmp_cv1_give_us_a_hand
    ...
    (sleep_until 
        (or
            (< (objects_distance_to_object (ai_actors "gr_militia") (player0)) 5.0)
            (< (objects_distance_to_object (ai_actors "gr_militia") (player1)) 5.0)
            (< (objects_distance_to_object (ai_actors "gr_militia") (player2)) 5.0)
            (< (objects_distance_to_object (ai_actors "gr_militia") (player3)) 5.0)
        )
    )
...
(script dormant void md_pmp_stash_convo
    ...
    (branch
        (or
            (= b_pmp_player_skips_encounter true)
            (<= (object_get_health (ai_get_object ai_civilian2)) 0.0)
        )
    ...
    (device_set_position "dm_pmp_stash0" 1.0)
    (device_set_position "dm_pmp_stash1" 1.0)
...
(script static void md_pmp_jun_hydro_civs_dead
    ...
    (md_object_play (* 30.0 6.0) none m30_0840)
...
(script dormant void md_clf_jun_eyes_on_capital_ship
    (if (> (ai_living_count "gr_cov_clf") 0) 
        (wake md_clf_jun_eyes_on_combat) (wake md_clf_jun_eyes_on_postcombat))
)
...
(script static void weather_set_theme_default
    ...
    (set r_rain_min_force 1.0)
    (set r_rain_max_force 1.0)
)
...
(script static void weather_rain_stop
    ...
    (weather_animate_force "off" 1.0 (random_range s_rain_min_ramp_down_time s_rain_max_ramp_down_time))
...
(script static void weather_thunder_clap
    (if b_rain_thunderclap 
        (begin
            ...
            (sound_impulse_start "sound\levels\solo\weather\thunder_claps.sound" none 1.0)
            ...
            (sound_impulse_start "sound\levels\solo\weather\rain\details\thunder.sound" none 1.0)
        )
    )
)
...
(script static void sleep_range_seconds (short minsleep, short maxsleep)
    (sleep (random_range (* 30.0 minsleep) (* 30.0 maxsleep)))
)
...
(script static boolean obj_ufollo_1_3
    (or
        (f_ai_is_defeated "gr_cov_ovr_high")
        (>= s_objcon_ovr 50)
    )
)
...
(script static boolean obj_cphant_2_6
    (and
        (= b_fkv_ds0_delivery_started false)
        (not (fkv_ds0_turret_is_alive))
        (>= s_objcon_fkv 5)
    )
)
...
(script static boolean obj_uhold__3_3
    (and
        (>= s_objcon_fkv 5)
        (<= (ai_living_count "gr_cov_fkv_hill") 0)
    )
)
...
(script static boolean obj_cfinal_5_19
    (and
        (= b_pmp_charlie_delivered true)
        (<= (ai_task_count "obj_cov_pmp/gate_main") 2)
    )
)
...
(script static boolean obj_ugo_to_6_6
    (or
        (= b_pmp_post_convo_completed true)
        (= b_pmp_post_convo_goto_river true)
    )
)
...
(script static boolean obj_ugo_do_6_16
    (and
        (= b_pmp_post_convo_completed true)
        (volume_test_players "tv_pmp_exit")
    )
)

(script static boolean obj_ugate__6_17
    (and
        (<= (ai_strength "gr_cov_pmp") 0.2)
        (>= s_objcon_pmp 30)
    )
)
...
(script static boolean obj_cnest__10_16
    (and
        (>= s_objcon_clf 110)
        (<= (ai_living_count "sq_cov_clf_jetpacks0") 0)
    )
)
...
(script static boolean obj_unest_11_3
    (and
        (f_ai_is_defeated "sq_cov_clf_skirmishers")
        (f_ai_is_partially_defeated "gr_cov_clf_mid" 2)
        (f_ai_is_defeated "sq_cov_clf_nest_shade0")
    )
)

(script static boolean obj_ufinal_11_4
    (and
        (f_ai_is_partially_defeated "gr_cov_clf_final" 2)
        (>= s_objcon_clf 130)
    )
)
...
(script static boolean obj_umissi_11_5
    (and
        (f_ai_is_defeated "sq_cov_clf_overlook_inf0")
        (f_ai_is_defeated "sq_cov_clf_overlook_inf1")
    )
)
...
(script static boolean obj_ucente_11_12
    (and
        (f_ai_is_defeated "sq_cov_clf_center_shade0")
        (f_ai_is_defeated "sq_cov_clf_center_inf0")
    )
)

(script static boolean obj_uroad__11_13
    (and
        (f_ai_is_defeated "gr_cov_clf_road")
        (> s_objcon_clf 60)
    )
)
...
(script static boolean obj_uassau_11_14
    (and
        (>= s_objcon_clf 110)
        (<= (ai_strength "gr_cov_clf_nest") 0.3)
    )
)
...
(script static boolean obj_ucross_13_14
    (and
        (>= s_objcon_set 30)
        (f_ai_is_defeated "sq_cov_set_bridge0")
    )
)
...
(script static boolean obj_uassau_13_15
    (and
        (f_ai_is_defeated "sq_cov_set_bridge0")
        (f_ai_is_defeated "sq_cov_set_ring_grunts0")
    )
)
...
(script static boolean obj_uassau_13_16
    (and
        (f_ai_is_defeated "sq_cov_set_bridge0")
        (f_ai_is_defeated "sq_cov_set_ring_grunts0")
        (<= (ai_strength "sq_cov_set_ring_jackals0") 0.5)
    )
)
...
(script static boolean obj_mmoas__19_1
    (or
        (< (ai_strength "sq_amb_pmp_moas0") 1.0)
        (volume_test_players "tv_pmp_moas_scare")
        (volume_test_object "tv_pmp_moas_scare" (ai_get_object ai_jun))
    )
)
