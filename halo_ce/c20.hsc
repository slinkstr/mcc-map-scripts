...
; Source file: c20.hsc
; Start time: 4/7/2022 7:47:10
; Decompilation finished in ~0.0021191s
...
(script static void cutscene_insertion
    (begin
        (sound_looping_start "sound\sinomatixx_foley\c20_insertion_foley" none 1.0)
        ...
        (sleep 7)
        (sound_looping_start "sound\sinomatixx_music\c20_insertion_music" none 1.0)
        (sleep 23)
        ...
        (sleep 50)
        (device_set_position "spooky_door" 1.0)
        (sleep 50)
        ...
        (sound_impulse_start "sound\dialog\c20\c20_insert_020_monitor" "monitor" 1.0)
        ...
        (cinematic_stop)
        (device_set_position_immediate "spooky_door" 0.0)
        (object_pvs_activate none)
        (fade_in 1.0 1.0 1.0 15)
        (sound_class_set_gain "ambient" 1.0 3)
    )
)

(script static void cutscene_extraction
    (begin
        (sound_looping_start "sound\sinomatixx_foley\c20_extraction_foley" none 1.0)
        (sound_class_set_gain "device_machinery" 0.0 0)
        (sound_class_set_gain "ambient" 0.5 0)
        (fade_out 1.0 1.0 1.0 15)
        (sleep 15)
        (device_set_position_immediate "index_platform" 0.0)
        (camera_control true)
        (cinematic_start)
        (object_create_anew "monitor")
        (object_create_anew "index")
        ...
        (sound_impulse_start "sound\dialog\c20\c20_320_monitor" "monitor" 1.0)
        ...
        (sound_impulse_start "sound\dialog\c20\c20_extract_020_monitor" "monitor" 1.0)
        ...
        (sleep (- (sound_impulse_time "sound\dialog\c20\c20_extract_020_monitor") 60.0))
        ...
        (object_destroy "monitor")
        (sound_impulse_start "sound\dialog\c20\c20_extract_030_monitor" none 1.0)
        (sleep 135)
        ...
        (camera_control false)
        (cinematic_stop)
        (sound_class_set_gain "device_machinery" 1.0 0)
        (sound_class_set_gain "ambient" 1.0 0)
        (game_won)
    )
)
...
(script continuous void fall_killerz
    (begin
...
(script continuous void platforms
    (begin
        (if 
            (or
                ...
                (device_set_position "platform1" 1.0) (begin
                    (if (> (device_get_position "platform1") 0.9) 
                        (sleep 90))
                    (device_set_position "platform1" 0.0)
                )
        )
        (if 
            (or
                ...
                (device_set_position "platform2" 1.0) (begin
                    (if (> (device_get_position "platform2") 0.9) 
                        (sleep 90))
                    (device_set_position "platform2" 0.0)
                )
        )
        (if 
            (or
                ...
                (device_set_position "platform3" 1.0) (begin
                    (if (> (device_get_position "platform3") 0.9) 
                        (sleep 90))
                    (device_set_position "platform3" 0.0)
                )
        )
        (sleep 30)
    )
...
(script continuous void floor4_door2_counter
    (begin
        (sleep 30)
        (if (volume_test_objects "enc7_5_trigger" (players)) 
            (set floor4_door2_count (+ floor4_door2_count 3.0)) (set floor4_door2_count (+ floor4_door2_count 1.0)))
    )
)

(script continuous void floor3_door2_counter
    (begin
        (sleep 30)
        (if (volume_test_objects "enc5_5_trigger" (players)) 
            (set floor3_door2_count (+ floor3_door2_count 3.0)) (set floor3_door2_count (+ floor3_door2_count 1.0)))
    )
)

(script dormant void stun_door_counters
    (begin
        (if debug 
            (print "stunning door counters..."))
        (sleep -1 floor3_door2_counter)
        (sleep -1 floor4_door2_counter)
    )
)

(script continuous void enc7_12_spawner
    (begin
        (sleep_until 
            (and
                (<= enc7_12_limiter (* 40.0 spawn_scale))
                (<= (ai_nonswarm_count "enc7_12") (* min_combat_spawn 2.0))
            )
        )
        (if (volume_test_objects_all "enc7_12a" (players)) 
            (begin
                ...
                (set enc7_12_limiter (+ enc7_12_limiter 2.0))
            )
        )
    ...
    (begin
        (if 
            (and
                ...
                (< enc7_5_limiter (* 30.0 spawn_scale))
            ) 
                (begin
...
(script continuous void enc7_3_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc7_3_trigger" (players))
                (< enc7_3_limiter (* 30.0 spawn_scale))
            ) 
                (if (< (ai_living_count "enc7_3/combats") (* min_combat_spawn 2.0)) 
                    (begin
                        (ai_spawn_actor "enc7_3/combats")
                        (set enc7_3_limiter (+ enc7_3_limiter 1.0))
                    )
                )
        )
    )
...
(script continuous void enc6_8_spawner
    (begin
        (if 
            (and
                (volume_test_objects "tv_platform3" (players))
                (< enc6_8_limiter (* 15.0 spawn_scale))
                (> (device_group_get "platform3") 0.4)
            ) 
                (begin
                    (if (< (ai_living_count "enc6_8/combats") min_combat_spawn) 
                        (begin
                            (ai_spawn_actor "enc6_8/combats")
                            (set enc6_8_limiter (+ enc6_8_limiter 1.0))
                        )
                    )
...
(script continuous void enc6_4_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc6_4b_trigger" (players))
                (< enc6_4_limiter (* 40.0 spawn_scale))
            ) 
                (begin
                    (if (< (ai_living_count "enc6_4/combats") (* min_combat_spawn 2.0)) 
                        (begin
                            (ai_spawn_actor "enc6_4/combats")
                            (set enc6_4_limiter (+ enc6_4_limiter 1.0))
                        )
                    )
...
(script continuous void enc6_2b_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc6_2b_trigger" (players))
                (< enc6_2_limiter (* 15.0 spawn_scale))
            ) 
                (begin
...
(script continuous void enc6_2_spawner
    (begin
        (if 
            (and
...
(script continuous void enc5_5_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc5_5_trigger" (players))
                (< enc5_5_limiter (* 30.0 spawn_scale))
            ) 
                (if (< (ai_living_count "enc5_5/carriers") (* min_carrier_spawn 3.0)) 
                    (begin
                        (ai_spawn_actor "enc5_5/carriers")
                        (ai_magically_see_players "enc5_5/carriers")
                        (set enc5_5_limiter (+ enc5_5_limiter 1.0))
                    )
                )
        )
    )
...
(script continuous void enc5_3_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc5_3_trigger" (players))
                (< enc5_3_limiter (* 20.0 spawn_scale))
            ) 
                (begin
                    (if (< (ai_living_count "enc5_3b/combats") min_combat_spawn) 
                        (begin
                            ...
                            (set enc5_3_limiter (+ enc5_3_limiter 1.0))
                        )
                    )
...
(script continuous void enc4_8_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc4_8_trigger" (players))
                (< enc4_8_limiter (* 20.0 spawn_scale))
            ) 
                (begin
...
(script continuous void enc4_6_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc4_6_trigger" (players))
                (< enc4_6_limiter (* 20.0 spawn_scale))
            ) 
                (begin
                    (if (< (ai_living_count "enc4_6/combats") min_combat_spawn) 
                        (begin
                            ...
                            (set enc4_6_limiter (+ enc4_6_limiter 1.0))
                        )
                    )
...
(script continuous void enc4_3_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc4_3_trigger" (players))
                (< enc4_3_limiter (* 20.0 spawn_scale))
            ) 
                (begin
                    (if (< (ai_living_count "enc4_3/combats") min_combat_spawn) 
                        (begin
                            ...
                            (set enc4_3_limiter (+ enc4_3_limiter 1.0))
                        )
                    )
...
(script continuous void enc4_0_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc4_0" (players))
                (< enc4_0_limiter (* 6.0 spawn_scale))
            ) 
                (if (< (ai_living_count "enc4_0") 20) 
                    (begin
                        (ai_place "enc4_0")
                        (set enc4_0_limiter (+ enc4_0_limiter 1.0))
                    )
                )
        )
    )
...
(script continuous void enc3_6_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc3_6b_trigger" (players))
                (< enc3_6_limiter (* 2.0 spawn_scale))
            ) 
    ...
    (begin
        (if 
            (and
                ...
                (< enc3_4_limiter (* 30.0 spawn_scale))
            ) 
                (begin
                    (if (< (ai_living_count "enc3_4/combats") (* 1.25 min_combat_spawn)) 
                        (begin
                            ...
                            (set enc3_4_limiter (+ enc3_4_limiter 2.0))
                            (if (volume_test_objects_all "enc3_4b" (players)) 
                                (ai_spawn_actor "enc3_4/leapers") (ai_spawn_actor "enc3_4/runners"))
                        )
                    )
...
(script continuous void enc2_0_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc2_0_trigger" (players))
                (< enc2_0_limiter (* 6.0 spawn_scale))
            ) 
                (if (< (ai_living_count "enc2_0") 20) 
                    (begin
                        (ai_place "enc2_0")
                        (set enc2_0_limiter (+ enc2_0_limiter 1.0))
                    )
                )
        )
    )
...
(script continuous void enc1_9_spawner
    (begin
        (if 
            (and
                (volume_test_objects "enc1_9_trigger" (players))
                (< enc1_9_limiter (* 6.0 spawn_scale))
            ) 
                (if (< (ai_living_count "enc1_9") 20) 
                    (begin
                        (ai_place "enc1_9")
                        (set enc1_9_limiter (+ enc1_9_limiter 1.0))
                    )
                )
        )
    )
...
(script dormant void stun_spawn_waves
    (begin
        (if debug 
...
(script dormant void monitor4_4
    (begin
...
(script dormant void monitor4_3
    (begin
        (sleep_until (volume_test_objects "monitor4_3" (players)))
        (ai_command_list_advance "bsp3_monitor")
        (ai_command_list "bsp3_monitor" "monitor4_3")
        (sleep 90)
        (c20_flavor_100_monitor)
        (set music_03_base true)
    )
)

(script dormant void monitor4_2
    (begin
        (ai_command_list_advance "bsp3_monitor")
...
(script dormant void monitor4_1
    (begin
...
(script dormant void monitor3_9
    (begin
...
(script dormant void monitor3_8
    (begin
        (ai_command_list_advance "bsp2_monitor")
...
(script dormant void monitor3_7
    (begin
...
(script dormant void monitor3_6
    (begin
...
(script dormant void monitor3_2
    (begin
...
(script dormant void monitor3_1
    (begin
        ...
        (wake monitor3_2)
        (c20_flavor_090_monitor)
        (c20_flavor_150_monitor)
    )
)

(script dormant void monitor2_11
    (begin
...
(script dormant void monitor2_10
    (begin
...
(script dormant void monitor2_6
    (begin
...
(script dormant void monitor2_5
    (begin
...
(script dormant void monitor2_4
    (begin
        ...
        (print "enc3_5c_trigger")
        (ai_command_list_advance "bsp1_monitor")
    )
)

(script dormant void monitor2_3
    (begin
...
(script dormant void monitor2_2
    (begin
...
(script dormant void monitor2_1
    (begin
...
(script dormant void monitor1_17
    (begin
...
(script dormant void monitor1_16
    (begin
        (ai_command_list_advance "bsp0_monitor")
...
(script dormant void monitor1_13
    (begin
...
(script dormant void monitor1_12
    (begin
        (sleep_until (volume_test_objects "monitor1_12" (players)))
        (ai_command_list_advance "bsp0_monitor")
        (ai_command_list "bsp0_monitor" "monitor1_12")
        (wake monitor1_13)
        (c20_flavor_040_monitor)
        (c20_flavor_050_monitor)
    )
)

(script dormant void monitor1_11
    (begin
...
(script dormant void monitor1_10
    (begin
        ...
        (wake monitor1_11)
        (c20_flavor_010_monitor)
        (c20_flavor_020_monitor)
    )
)

(script dormant void monitor1_9b
    (begin
...
(script dormant void monitor1_9
    (begin
...
(script dormant void monitor1_8
    (begin
...
(script dormant void monitor1_7
    (begin
...
(script dormant void monitor1_6
    (begin
...
(script dormant void monitor1_5
    (begin
...
(script dormant void monitor1_4
    (begin
...
(script dormant void monitor1_3
    (begin
...
(script dormant void monitor1_2
    (begin
...
(script dormant void monitor1_1
    (begin
        (wake monitor1_2)
...
(script dormant void init_monitor_bsp0
    (begin
...
(script dormant void floor4_door2
    (begin
...
(script dormant void section7
    (begin
        ...
        (ai_erase "enc6_7b")
        (ai_erase "enc6_8")
        (device_group_set_immediate "floor3_door1" 0.0)
        (device_group_set_immediate "floor3_door2" 0.0)
        (device_group_set_immediate "floor3_door3" 0.0)
        (device_group_set_immediate "floor3_door4" 0.0)
        (device_group_set_immediate "floor3_door5" 0.0)
        (wake enc7_1)
        (wake monitor4_1)
    )
)
...
(script dormant void enc6_5
    (begin
        (certain_save)
        (if debug 
            (print "encounter 6.5 prep..."))
        (ai_place "enc6_5")
        (ai_place "enc6_5b/sentinels")
        (sleep_until (volume_test_objects "enc6_5_trigger" (players)))
        (if debug 
            (print "encounter 6.5..."))
        (if (< (ai_living_count "enc6_5b") 6) 
            (ai_spawn_actor "enc6_5b/replacements"))
        (sleep 45)
        (if (< (ai_living_count "enc6_5b") 6) 
            (ai_spawn_actor "enc6_5b/replacements"))
        (sleep 45)
...
(script dormant void enc6_4
    (begin
        ...
        (sleep 30)
        (device_group_set "floor3_door4" 0.0)
        (objective_hold)
        (sleep 60)
        (ai_place "enc6_4/infs")
        (sound_looping_set_alternate "levels\c20\music\c20_04" true)
        (sleep_until (<= (device_group_get "floor3_door4") 0.0))
        (ai_magically_see_players "enc6_4")
        (sleep 150)
        (wake enc6_4_spawner)
        (sleep (* 30.0 (* spawn_scale 60.0)))
        (sleep -1 enc6_4_spawner)
...
(script dormant void enc6_2
    (begin
        ...
        (if debug 
            (print "encounter 6.2..."))
        (sound_looping_start "levels\c20\music\c20_04" none 1.0)
        (wake enc6_2_spawner)
...
(script dormant void section6
    (begin
        ...
        (device_group_set_immediate "floor2_door1" 0.0)
        (device_group_set_immediate "floor2_door2" 0.0)
        (wake enc6_1)
        (wake enc6_2)
        (wake enc6_3)
...
(script dormant void floor3_door2
    (begin
        (certain_save)
        ...
        (sleep -1 enc5_5_spawner)
        (sleep 900)
        (sound_looping_start "levels\c20\music\c20_01" none 1.0)
    )
)
...
(script dormant void enc4_2
    (begin
        ...
        (if debug 
            (print "encounter 4.2..."))
        (sound_looping_start "levels\c20\music\c20_03" none 1.0)
        (ai_place "enc4_2")
...
(script dormant void section4
    (begin
        (if debug 
            (print "section 4..."))
        (device_group_set_immediate "floor1_door1" 0.0)
        (wake enc4_0)
        (wake enc4_1)
        (wake enc4_2)
        (ai_erase "enc2_0")
...
(script dormant void enc3_5
    (begin
        ...
        (ai_follow_distance "enc3_5_sents" 5.0)
...
(script dormant void floor2_door1
    (begin
        (sleep 1200)
        (wake monitor2_3)
        (sleep 240)
...
(script dormant void enc2_12
    (begin
        (sleep_until (volume_test_objects "enc2_12_trigger" (players)))
        (certain_save)
        (if debug 
            (print "encounter 2.12..."))
        (sleep -1 enc2_11_spawner)
        (if (> 8.0 (+ (ai_living_count "enc2_11/combats") (ai_living_count "enc2_9/combats") (ai_living_count "enc2_8/combats"))) 
            (begin
                (ai_place "enc2_12b")
...
(script dormant void enc2_4
    (begin
        ...
        (if debug 
            (print "encounter 2.4..."))
        (sound_looping_start "levels\c20\music\c20_02" none 1.0)
        (wake enc2_4_spawner)
        (wake enc2_5)
    )
)

(script dormant void enc2_3
    (begin
        (sleep_until (volume_test_objects "enc2_3_trigger" (players)))
        (certain_save)
    ...
    (begin
        ...
        (sleep_until 
            (or
                ...
                (objects_can_see_object (players) (list_get (ai_actors "enc1/carrier1") 0) 30.0)
            )
        )
...
(script static void diff_control
    (begin
        (if (= easy (game_difficulty_get_real)) 
            (begin
                (if debug 
                    (print "difficulty adjusted for easy"))
