...
; Start time: 4/7/2022 7:27:18
; Decompilation finished in ~0.0050471s
...
(global short g_nav_sleep (* 30.0 60.0 2.0))
(global short g_nav_sleep_dam (* 30.0 60.0 0.5))
...
(global short g_jw_brute_sleep (* 30.0 50.0))
(global short g_jw_grunt_sleep (* 30.0 60.0))
...
(global real g_ba_starting_pitch 10.0)
...
(script dormant void 010_jungle_mission_won
    ...
    5)
    (sound_looping_start "sound\cinematics\070_waste\070ld_pelican_pickup\070ld_pelican_glue\070ld_pelican_glue" "dam_pelican_location" 1.0)
...
(script dormant void music_010_01
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_01" none 1.0)
...
(script dormant void music_010_02
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_02" none 1.0)
...
(script dormant void music_010_03
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_03" none 1.0)
...
(script dormant void music_010_04
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_04" none 1.0)
...
(script dormant void music_010_05
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_05" none 1.0)
...
(script dormant void music_010_06
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_06" none 1.0)
...
(script dormant void music_010_065
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_065" none 1.0)
...
(script dormant void music_010_07
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_07" none 1.0)
...
(script dormant void music_010_075
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_075" none 1.0)
...
(script dormant void music_010_076
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_076" none 1.0)
...
(script dormant void music_010_08
    ...
    (sound_looping_start "levels\solo\010_jungle\music\010_music_08" none 1.0)
)
...
(script dormant void md_cc_johnson_move_out
    ...
    (if 
        (or
            ...
            (player_control_scale_all_input 1.0 0.0) (player_control_scale_all_input 0.775 0.0))
    ...
    (sleep_until 
        (or
            (and
                ...
                (>= (ai_combat_status "gr_jw_upper_cov") 4)
                (< (unit_get_shield "sq_jw_u_cov_01/brute") 1.0)
            )
            (>= g_jw_obj_control 9)
        )
    )
        ...
        (and
            ...
            (begin
                ...
                (if 
                    (and
                        (>= (ai_living_count "sq_jw_u_cov_01/brute") 1)
                        (> (object_get_shield "sq_jw_u_cov_01/brute") 0.0)
                    ) 
                        (begin
                            (if dialogue 
...
(script dormant void md_jw_arb_prophets
    ...
    (if (<= g_jw_obj_control 7) 
        (begin
            ...
            (set g_playing_dialogue true)
            (ai_dialogue_enable false)
            (vs_approach arbiter false dead_brute 1.5 100.0 100.0)
            (sleep 1)
            (sleep_until (not (vs_running_atom arbiter)) 1 (* 30.0 5.0))
            (sleep 1)
            (vs_face_object arbiter true dead_brute)
            (sleep 1)
            (if (<= (objects_distance_to_object arbiter dead_brute) 2.0) 
                (begin
                    (if dialogue 
        ...
        (begin
            ...
            (if (<= (ai_combat_status "gr_gc_covenant") 4) 
                (begin
                    ...
                    (sleep 15)
                    (sleep_until (>= (ai_combat_status "gr_gc_jackals") 5) 30 (* 30.0 2.0))
...
(script dormant void vs_jw_joh_phantom
    ...
    (player_control_scale_all_input 1.0 3.0)
    (if (<= g_jw_obj_control 3) 
        (sleep 90))
    (if (<= g_jw_obj_control 3) 
        (begin
...
(script command_script void cs_jw_climb_mar_01
    ...
    (cs_stow)
    (sleep 5)
    (set g_jw_marines_climbing (+ g_jw_marines_climbing 1.0))
    (biped_force_ground_fitting_on ai_current_actor true)
...
(script dormant void md_pa_sarge
    ...
    (if (<= g_pa_obj_control 2) 
        (begin
            ...
            (vs_approach_player sarge true 3.0 20.0 20.0)
            (if dialogue 
...
(script command_script void cs_ss_banshee_01
    ...
    (cs_shoot_point false "ps_ss_banshee/b1_shoot")
    (cs_vehicle_boost true)
    (cs_fly_by "ps_ss_banshee/b1_4" 5.0)
    (cs_fly_by "ps_ss_banshee/b1_5" 5.0)
    (cs_fly_by "ps_ss_banshee/b1_6" 5.0)
    (cs_fly_by "ps_ss_banshee/b1_7" 5.0)
    (cs_fly_by "ps_ss_banshee/b1_erase" 2.0)
    (ai_erase ai_current_actor)
)
...
(script command_script void cs_ss_banshee_02
    ...
    (cs_shoot_point false "ps_ss_banshee/b2_shoot")
    (cs_vehicle_boost true)
    (cs_fly_by "ps_ss_banshee/b2_4" 5.0)
    (cs_fly_by "ps_ss_banshee/b2_5" 5.0)
    (cs_fly_by "ps_ss_banshee/b2_6" 5.0)
    (cs_fly_by "ps_ss_banshee/b2_7" 5.0)
    (cs_fly_by "ps_ss_banshee/b2_erase" 2.0)
    (ai_erase ai_current_actor)
)
...
(script dormant void vs_ba_joh_dumb_apes
    ...
    (sleep_until (volume_test_players "tv_ba_ledge") 1 (* 30.0 30.0))
...
(script dormant void 010pb_johnson_captured
    ...
    (player_control_lock_gaze (player0) "ps_dam/phantom" 40.0)
    (player_control_lock_gaze (player1) "ps_dam/phantom" 40.0)
    (player_control_lock_gaze (player2) "ps_dam/phantom" 40.0)
    (player_control_lock_gaze (player3) "ps_dam/phantom" 40.0)
    ...
    (if 
        (or
            ...
            (cinematic_fade_to_gameplay) (perspective_skipped))
...
(script dormant void vs_dam_jail_bait
    ...
    (sleep 120)
    (device_set_position "dam_jail" 1.0)
    (sleep 60)
...
(script dormant void vs_dam_jail_rescue
    ...
    (if (= (device_group_get "dg_cov_dam_generator") 1.0) 
        (begin
            (if dialogue 
    ...
    (sleep_until (<= (device_group_get "dg_cov_dam_generator") 0.0) 1)
...
(script command_script void cs_dam_marines_approach
    (cs_approach_player 5.0 40.0 40.0)
    (cs_face_player true)
    (sleep 5)
    (cs_crouch true)
...
(script static boolean obj_jarb_n_2_37
    (and
        g_md_jw_river
        (<= (ai_combat_status "obj_jw_upper_allies") 4)
    )
)
...
(script static boolean obj_jupper_3_0
    (and
        (> (ai_living_count "sq_jw_u_cov_01/brute") 0)
        (<= g_jw_obj_control 6)
    )
)
...
(script static boolean obj_ggate__7_15
    (and
        (>= g_gc_obj_control 2)
        (<= (ai_task_count "obj_gc_covenant/ravine_grunt") 0)
    )
)
...
(script static boolean obj_griver_8_21
    (and
        ...
        (<= (ai_living_count "obj_gc_covenant/ravine_grunt") 1)
    )
)
...
(script static boolean obj_pcov_t_10_5
    (and
        ...
        (>= (ai_task_count "obj_pa_covenant/top_grunt_02b") 1)
    )
)
...
(script static boolean obj_sb_fro_12_16
    (and
        (not (volume_test_players "tv_ss_07"))
        (<= g_ss_obj_control 7)
    )
)
...
(script static boolean obj_barb_0_15_18
    (and
        ...
        (<= (ai_task_count "obj_ba_covenant/rein_front_b") 0)
    )
)
...
(script static boolean obj_bmar_0_15_19
    (and
        (<= (ai_task_count "obj_ba_covenant/cov_01b") 0)
        (<= (ai_task_count "obj_ba_covenant/rein_front_a") 0)
    )
)
...
(script static boolean obj_brein__16_9
    (and
        (<= (ai_task_count "obj_ba_covenant/rein_overflow") 0)
        (<= g_ba_obj_control 4)
    )
)
...
(script static boolean obj_dmar_b_18_28
    (or
        (volume_test_players "tv_dam_04")
        (volume_test_players "tv_dam_05")
        (volume_test_players "tv_dam_06")
    )
)
...
(script static void ins_chief_crater
    ...
    (if (= (game_is_cooperative) true) 
        (unit_add_equipment (player0) "chief_coop_initial" true true) (unit_add_equipment (player0) "chief_initial" true true))
    (sleep 1)
...
(script static void ins_brute_ambush
    ...
    (if (= (game_is_cooperative) true) 
        (unit_add_equipment (player0) "chief_coop_initial" true true) (unit_add_equipment (player0) "insertion_chief" true true))
    (sleep 1)
    (insertion_start)
    (wake music_010_07)
    (wake music_010_075)
...
(script dormant void enc_jungle_walk
    ...
    (player_control_scale_all_input 1.0 60.0)
    (set g_music_010_03 true)
...
(script command_script void cs_jw_phantom_02
    ...
    (cs_fly_to "ps_jw_phantom/ph01_lift" 2.0)
...
(script command_script void cs_jw_phantom_04
    ...
    (cs_fly_to_and_face "ps_jw_phantom/ph04_hover" "ps_jw_phantom/ph04_face" 2.0)
    (vehicle_hover jw_phantom_04 true)
    (cond
        ((<= (game_difficulty_get) normal)
            (sleep 1)
...
(script dormant void jw_out_of_bounds
    (sleep_until 
        (begin
            ...
            (cond
                ((volume_test_object "tv_jw_out_of_bounds" (player0))
                    (unit_kill (unit (player0)))
                )
                ((volume_test_object "tv_jw_out_of_bounds" (player1))
                    (unit_kill (unit (player1)))
                )
                ((volume_test_object "tv_jw_out_of_bounds" (player2))
                    (unit_kill (unit (player2)))
                )
                ((volume_test_object "tv_jw_out_of_bounds" (player3))
...
(script dormant void enc_grunt_camp
    ...
    (sleep_until 
        (or
            (volume_test_players "tv_gc_02")
            (volume_test_players "tv_gc_03")
        ) 
    5)
    (cond
        ((volume_test_players "tv_gc_02")
    ...
    (sleep_until 
        (or
            (volume_test_players "tv_gc_04")
            (volume_test_players "tv_gc_05")
        ) 
    5)
    (cond
        ((volume_test_players "tv_gc_04")
...
(script static void ai_gc_jackal (ai spawned_squad)
    (ai_place spawned_squad)
    (set g_gc_jackal_count (+ g_gc_jackal_count 1.0))
...
(script dormant void enc_substation
    ...
    (if (= (game_insertion_point_get) 1) 
        (wake chapter_charlie_insert) (wake chapter_charlie))
...
(script command_script void cs_ss_phantom_01
    ...
    (sleep_until g_ss_phantom_03 5 (* 30.0 10.0))
...
(script command_script void cs_ss_phantom_02
    ...
    (cs_fly_by "ps_ss_phantom/p3")
    (cs_vehicle_speed 0.5)
    (cs_fly_to_and_face "ps_ss_phantom/ph_hover" "ps_ss_phantom/ph_face" 1.0)
    (sleep 30)
    (set g_music_010_065 true)
    (cs_fly_to_and_face "ps_ss_phantom/ph_drop" "ps_ss_phantom/ph_face" 1.0)
    (sleep 15)
    (begin_random
        (begin
    ...
    (cs_fly_to "ps_ss_phantom/ph_hover" 1.0)
    (if (>= (game_difficulty_get) heroic) 
...
(script static void ai_pb_jackal (ai spawned_squad)
    (ai_place spawned_squad)
    (set g_pb_jackal_count (+ g_pb_jackal_count 1.0))
...
(script static void ai_ba_jackal (ai spawned_squad)
    (ai_place spawned_squad)
    (set g_ba_jackal_count (+ g_ba_jackal_count 1.0))
...
(script command_script void cs_dam_ini_grunt
    (if (= (random_range 0 2) 0) 
        (ai_activity_set ai_current_actor "stand") (ai_activity_set ai_current_actor "asleep"))
...
(script command_script void cs_dam_phantom_01
    ...
    (cs_fly_to "ps_dam/bridge_drop" 1.0)
    (sleep 5)
    ...
    (if (<= (ai_combat_status "obj_dam_00_04_covenant") 4) 
        (sleep_until (>= (ai_combat_status "obj_dam_00_04_covenant") 5) 30 (* 30.0 7.0)))
    (if debug 
        (print "placing and dropping covenant"))
    ...
    (if debug 
        (print "fly away"))
    (cs_fly_to "ps_dam/bridge_hover" 1.0)
    (sleep 60)
...
(script command_script void cs_dam_phantom_02
    ...
    (sleep 30)
    (cs_vehicle_speed 0.5)
    (cs_fly_to "ps_dam/jail_drop" 1.0)
    ...
    (if debug 
        (print "raise"))
    (cs_fly_to "ps_dam/jail_hover" 1.0)
    (sleep 30)
    (cs_vehicle_speed 1.0)
    (if debug 
        (print "fly away"))
...
(script command_script void cs_dam_phantom_03
    ...
    (cs_fly_to "ps_dam/ph03_hover" 2.0)
    (cs_face true "ps_dam/ph01")
    (cs_vehicle_speed 0.5)
    (sleep 90)
    (cs_fly_to "ps_dam/ph03_drop" 2.0)
    (sleep 60)
...
(script dormant void ai_dam_pelican
    ...
    (sleep 150)
    (sleep_until (<= (ai_task_count "obj_dam_08_evac_covenant/infantry_gate") 6) 30 (* 30.0 60.0 0.5))
...
(script command_script void cs_dam_pelican
    ...
    (if (>= (ai_living_count "sq_dam_phantom_03") 1) 
        (begin
            ...
            (sleep (random_range 120 150))
            (object_damage_damage_section dam_phantom_03 "death" 4000.0)
            (sleep 15)
    ...
    (if (>= (ai_living_count "sq_dam_phantom_04") 1) 
        (begin
            ...
            (sleep (random_range 120 150))
            (object_damage_damage_section dam_phantom_04 "death" 4000.0)
            (sleep 15)
...
(script command_script void cs_dam_pelican_mid
    ...
    (cs_fly_to "ps_dam_pelican/mid01" 2.0)
    (cs_vehicle_speed 0.25)
    (sleep 60)
    (cs_fly_to "ps_dam_pelican/mid02" 1.0)
    (sleep 60)
    (set g_nav_dam true)
...
(script dormant void 010tr_jump
    ...
    (sleep_until (>= g_cc_obj_control 3) 5 (* 30.0 10.0))
    (if (<= g_cc_obj_control 2) 
        (begin
...
(script dormant void 010tr_grenades
    ...
    (if (not (game_is_cooperative)) 
        (begin
            ...
            (set g_playing_dialogue false)
            (sleep_until (>= g_ss_obj_control 2) (* 30.0 10.0))
...
(script static void !010lb01_takeoff_middle_sc_sh1
    ...
    (sleep 29)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican") "thrusters_back" 1.0 15.0)
    (sleep 5)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican") "thrusters_down" 0.25 25.0)
    (sleep 15)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican") "thrusters_down" 1.0 50.0)
    (sleep 72)
...
(script static void !010lb02_transition_sc_sh1
    ...
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican") "thrusters_back" 0.25 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican") "thrusters_down" 0.15 0.0)
    (sleep 180)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican") "thrusters_back" 1.0 30.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican") "thrusters_down" 0.5 45.0)
    (sleep 176)
...
(script static void !010lb03_sniper_sc_sh2
    ...
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_back" 0.2 0.0)
    (sleep 101)
    ...
    (sleep 35)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 1.0 15.0)
    (sleep 35)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 0.0 10.0)
    (sleep 10)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 1.0 15.0)
    (sleep 48)
    (cinematic_lights_destroy)
