...
; Start time: 4/7/2022 7:27:20
; Decompilation finished in ~0.0059622s
...
(script dormant void sc_elev_opening
    ...
    (if 
        (or
            ...
            (print "empty") (player_training_activate_flashlight))
)
...
(script static void sv_elev_explosion_big
    (player_effect_set_max_rotation 1.0 1.0 1.0)
...
(script dormant void sc_elev_backup_for_door
    (if (> (object_get_health "elev_room_bash_door") 0.2) 
        (begin
            (if (> (object_get_health "elev_room_bash_door") 0.2) 
                (vs_go_to act_doorman true "elev_door/p7" 1.0))
            (if (> (object_get_health "elev_room_bash_door") 0.2) 
                (vs_go_to_and_face act_doorman true "elev_door/p0" "elev_door/p6"))
            (if 
                (and
                    (> (object_get_health "elev_room_bash_door") 0.2)
                    (= (volume_test_players "tv_elev_door") false)
                ) 
                    (begin
            ...
            (if 
                (and
                    (> (object_get_health "elev_room_bash_door") 0.2)
                    (= (volume_test_object "tv_elev_check" (ai_get_object "sq_elev_doorman")) true)
                ) 
                    (begin
            ...
            (if 
                (and
                    (> (object_get_health "elev_room_bash_door") 0.2)
                    (= (volume_test_object "tv_elev_check1" (ai_get_object "sq_elev_doorman")) true)
                ) 
                    (begin
...
(script dormant void sc_elev_door_impulse
    (sleep_until 
        (or
            (< (object_get_health "elev_room_bash_door") 0.33)
            (= b_elev_door_impulse true)
            (>= s_elevator_obj_control 2)
        ) 
    1)
    (object_set_velocity "elev_room_bash_door" -2.0 0.0 0.0)
    (sleep 5)
    (object_damage_damage_section "elev_room_bash_door" "door" 1000.0)
    (sleep 60)
...
(script dormant void sc_elev_mech
    ...
    (ai_dialogue_enable true)
    (vs_go_to act_mechanic false "elev_room_pts/p32" 1.0)
    (vs_go_to act_mechanic false "elev_room_pts/p31" 1.0)
...
(script dormant void sc_elev_blast_door
    ...
    (if (= (device_get_position "cavern_entrance") 0.0) 
        (begin
            (sleep 60)
            (print "marine:  i'll get the door, sir!")
            (vs_play_line act_blastdoor true 030mb_150)
            (vs_go_to act_blastdoor true "elev_room_pts/p16" 0.0)
            ...
            (sleep 30)
            (device_set_position "cavern_entrance" 1.0)
            (device_set_position "cavern_entrance_but" 1.0)
            (device_set_power "cavern_entrance_switch_01" 0.0)
...
(script dormant void sc_elev_load_up
    ...
    (if (= (device_get_position "cavern_entrance") 0.0) 
        (ai_enter_squad_vehicles "sg_elev_mount") (ai_enter_squad_vehicles "sg_all_allies"))
    (set b_elev_prompt true)
    (sleep 150)
    (if (= (device_get_position "cavern_entrance") 0.0) 
        (ai_enter_squad_vehicles "sg_elev_mount") (ai_enter_squad_vehicles "sg_all_allies"))
...
(script dormant void sc_elev_reserve_driver
    ...
    (sleep_until (= (device_get_position "cavern_entrance") 1.0))
    (print "all enter")
    (ai_enter_squad_vehicles "sg_all_allies")
)
...
(script dormant void sc_elev_enter_vehicles
    ...
    (sleep_until 
        (or
            (> (device_get_position "cavern_entrance") 0.0)
        ...
        (begin
            (if 
                (and
                    ...
                    (begin
                        (player_control_scale_all_input 1.0 0.0)
...
(script dormant void sc_drive_dialog_tether
    (sleep_until 
        (and
            ...
            (= (volume_test_players "tv_drive_vista") true)
        ) 
    5)
    (vs_set_cleanup_script gs_dialogue_cleanup)
    (ai_dialogue_enable false)
...
(script dormant void sc_drive_brute_radio_01
    (sound_looping_start "sound\materials\gear\high_ground_radio\high_ground_radio" "drive_brute_radio_01" 1.0)
...
(script dormant void sc_drive_brute_radio_02
    (sound_looping_start "sound\materials\gear\high_ground_radio\high_ground_radio" "drive_brute_radio_02" 1.0)
...
(script command_script void cs_pond_phantom1
    ...
    (if (<= (game_difficulty_get) normal) 
        (sleep_until (>= s_pond_obj_control 2) 1 480) (sleep_until (>= s_pond_obj_control 3) 1 480))
    (sleep 120)
    (cs_vehicle_speed 0.5)
    (sleep 180)
    (cs_vehicle_speed 1.0)
    (cs_fly_to "pond_ph/p1" 1.0)
    (cs_fly_to "pond_ph/p2" 1.0)
    (cs_fly_to "pond_ph/p3" 1.0)
    (cs_fly_to "pond_ph/p4" 1.0)
...
(script dormant void sc_crash_shield_destroy
    (sleep_until (<= (object_get_health "crash_generator") 0.0) 1)
...
(script command_script void cs_crash_choppers1
    ...
    (object_set_velocity v_crash_doomed 0.0 7.0 3.0)
...
(script dormant void sc_crash_filler_dialog
    (sleep_until 
        (or
            (= (volume_test_players "tv_crash_dialog01") true)
            (= (volume_test_players "tv_crash_dialog02") true)
            (= (ai_task_count "obj_crash_cov/initial_gate") 0)
        )
    )
    (if 
        (and
            (or
                (= (volume_test_objects "tv_crash_dialog01" (ai_get_object "sq_crash_marines")) true)
                (= (volume_test_objects "tv_crash_dialog02" (ai_get_object "sq_crash_marines")) true)
            )
...
(script dormant void sc_crash_mombasa_dialog
    (sleep_until 
        (and
            ...
            (= (volume_test_players "tv_crash_dialog_mombasa") true)
        )
    )
...
(script dormant void sc_crash_filler_dialog02
    (sleep_until 
        (and
            ...
            (= (volume_test_players "tv_crash_oc3") true)
        )
    )
...
(script dormant void sc_crash_prompt
    ...
    (if 
        (and
            ...
            (> (object_get_health "crash_generator") 0.0)
        ) 
            (begin
                (vs_set_cleanup_script gs_dialogue_cleanup)
                (ai_dialogue_enable false)
...
(script dormant void sc_crash_truth
    ...
    (sleep 15)
    (if (> (object_get_health "crash_truth_battery") 0.0) 
        (begin
            ...
            (sound_impulse_start "sound\dialog\030_outskirts\mission\030mz_030_pot" "crash_truth_biped" 1.0)
    ...
    (if (> (object_get_health "crash_truth_battery") 0.0) 
        (begin
            ...
            (sound_impulse_start "sound\dialog\030_outskirts\mission\030mz_040_pot" "crash_truth_biped" 1.0)
...
(script command_script void cs_garage_phantom1
    ...
    (game_save)
    (sleep 120)
    (cs_fly_to "garage_ph1/p0" 1.0)
    (cs_fly_to "garage_ph1/p1" 1.0)
    (cond
        ((= (game_difficulty_get_real) easy)
    ...
    (cs_vehicle_speed 1.0)
    (cs_fly_to "garage_ph1/p7" 1.0)
    (cs_fly_to "garage_ph1/p8" 1.0)
    (cs_fly_to "garage_ph1/p9" 1.0)
    (cs_fly_to "garage_ph1/p10" 1.0)
    (cs_fly_to "garage_ph1/p11" 1.0)
    (ai_erase ai_current_squad)
)
...
(script dormant void sc_garage_phantom_alive
    (sleep_until 
        (or
            ...
            (<= (object_get_health v_garage_phantom0) 0.0)
        )
    )
    (set s_garage_phantom 1)
)
...
(script dormant void sc_garage_phantom_alive2
    (sleep_until 
        (or
            ...
            (<= (object_get_health v_garage_phantom1) 0.0)
        )
    )
    (set s_garage_phantom 2)
)
...
(script command_script void cs_garage_pelican1
    (cs_enable_pathfinding_failsafe true)
    (cs_shoot true)
    (cs_fly_to "garage_pelican1/p0" 1.0)
    ...
    (cs_fly_to "garage_pelican1/p1" 1.0)
    (wake sc_garage_pelican_inc)
    (cs_fly_to "garage_pelican1/p2" 1.0)
    (cs_fly_to "garage_pelican1/p3" 1.0)
    (cs_fly_to "garage_pelican1/p5" 1.0)
    (cs_fly_to_and_face "garage_pelican1/p4" "garage_pelican1/p9" 1.0)
    (cs_vehicle_speed 0.5)
    ...
    (cs_fly_to_and_face "garage_pelican1/p6" "garage_pelican1/p7" 1.0)
    (sv_garage_kill_player)
    (cs_fly_to_and_face "garage_pelican1/p7" "garage_pelican1/p8" 1.0)
    (cs_fly_to "garage_pelican1/p8" 1.0)
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_garage_pelican2
    ...
    (cs_fly_to "garage_pelican2/p0" 1.0)
    (cs_fly_to "garage_pelican2/p1" 1.0)
    (cs_fly_to "garage_pelican2/p2" 1.0)
    (cs_fly_to "garage_pelican2/p3" 1.0)
    (cs_fly_to "garage_pelican2/p4" 1.0)
    (sleep_until 
        (or
            (= b_garage_pelican true)
            (= (object_get_health (ai_get_object "sq_garage_pelican1/pilot")) 0.0)
        )
    )
    (cs_fly_to "garage_pelican2/p5" 1.0)
    (cs_fly_to_and_face "garage_pelican2/p6" "garage_pelican2/p7" 1.0)
    (cs_vehicle_speed 0.5)
    (sleep 60)
    ...
    (ai_enter_squad_vehicles "sg_all_allies")
    (cs_vehicle_speed 1.0)
    (cs_fly_to_and_face "garage_pelican2/p13" "garage_pelican2/p8" 1.0)
    (sv_garage_kill_player)
    (cs_fly_to_and_face "garage_pelican2/p8" "garage_pelican2/p9" 1.0)
    (set b_tether_wraith_awake true)
    (cs_fly_to_and_face "garage_pelican2/p9" "garage_pelican2/p10" 1.0)
    (cs_fly_to_and_face "garage_pelican2/p10" "garage_pelican2/p11" 1.0)
    (cs_fly_to "garage_pelican2/p11" 1.0)
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_garage_pelican3
    ...
    (cs_fly_to "garage_pelican3/p0" 1.0)
    (cs_fly_to "garage_pelican3/p1" 1.0)
    (cs_fly_to "garage_pelican3/p2" 1.0)
    (cs_fly_to "garage_pelican3/p3" 1.0)
    (cs_fly_to "garage_pelican3/p4" 1.0)
    (cs_fly_to "garage_pelican3/p5" 1.0)
    (cs_fly_to_and_face "garage_pelican3/p6" "garage_pelican3/p7" 1.0)
    (cs_vehicle_speed 0.5)
    (sleep 30)
    (sleep_until (= (volume_test_players "tv_garage_pelican2") false) 5)
    ...
    (ai_enter_squad_vehicles "sg_all_allies")
    (cs_vehicle_speed 1.0)
    (cs_fly_to_and_face "garage_pelican3/p13" "garage_pelican3/p8" 1.0)
    (sv_garage_kill_player)
    (cs_fly_to_and_face "garage_pelican3/p8" "garage_pelican3/p9" 1.0)
    (set b_tether_wraith_awake true)
    (cs_fly_to_and_face "garage_pelican3/p9" "garage_pelican3/p10" 1.0)
    (cs_fly_to_and_face "garage_pelican3/p10" "garage_pelican3/p11" 1.0)
    (cs_fly_to "garage_pelican3/p11" 1.0)
    (ai_erase ai_current_squad)
)
...
(script dormant void sc_garage_wraith_nasty
    ...
    (if (> (ai_task_count "obj_garage_cov/main_gate") 0) 
        (print "marine:  damn tank will kills us all if we let it!") (vs_play_line act_garage_wraith_cry true 030mh_180))
    (ai_dialogue_enable true)
    (vs_release_all)
    (sleep (random_range 120 160))
    ...
    (ai_dialogue_enable false)
    (if (> (ai_task_count "obj_garage_cov/main_gate") 0) 
        (print "marine:  you wanna live, chief, you best kill that wraith!") (vs_play_line act_garage_wraith_cry true 030mh_200))
    (ai_dialogue_enable true)
    (vs_release_all)
)
...
(script command_script void cs_round_phantom1
    ...
    (cs_enable_pathfinding_failsafe true)
    (cs_shoot true)
    (cs_fly_to "round_ph1/p0" 1.0)
    (game_save)
    (cs_fly_to "round_ph1/p1" 1.0)
    (cs_fly_to "round_ph1/p2" 1.0)
    (unit_open v_round_phantom1)
    (cs_fly_to "round_ph1/p3" 1.0)
    (cs_fly_to "round_ph1/drop" 1.0)
    (vehicle_unload v_round_phantom1 phantom_lc)
    (cs_fly_to "round_ph1/p4" 1.0)
    (cs_fly_to "round_ph1/p5" 1.0)
    (cs_fly_to "round_ph1/p6" 1.0)
    (cs_fly_to "round_ph1/p7" 1.0)
    (cs_fly_to "round_ph1/p8" 1.0)
    (game_save)
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_round_phantom2
    ...
    (cs_shoot true)
    (cs_vehicle_speed 2.0)
    (cs_fly_to "round_ph2/p0" 1.0)
    (game_save)
    (cs_fly_to "round_ph2/p1" 1.0)
    (cs_vehicle_speed 1.0)
    (cs_fly_to "round_ph2/p2" 1.0)
    (unit_open v_round_phantom2)
    (cs_fly_to "round_ph2/p3" 1.0)
    (vehicle_unload v_round_phantom2 phantom_sc01)
    (cs_fly_to "round_ph2/p4" 1.0)
    (vehicle_unload v_round_phantom2 phantom_sc02)
    (cs_fly_to "round_ph2/p5" 1.0)
    (cs_fly_to "round_ph2/p6" 1.0)
    (cs_fly_to "round_ph2/p7" 1.0)
    (cs_fly_to "round_ph2/p8" 1.0)
    (game_save)
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_round_phantom3
    ...
    (cs_enable_pathfinding_failsafe true)
    (cs_shoot true)
    (cs_fly_to "round_ph3/p0" 1.0)
    (game_save)
    (cs_fly_to "round_ph3/p1" 1.0)
    (cs_fly_to "round_ph3/p2" 1.0)
    (unit_open v_round_phantom3)
    (cs_fly_to "round_ph3/p3" 1.0)
    (vehicle_unload v_round_phantom3 phantom_sc01)
    (cs_fly_to "round_ph3/p4" 1.0)
    (vehicle_unload v_round_phantom3 phantom_sc02)
    (cs_fly_to "round_ph3/p5" 1.0)
    (cs_fly_to "round_ph3/p6" 1.0)
    (cs_fly_to "round_ph3/p7" 1.0)
    (game_save)
    (ai_erase ai_current_squad)
)
...
(script dormant void sc_round_rock_kill
    ...
    (sleep_until 
        (begin
            ...
            (set s_round_rock_list_count (+ s_round_rock_list_count 1.0))
...
(script dormant void sc_round_dialog_storm
    (sleep_until 
        (and
            (= (ai_task_count "obj_round_cov/main_gate") 0)
            (or
                (= (volume_test_players "tv_round_vista1") true)
                (= (volume_test_players "tv_round_vista2") true)
            )
        ) 
    5)
    (vs_set_cleanup_script gs_dialogue_cleanup)
...
(script dormant void sc_round_navpoint
    ...
    (if (= s_exit_obj_control 0) 
        (begin
            ...
            (sleep_until 
                (or
                    (<= (objects_distance_to_flag (players) "round_navpoint") 5.0)
...
(script dormant void sc_exit_shield_destroy
    (sleep_until (<= (object_get_health "exit_generator") 0.0) 1)
...
(script command_script void cs_exit_exit_vehicle
    (if 
        (or
            (= (vehicle_test_seat (ai_vehicle_get (ai_player_get_vehicle_squad (player0))) "warthog_d" (player0)) true)
            (= (vehicle_test_seat (ai_vehicle_get (ai_player_get_vehicle_squad (player1))) "warthog_d" (player1)) true)
            (= (vehicle_test_seat (ai_vehicle_get (ai_player_get_vehicle_squad (player2))) "warthog_d" (player2)) true)
            (= (vehicle_test_seat (ai_vehicle_get (ai_player_get_vehicle_squad (player3))) "warthog_d" (player3)) true)
        ) 
            (begin
...
(script dormant void sc_exit_prompt
    (sleep_until 
        (and
            ...
            (= (volume_test_object "tv_exit_enemy_check" (ai_get_object "sg_exit_cov")) false)
            (= (volume_test_object "tv_exit_enemy_check2" (ai_get_object "sg_exit_cov")) false)
    ...
    (vs_set_cleanup_script gs_dialogue_cleanup)
    (ai_dialogue_enable false)
    (if (> (object_get_health "exit_generator") 0.0) 
        (begin
            (print "take down that barrier, chief!")
    ...
    (sleep_until 
        (begin
            ...
            (<= (object_get_health "exit_generator") 0.0)
        )
    )
    (ai_dialogue_enable true)
)
...
(script dormant void sc_exit_truth
    ...
    (if (> (object_get_health "exit_truth_battery") 0.0) 
        (begin
            ...
            (sound_impulse_start "sound\dialog\030_outskirts\mission\030mz_060_pot" "exit_truth_biped" 1.0)
    ...
    (if (> (object_get_health "exit_truth_battery") 0.0) 
        (begin
            ...
            (sound_impulse_start "sound\dialog\030_outskirts\mission\030mz_070_pot" "exit_truth_biped" 1.0)
    ...
    (if (> (object_get_health "exit_truth_battery") 0.0) 
        (begin
            ...
            (sound_impulse_start "sound\dialog\030_outskirts\mission\030mz_080_pot" "exit_truth_biped" 1.0)
...
(script static boolean obj_gig_ch_12_5
    (or
        (>= s_garage_obj_control 3)
        (= (ai_task_count "obj_garage_cov/door_gate") 0)
    )
)
...
(script static boolean obj_ghold__13_2
    (and
        (>= (ai_task_count "obj_garage_cov/door_gate") 1)
        (<= s_garage_obj_control 1)
    )
)
...
(script static boolean obj_gru_se_13_6
    (or
        (volume_test_players "tv_garage_02b")
        (>= s_garage_obj_control 2)
    )
)
...
(script static boolean obj_rwg_ov_16_23
    (or
        (<= (ai_task_count "obj_round_cov/wg_ini_back") 0)
        (<= (ai_task_count "obj_round_cov/wg_ini_hill") 0)
    )
)
        ...
        (begin
            (if 
                (or
                    ...
                    (set player_on_foot false) (set player_on_foot true))
            false
        )
    )
)
...
(script dormant void gs_kill_stragglers
    (sleep_until 
        (begin
            (if 
                (and
                    (= (objects_can_see_object (players) (list_get (ai_actors "sg_all_allies") s_global_stragglers) 45.0) false)
                    (> (objects_distance_to_object (players) (list_get (ai_actors "sg_all_allies") s_global_stragglers)) 250.0)
                ) 
                    (object_destroy (list_get (ai_actors "sg_all_allies") s_global_stragglers)))
            (set s_global_stragglers (+ s_global_stragglers 1.0))
    ...
    (cond
        ...
        ((= (current_zone_set) 2)
            (begin
                ...
                (device_set_position_immediate "cavern_exit" 0.0)
...
(script dormant void sc_elevator_start
    ...
    (device_set_position "cavern_entrance" 0.0)
    (object_create_anew "cavern_exit")
    (device_set_position "cavern_exit" 0.0)
...
(script dormant void sc_cavern_start
    ...
    (device_set_power "cavern_entrance" 0.0)
    (device_set_position_immediate "cavern_entrance" 0.0)
...
(script dormant void sc_drive_spawn
    ...
    (object_damage_damage_section "drive_watchpod" "upper" 1.0)
...
(script dormant void sc_crash_marines
    ...
    (if 
        (and
            ...
            (ai_place "sq_crash_marines") (ai_place "sq_crash_marines" 2))
)
...
(script dormant void sc_crash_cov
    (cond
        ((= (game_difficulty_get_real) easy)
            ...
            (if (<= s_crash_obj_control 5) 
                (ai_place "sq_crash_third01") (ai_place "sq_crash_third02"))
        )
        ((= (game_difficulty_get_real) normal)
            (ai_place "sq_crash_initial01")
            (ai_place "sq_crash_initial02")
            ...
            (if (<= s_crash_obj_control 4) 
                (ai_place "sq_crash_second01") (ai_place "sq_crash_second02"))
            (sleep_until 
                (and
                    (= (ai_task_count "obj_crash_cov/initial_gate") 0)
                    (= (ai_task_count "obj_crash_cov/second_gate") 0)
    ...
    (if (> (object_get_health "crash_generator") 0.0) 
...
(script dormant void sc_garage_start
    ...
    (if (<= (game_difficulty_get_real) normal) 
        (wake sc_garage_reinforcements) (wake sc_garage_reinforcements2))
...
(script dormant void sc_garage_initial
    ...
    (if 
        (and
            ...
            (ai_place "sq_garage_initial_mar2" 1) (ai_place "sq_garage_initial_mar2" 2))
    (sleep 1)
    ...
    (if (= (game_is_cooperative) false) 
        (begin
            (if (< (ai_living_count "sg_all_allies") 4) 
                (ai_place "sq_round_marine01") (begin
            ...
            (if 
                (and
                    ...
                    (begin
                        ...
                        (set s_exit_marine_reinforce (+ s_exit_marine_reinforce 1.0))
                        (sleep 300)
                    )
            )
...
(script dormant void kill_stragglers
    (sleep_until 
        (begin
            (if 
                (and
                    (= (objects_can_see_object (players) (list_get (ai_actors "sq_elev_mar") straggler_no) 45.0) false)
                    (> (objects_distance_to_object (players) (list_get (ai_actors "sq_elev_mar") straggler_no)) 250.0)
                ) 
                    (object_destroy (list_get (ai_actors "sq_elev_mar") straggler_no)))
            (if 
                (and
                    (= (objects_can_see_object (players) (list_get (ai_actors "sg_allied_vehicles") straggler_no) 45.0) false)
                    (> (objects_distance_to_object (players) (list_get (ai_actors "sg_allied_vehicles") straggler_no)) 250.0)
                ) 
...
(script continuous void check_for_mind_the_gap_cheevo
        ...
        (begin
            (if (= (volume_test_object "tv_bridge_oc6" (ai_vehicle_get_from_starting_location "sq_elev_warthog1/warthog1")) true) 
                (begin
                    ...
                    (set s_vehicles_across_gap (+ s_vehicles_across_gap 1.0))
                )
            )
        )
    )
...
(script static void !030la01_we_made_it_sc_sh1
    ...
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "jet_wash_active" 1.0 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 0.5 0.0)
    (cinematic_scripting_start_music 0 0 0 1)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "jet_wash_power" 1.0 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "jet_wash_power" 0.25 0.0)
    (sleep 15)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 1.0 5.0)
    (sleep 5)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "jet_wash_power" 0.75 0.0)
    (sleep 10)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 0.25 10.0)
    (sleep 55)
...
(script static void !030la01_we_made_it_sc_sh4
    ...
    (render_exposure 2.7 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "jet_wash_active" 1.0 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "jet_wash_power" 0.25 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 0.0 0.0)
    (sleep 25)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 1.0 15.0)
    (sleep 10)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "jet_wash_power" 1.0 10.0)
    (sleep 7)
...
(script static void !030la01_we_made_it_sc_sh5
    ...
    (render_exposure 2.5 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "jet_wash_active" 0.0 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 0.75 0.0)
    (sleep 15)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 0.35 10.0)
    (sleep 124)
    (cinematic_lights_destroy)
    (cinematic_clips_destroy)
    (render_exposure_fade_out 0.0)
...
(script static void !030la02_final_effort_sc_sh3
    ...
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican2") "thrusters_down" 1.0 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican2") "thrusters_back" 0.0 0.0)
    (sleep 15)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 1.0 25.0)
    (sleep 35)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican2") "thrusters_down" 0.0 10.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican2") "thrusters_back" 1.0 5.0)
    (sleep 70)
    (cinematic_lights_destroy)
    (cinematic_clips_destroy)
    (render_exposure_fade_out 0.0)
...
(script static void !030la02_final_effort_sc_sh4
    ...
    (render_exposure 2.5 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_down" 0.25 0.0)
    (object_set_function_variable (cinematic_object_get_scenery "cin_pelican1") "thrusters_back" 1.0 0.0)
    (sleep 110)
    (cinematic_print "custom script play")
